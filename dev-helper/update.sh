...
function make_writable {
  ...
  case $type in
        ...
        css  ) find ../modules/cms/ui/themes/$theme/style/ -type f -name "*.css" -exec chmod -v a+w {} \; ; find ../modules/template_engine/components/html/ -type f -name "*.css" -exec chmod -v a+w {} \; ;;
