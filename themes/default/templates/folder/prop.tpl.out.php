<!-- Compiling output/output-begin @ Wed, 29 Nov 2017 00:51:17 +0100 --><!-- Compiling header/header-begin @ Wed, 29 Nov 2017 00:51:17 +0100 --><?php $a2_name='';$a2_back=false; ?><?php if(!empty($a2_views)) { ?>
...
<?php if (isset($a5_key)) { echo lang($a5_key); ?><?php if (isset($a5_text)) { echo $a5_text; } ?><?php } ?><?php unset($a5_for,$a5_key) ?><!-- Compiling label/label-end @ Wed, 29 Nov 2017 00:51:17 +0100 --></label><!-- Compiling part/part-end @ Wed, 29 Nov 2017 00:51:17 +0100 --></div><!-- Compiling part/part-begin @ Wed, 29 Nov 2017 00:51:17 +0100 --><?php $a4_class='input'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><!-- Compiling input/input-begin @ Wed, 29 Nov 2017 00:51:17 +0100 --><?php $a5_class='filename';$a5_default='';$a5_type='text';$a5_name='filename';$a5_size='';$a5_maxlength='256';$a5_onchange='';$a5_readonly=false;$a5_hint='';$a5_icon=''; ?><?php if ($this->isEditable() && !$this->isEditMode()) $a5_readonly=true;
	  if ($a5_readonly && empty($$a5_name)) $$a5_name = '- '.lang('EMPTY').' -';
      if(!isset($a5_default)) $a5_default='';
      $tmp_value = Text::encodeHtml(isset($$a5_name)?$$a5_name:$a5_default);
?><?php if (!$a5_readonly || $a5_type=='hidden') {
