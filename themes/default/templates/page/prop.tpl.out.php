<!-- Compiling output/output-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><!-- Compiling header/header-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a2_name='';$a2_views='changetemplate';$a2_back=false; ?><?php if(!empty($a2_views)) { ?>
...
?>
<!-- Compiling part/part-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a3_class='line'; ?><div class="<?php echo $a3_class ?>"><?php unset($a3_class) ?><!-- Compiling part/part-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a4_class='label'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><!-- Compiling label/label-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a5_for='name'; ?><label<?php if (isset($a5_for)) { ?> for="<?php echo REQUEST_ID ?>_<?php echo $a5_for ?><?php if (!empty($a5_value)) echo '_'.$a5_value ?>" <?php if(hasLang(@$a5_key.'_desc')) { ?> title="<?php echo lang(@$a5_key.'_desc')?>"<?php } ?>  class="label"<?php } ?>>
<?php if (isset($a5_key)) { echo lang($a5_key); ?><?php if (isset($a5_text)) { echo $a5_text; } ?><?php } ?><?php unset($a5_for) ?><!-- Compiling text/text-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a6_class='text';$a6_text='global_name';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
...
<?php if (isset($a5_key)) { echo lang($a5_key); ?><?php if (isset($a5_text)) { echo $a5_text; } ?><?php } ?><?php unset($a5_for) ?><!-- Compiling text/text-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a6_class='text';$a6_text='global_filename';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_text,$a6_escape,$a6_cut) ?><!-- Compiling label/label-end @ Wed, 29 Nov 2017 01:27:15 +0100 --></label><!-- Compiling part/part-end @ Wed, 29 Nov 2017 01:27:15 +0100 --></div><!-- Compiling part/part-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a4_class='input'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><!-- Compiling input/input-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a5_class='filename';$a5_default='';$a5_type='text';$a5_name='filename';$a5_size='';$a5_maxlength='256';$a5_onchange='';$a5_readonly=false;$a5_hint='';$a5_icon=''; ?><?php if ($this->isEditable() && !$this->isEditMode()) $a5_readonly=true;
	  if ($a5_readonly && empty($$a5_name)) $$a5_name = '- '.lang('EMPTY').' -';
      if(!isset($a5_default)) $a5_default='';
      $tmp_value = Text::encodeHtml(isset($$a5_name)?$$a5_name:$a5_default);
?><?php if (!$a5_readonly || $a5_type=='hidden') {
...
<?php if (isset($a5_key)) { echo lang($a5_key); ?><?php if (isset($a5_text)) { echo $a5_text; } ?><?php } ?><?php unset($a5_for) ?><!-- Compiling text/text-begin @ Wed, 29 Nov 2017 01:27:15 +0100 --><?php $a6_class='text';$a6_text='global_description';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
