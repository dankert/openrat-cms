<!-- Compiling output/output-begin @ Wed, 29 Nov 2017 00:50:46 +0100 -->
		<form name=""
      target="_self"
...
?>
<!-- Compiling part/part-begin @ Wed, 29 Nov 2017 00:50:46 +0100 --><?php $a3_class='line'; ?><div class="<?php echo $a3_class ?>"><?php unset($a3_class) ?><!-- Compiling part/part-begin @ Wed, 29 Nov 2017 00:50:46 +0100 --><?php $a4_class='label'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><!-- Compiling text/text-begin @ Wed, 29 Nov 2017 00:50:46 +0100 --><?php $a5_class='text';$a5_text='LANGUAGE_ISOCODE';$a5_escape=true;$a5_cut='both'; ?><?php
		$a5_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a5_class ?>" title="<?php echo $a5_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a5_class,$a5_text,$a5_escape,$a5_cut) ?><!-- Compiling part/part-end @ Wed, 29 Nov 2017 00:50:46 +0100 --></div><!-- Compiling part/part-begin @ Wed, 29 Nov 2017 00:50:46 +0100 --><?php $a4_class='input'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><!-- Compiling selectbox/selectbox-begin @ Wed, 29 Nov 2017 00:50:46 +0100 --><?php $a5_list='isocodes';$a5_name='isocode';$a5_onchange='';$a5_title='';$a5_class='';$a5_addempty=false;$a5_multiple=false;$a5_size='1';$a5_lang=false; ?><?php
$a5_readonly=false;
$a5_tmp_list = $$a5_list;
...
?><?php unset($a5_list,$a5_name,$a5_onchange,$a5_title,$a5_class,$a5_addempty,$a5_multiple,$a5_size,$a5_lang) ?><!-- Compiling part/part-end @ Wed, 29 Nov 2017 00:50:46 +0100 --></div><!-- Compiling part/part-end @ Wed, 29 Nov 2017 00:50:46 +0100 --></div>
