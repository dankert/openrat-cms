	...
	table padding:5 space:0 width:100%
		row
			...
			cell class:title width:40% style:text-align:right;
				link url:profile_url target:cms_main_main
					text title:USER_PROFILE_DESC text:USER_YOURPROFILE
				text raw:_|_
				link url:logout_url target:_top
					text title:USER_LOGOUT_DESC text:USER_LOGOUT
