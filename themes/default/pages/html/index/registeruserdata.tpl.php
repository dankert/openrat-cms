...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_title='GLOBAL_REGISTER';$a3_name='login';$a3_icon='user';$a3_width='400';$a3_rowclasses='fx1,fx2';$a3_columnclasses='x,y'; ?><div class="breadcrumb">
		<?php 
	$icon=$a3_icon;
...
if	($a7_readonly) {
?><input type="hidden" id="id_<?php echo $a7_name ?>" name="<?php echo $a7_name ?>" value="<?php echo $tmp_value ?>" /><?php
 } } else { ?><a href="<?php echo Html::url('','',0,array('mode'=>'edit')) ?>"><span class="<?php echo $a7_class ?>"><?php echo $tmp_value ?></span></a><?php } ?><?php unset($a7_class,$a7_default,$a7_type,$a7_name,$a7_value,$a7_size,$a7_maxlength,$a7_onchange,$a7_readonly) ?></td></tr><?php
	$row_idx++;
	$column_idx = 0;
?>
<tr
