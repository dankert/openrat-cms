...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_name='password';$a3_icon='user';$a3_widths='50%,50%';$a3_width='400px';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php
...
<?php } ?>
><?php $a7_class='text';$a7_text='mail_code';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a7_class='text';$a7_default='';$a7_type='text';$a7_name='code';$a7_size='30';$a7_maxlength='256';$a7_onchange='';$a7_readonly=false; ?><?php if ($this->isEditable() && !$this->isEditMode()) $a7_readonly=true;
