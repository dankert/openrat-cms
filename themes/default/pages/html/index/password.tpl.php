...
?><?php unset($attr2_name);unset($attr2_target);unset($attr2_method);unset($attr2_enctype); ?><?php  $attr3_title='GLOBAL_password';  $attr3_name='login';  $attr3_icon='user';  $attr3_widths='50%,50%';  $attr3_width='400';  $attr3_rowclasses='fx1,fx2';  $attr3_columnclasses='x,y';  ?><?php
...
?>><?php unset($attr5_class);unset($attr5_colspan); ?><?php  $attr6_name='password';  ?><img src="<?php echo $image_dir.'logo_'.$attr6_name.IMG_ICON_EXT ?>" border="0" align="left"><h2 class="logo"><?php echo langHtml('logo_'.$attr6_name) ?></h2><p class="logo"><?php echo langHtml('logo_'.$attr6_name.'_text') ?></p><?php unset($attr6_name); ?><?php  ?></td><?php  ?><?php  ?><?php
	$attr5_tmp_class='';
...
?><td<?php
?> width="<?php echo $attr6_width ?>"<?php
?>><?php unset($attr6_width); ?><?php  $attr7_class='text';  $attr7_default='';  $attr7_type='text';  $attr7_name='username';  $attr7_value='';  $attr7_size='30';  $attr7_maxlength='256';  $attr7_onchange='';  $attr7_readonly=false;  ?><?php if ($this->isEditable() && !$this->isEditMode()) $attr7_readonly=true;
...
?>><?php unset($attr6_class);unset($attr6_colspan); ?><?php  $attr7_type='ok';  $attr7_class='ok';  $attr7_value='ok';  $attr7_text='button_next';  ?><?php
		if ($this->isEditable() && !$this->isEditMode())
...
<?php } ?>
<?php  ?><?php  ?></form>
<?php  ?><?php  $attr2_field='username';  ?><?php
