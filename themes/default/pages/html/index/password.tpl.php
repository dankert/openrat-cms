...
?><td <?php foreach( $attr6 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr6) ?><?php unset($attr6_width) ?><?php $attr7 = array('class'=>'text','text'=>'USER_USERNAME') ?><?php $attr7_class='text' ?><?php $attr7_text='USER_USERNAME' ?><?php
...
?><span class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
	...
	echo $tmp_text;
?></span><?php unset($attr7) ?><?php unset($attr7_class) ?><?php unset($attr7_text) ?><?php $attr5 = array() ?></td><?php unset($attr5) ?><?php $attr6 = array('width'=>'50%') ?><?php $attr6_width='50%' ?><?php
//	if (empty($attr6_class))
//		$attr6['class']=$row_class;
	$column_class_idx++;
	if ($column_class_idx > count($column_classes))
