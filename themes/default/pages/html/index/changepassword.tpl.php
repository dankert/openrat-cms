...
?><?php unset($attr2_name);unset($attr2_target);unset($attr2_method);unset($attr2_enctype); ?><?php  $attr3_title='GLOBAL_CHOOSE';  $attr3_name='login';  $attr3_icon='user';  $attr3_width='400';  $attr3_rowclasses='fx1,fx2';  $attr3_columnclasses='x,y';  ?><?php
...
?>><?php unset($attr5_class);unset($attr5_colspan); ?><?php  $attr6_name='changepassword';  ?><img src="<?php echo $image_dir.'logo_'.$attr6_name.IMG_ICON_EXT ?>" border="0" align="left"><h2 class="logo"><?php echo langHtml('logo_'.$attr6_name) ?></h2><p class="logo"><?php echo langHtml('logo_'.$attr6_name.'_text') ?></p><?php unset($attr6_name); ?><?php  ?></td><?php  ?><?php  ?><?php
	$attr5_tmp_class='';
...
?><td<?php
?> width="<?php echo $attr6_width ?>"<?php
?>><?php unset($attr6_width); ?><?php  $attr7_class='text';  $attr7_text='USER_NEW_PASSWORD';  $attr7_escape=true;  ?><?php
		$attr7_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
		$langF = $attr7_escape?'langHtml':'lang';
...
?><td<?php
?> width="<?php echo $attr6_width ?>"<?php
?>><?php unset($attr6_width); ?><?php  $attr7_name='password_new_1';  $attr7_default='';  $attr7_class='';  $attr7_size='25';  $attr7_maxlength='256';  ?><input type="password" name="<?php echo $attr7_name ?>" size="<?php echo $attr7_size ?>" maxlength="<?php echo $attr7_maxlength ?>" class="<?php echo $attr7_class ?>" value="<?php if (count($errors)==0) echo isset($$attr7_name)?$$attr7_name:$attr7_default ?>" <?php if (in_array($attr7_name,$errors)) echo 'style="border:2px dashed red;"' ?> /><?php unset($attr7_name);unset($attr7_default);unset($attr7_class);unset($attr7_size);unset($attr7_maxlength); ?><?php  ?></td><?php  ?><?php  ?></tr><?php  ?><?php  ?><?php
	$attr5_tmp_class='';
	$attr5_last_class = $attr5_tmp_class;
	echo Html::open_tag('tr',array('class'=>$attr5_tmp_class));
?><?php  ?><?php  $attr6_width='50%';  ?><?php
...
?><td<?php
?> width="<?php echo $attr6_width ?>"<?php
?>><?php unset($attr6_width); ?><?php  $attr7_class='text';  $attr7_text='USER_NEW_PASSWORD_REPEAT';  $attr7_escape=true;  ?><?php
		$attr7_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
		$langF = $attr7_escape?'langHtml':'lang';
...
<?php } ?>
<?php  ?><?php  ?></form>
<?php  ?><?php  $attr2_field='password_old';  ?><?php
