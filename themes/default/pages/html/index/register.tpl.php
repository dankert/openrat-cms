...
?><td <?php foreach( $attr6 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr6) ?><?php unset($attr6_width) ?><?php unset($attr6_class) ?><?php $attr7 = array('class'=>'text','text'=>'USER_MAIL','escape'=>true) ?><?php $attr7_class='text' ?><?php $attr7_text='USER_MAIL' ?><?php $attr7_escape=true ?><?php
...
?><td <?php foreach( $attr6 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr6) ?><?php unset($attr6_width) ?><?php unset($attr6_class) ?><?php $attr7 = array('class'=>'','default'=>'','type'=>'text','name'=>'mail','size'=>'25','maxlength'=>'256','onchange'=>'') ?><?php $attr7_class='' ?><?php $attr7_default='' ?><?php $attr7_type='text' ?><?php $attr7_name='mail' ?><?php $attr7_size='25' ?><?php $attr7_maxlength='256' ?><?php $attr7_onchange='' ?><?php if(!isset($attr7_default)) $attr7_default='';
...
<?php unset($attr1) ?><?php $attr2 = array('field'=>'mail') ?><?php $attr2_field='mail' ?>
