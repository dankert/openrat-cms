...
?><?php unset($attr2_name);unset($attr2_target);unset($attr2_method);unset($attr2_enctype); ?><?php  $attr3_title='GLOBAL_REGISTER';  $attr3_name='login';  $attr3_icon='user';  $attr3_width='400';  $attr3_rowclasses='odd,even';  $attr3_columnclasses='x';  ?><?php
...
?>><?php unset($attr6_width); ?><?php  $attr7_class='text';  $attr7_text='USER_MAIL';  $attr7_escape=true;  ?><?php
		$attr7_title = '';
		$tmp_tag = 'span';
...
?><td<?php
?> width="<?php echo $attr6_width ?>"<?php
?>><?php unset($attr6_width); ?><?php  $attr7_class='text';  $attr7_default='';  $attr7_type='text';  $attr7_name='mail';  $attr7_size='25';  $attr7_maxlength='256';  $attr7_onchange='';  $attr7_readonly=false;  ?><?php if ($this->isEditable() && !$this->isEditMode()) $attr7_readonly=true;
