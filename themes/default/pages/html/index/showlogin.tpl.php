...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php unset($attr_width) ?><?php unset($attr_class) ?><?php $attr = array('not'=>'1','present'=>'force_username') ?><?php $attr_not='1' ?><?php $attr_present='force_username' ?><?php 
...
//	Html::debug($attr);
	...
	if	( $exec )
	{
?><?php unset($attr) ?><?php unset($attr_not) ?><?php unset($attr_present) ?><?php $attr = array('class'=>'','default'=>'','type'=>'text','name'=>'login_name','value'=>'','size'=>'25','maxlength'=>'256','onchange'=>'') ?><?php $attr_class='' ?><?php $attr_default='' ?><?php $attr_type='text' ?><?php $attr_name='login_name' ?><?php $attr_value='' ?><?php $attr_size='25' ?><?php $attr_maxlength='256' ?><?php $attr_onchange='' ?><input id="id<?php echo $attr_name ?>" name="<?php echo $attr_name ?>" type="<?php echo $attr_type ?>" size="<?php echo $attr_size ?>" maxlength="<?php echo $attr_maxlength ?>" class="<?php echo $attr_class ?>" value="<?php echo isset($$attr_name)?$$attr_name:$attr_default ?>" onxxxMouseOver="this.focus();"  /><?php unset($attr) ?><?php unset($attr_class) ?><?php unset($attr_default) ?><?php unset($attr_type) ?><?php unset($attr_name) ?><?php unset($attr_value) ?><?php unset($attr_size) ?><?php unset($attr_maxlength) ?><?php unset($attr_onchange) ?><?php $attr = array() ?><?php
	}
	
?><?php unset($attr) ?><?php $attr = array() ?><?php
	if	( !$last_exec )
	{
?><?php unset($attr) ?><?php $attr = array('class'=>'','default'=>'','type'=>'hidden','name'=>'login_name','value'=>$force_username,'size'=>'40','maxlength'=>'256','onchange'=>'') ?><?php $attr_class='' ?><?php $attr_default='' ?><?php $attr_type='hidden' ?><?php $attr_name='login_name' ?><?php $attr_value=$force_username ?><?php $attr_size='40' ?><?php $attr_maxlength='256' ?><?php $attr_onchange='' ?><input id="id<?php echo $attr_name ?>" name="<?php echo $attr_name ?>" type="<?php echo $attr_type ?>" size="<?php echo $attr_size ?>" maxlength="<?php echo $attr_maxlength ?>" class="<?php echo $attr_class ?>" value="<?php echo isset($$attr_name)?$$attr_name:$attr_default ?>" onxxxMouseOver="this.focus();"  /><?php unset($attr) ?><?php unset($attr_class) ?><?php unset($attr_default) ?><?php unset($attr_type) ?><?php unset($attr_name) ?><?php unset($attr_value) ?><?php unset($attr_size) ?><?php unset($attr_maxlength) ?><?php unset($attr_onchange) ?><?php $attr = array('class'=>'text','value'=>$force_username) ?><?php $attr_class='text' ?><?php $attr_value=$force_username ?><?php
	if(empty($attr_title))
		if (!empty($attr_key))
			$attr_title = lang($attr_key).'_HELP';
		else
...
?><span class="<?php echo $attr_class ?>" title="<?php echo $attr_title ?>"><?php
	...
	echo $tmp_text;
?></span><?php unset($attr) ?><?php unset($attr_class) ?><?php unset($attr_value) ?><?php $attr = array() ?><?php
	}
?><?php unset($attr) ?><?php $attr = array() ?></td><?php unset($attr) ?><?php $attr = array() ?></tr><?php unset($attr) ?><?php $attr = array() ?><?php
	$row_class_idx++;
	if ($row_class_idx > count($row_classes))
...
?><span class="<?php echo $attr_class ?>" title="<?php echo $attr_title ?>"><?php
	...
	echo $tmp_text;
?></span><?php unset($attr) ?><?php unset($attr_class) ?><?php unset($attr_value) ?><?php $attr = array() ?></a><?php unset($attr) ?><?php $attr = array('present'=>'force_username') ?><?php $attr_present='force_username' ?><?php 
...
//	Html::debug($attr);
	...
	if	( $exec )
	{
?><?php unset($attr) ?><?php unset($attr_present) ?><?php $attr = array('field'=>'login_password') ?><?php $attr_field='login_password' ?>
...
<?php unset($attr) ?><?php unset($attr_field) ?><?php $attr = array() ?><?php
	}
	
?><?php unset($attr) ?><?php $attr = array() ?><?php
	if	( !$last_exec )
	{
?><?php unset($attr) ?><?php $attr = array('field'=>'login_name') ?><?php $attr_field='login_name' ?>
<script name="JavaScript" type="text/javascript">
<!--
document.forms[0].<?php echo $attr_field ?>.focus();
document.forms[0].<?php echo $attr_field ?>.select();
