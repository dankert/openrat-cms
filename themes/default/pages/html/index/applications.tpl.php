<?php $a1_class='main';$a1_title='MENU_INDEX_APPLICATIONS'; ?><?php unset($a1_class,$a1_title) ?><?php $a2_icon='project';$a2_width='600';$a2_rowclasses='odd,even';$a2_columnclasses='1,2,3'; ?><div class="breadcrumb">
		<?php 
	$icon=$a2_icon;
...
<?php
    ...
    foreach( $windowMenu as $menu )
		...
		global $image_dir;
		echo '<br/><br/>';
		echo '<table class="x-main" cellspacing="0" cellpadding="4" width="'.$a2_width.'">';
		?>
...
<tr
>
<?php $a4_colspan='2'; ?><?php $column_idx++; ?><td
...
<?php } ?>
 colspan="2"
><?php unset($a4_colspan) ?><?php $a5_title='';$a5_class='';$a5_action='index';$a5_subaction='projectmenu'; ?><?php
	$params = array();
	$tmp_url = '';
		$tmp_url = Html::url($a5_action,$a5_subaction,!empty($a5_id)?$a5_id:$this->getRequestId(),$params);
?><a<?php if (isset($a5_name)) echo ' name="'.$a5_name.'"'; else echo ' href="'.$tmp_url.(isset($a5_anchor)?'#'.$a5_anchor:'').'"' ?> class="<?php echo $a5_class ?>"<?php if (isset($a5_accesskey)) echo ' accesskey="'.$a5_accesskey.'"' ?>  title="<?php echo encodeHtml($a5_title) ?>"><?php unset($a5_title,$a5_class,$a5_action,$a5_subaction) ?><?php $a6_class='text';$a6_raw='OpenRat';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_raw,$a6_escape,$a6_cut) ?></a></td></tr><?php $a3_list='applications';$a3_extract=true;$a3_key='list_key';$a3_value='list_value'; ?><?php
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_title='';$a6_url=$url;$a6_class=''; ?><?php
	$params = array();
	$tmp_url = '';
		$tmp_url = $a6_url;
?><a<?php if (isset($a6_name)) echo ' name="'.$a6_name.'"'; else echo ' href="'.$tmp_url.(isset($a6_anchor)?'#'.$a6_anchor:'').'"' ?> class="<?php echo $a6_class ?>"<?php if (isset($a6_accesskey)) echo ' accesskey="'.$a6_accesskey.'"' ?>  title="<?php echo encodeHtml($a6_title) ?>"><?php unset($a6_title,$a6_url,$a6_class) ?><?php $a7_class='text';$a7_var='name';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
...
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_var,$a6_escape,$a6_cut) ?></td></tr><?php } ?>      </table>
	</td>
  </tr>
</table>
<?php if ($showDuration)
