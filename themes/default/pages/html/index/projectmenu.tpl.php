<?php $attr1_debug_info = 'a:2:{s:5:"class";s:4:"main";s:5:"title";s:30:"message:MENU_INDEX_PROJECTMENU";}' ?><?php $attr1 = array('class'=>'main','title'=>lang('MENU_INDEX_PROJECTMENU')) ?><?php $attr1_class='main' ?><?php $attr1_title=lang('MENU_INDEX_PROJECTMENU') ?><?php if (!headers_sent()) header('Content-Type: text/html; charset='.lang('CHARSET'))
...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php unset($attr5_colspan) ?><?php $attr6_debug_info = 'a:1:{s:5:"title";s:8:"var:name";}' ?><?php $attr6 = array('title'=>$name) ?><?php $attr6_title=$name ?><fieldset><?php if(isset($attr6_title)) { ?><legend><?php echo $attr6_title ?></legend><?php } ?><?php unset($attr6) ?><?php unset($attr6_title) ?><?php $attr5_debug_info = 'a:0:{}' ?><?php $attr5 = array() ?></fieldset><?php unset($attr5) ?><?php $attr4_debug_info = 'a:0:{}' ?><?php $attr4 = array() ?></td><?php unset($attr4) ?><?php $attr3_debug_info = 'a:0:{}' ?><?php $attr3 = array() ?></tr><?php unset($attr3) ?><?php $attr4_debug_info = 'a:0:{}' ?><?php $attr4 = array() ?><?php
	$row_class_idx++;
	if ($row_class_idx > count($row_classes))
		$row_class_idx=1;
	$row_class=$row_classes[$row_class_idx-1];
