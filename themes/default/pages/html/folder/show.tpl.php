...
<?php unset($a2_widths,$a2_width,$a2_rowclasses,$a2_columnclasses) ?><?php $a3_present='up_url'; ?><?php 
...
<?php } ?>
 colspan="8"
><?php unset($a5_width,$a5_colspan) ?><?php $a6_title='';$a6_target='cms_main';$a6_url=$up_url;$a6_class=''; ?><?php
	$params = array();
	$tmp_url = '';
		$tmp_url = $a6_url;
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_title=$desc;$a6_target='cms_main';$a6_url=$url;$a6_class=$class; ?><?php
	$params = array();
	$tmp_url = '';
		$tmp_url = $a6_url;
...
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_text,$a6_escape,$a6_cut) ?></td></tr><?php } ?>      </table>
	</td>
  </tr>
</table>
</center>
