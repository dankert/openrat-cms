...
<?php unset($attr1) ?><?php unset($attr1_class) ?><?php unset($attr1_title) ?><?php $attr2 = array('title'=>'global_prop','name'=>'objectName','icon'=>'folder','widths'=>'50%,50%','width'=>'90%','rowclasses'=>'odd,even','columnclasses'=>'1,2,3') ?><?php $attr2_title='global_prop' ?><?php $attr2_name='objectName' ?><?php $attr2_icon='folder' ?><?php $attr2_widths='50%,50%' ?><?php $attr2_width='90%' ?><?php $attr2_rowclasses='odd,even' ?><?php $attr2_columnclasses='1,2,3' ?><?php
...
<?php } ?>
  ...
  <tr>
    <td>
      <table class="n" cellspacing="0" width="100%" cellpadding="4"><?php unset($attr2) ?><?php unset($attr2_title) ?><?php unset($attr2_name) ?><?php unset($attr2_icon) ?><?php unset($attr2_widths) ?><?php unset($attr2_width) ?><?php unset($attr2_rowclasses) ?><?php unset($attr2_columnclasses) ?><?php $attr3 = array() ?><?php
	$row_class_idx++;
