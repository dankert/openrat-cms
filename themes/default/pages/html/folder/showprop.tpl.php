...
<?php unset($attr) ?><?php unset($attr_class) ?><?php $attr = array('title'=>'global_prop','name'=>'objectName','icon'=>'folder','widths'=>'50%,50%','width'=>'90%') ?><?php $attr_title='global_prop' ?><?php $attr_name='objectName' ?><?php $attr_icon='folder' ?><?php $attr_widths='50%,50%' ?><?php $attr_width='90%' ?><?php
...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php unset($attr_width) ?><?php unset($attr_style) ?><?php unset($attr_class) ?><?php unset($attr_colspan) ?>