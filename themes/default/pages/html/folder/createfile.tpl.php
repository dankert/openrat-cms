...
<?php } ?>
</div><?php unset($a2_name,$a2_back) ?><?php $a2_name='';$a2_target='upload';$a2_method='post';$a2_enctype='multipart/form-data';$a2_type='upload'; ?><?php
...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype,$a2_type) ?><?php $a3_name='type';$a3_default='file'; ?><?php
if (isset($$a3_name))
...
elseif ( isset($a3_default) )
	...
	$a3_tmp_value = "";
?><input type="hidden" name="<?php echo $a3_name ?>" value="<?php echo $a3_tmp_value ?>" /><?php unset($a3_name,$a3_default) ?><?php $a3_title='';$a3_name='';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php if (false) { ?>
<div class="window">
<div class="title">
		<?php $icon=$actionName; ?>
...
<?php } ?><?php unset($a3_title,$a3_name,$a3_width,$a3_rowclasses,$a3_columnclasses) ?><?php
	$column_idx = 0;
?>
<tr
>
...
<?php } ?>
><?php unset($a5_header) ?><?php $a6_class='text';$a6_text='global_FILE';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a5_header) ?><?php $a6_name='file';$a6_class='upload';$a6_maxlength=$maxlength;$a6_size='40'; ?><input size="<?php echo $a6_size ?>" id="id_<?php echo $a6_name ?>" type="file" <?php if (isset($a6_maxlength))echo ' maxlength="'.$a6_maxlength.'"' ?> name="<?php echo $a6_name ?>" class="<?php echo $a6_class ?>" <?php if (in_array($a6_name,$errors)) echo 'style="border-rightx:10px solid red; background-colorx:yellow; border:2px dashed red;"' ?> /><?php unset($a6_name,$a6_class,$a6_maxlength,$a6_size) ?><?php $a6_inline=false;$a6_url='';$a6_name='upload'; ?><iframe name="<?php echo $a6_name ?>" src="<?php echo $a6_url ?>"></iframe>
<?php unset($a6_inline,$a6_url,$a6_name) ?></td></tr><?php
	$column_idx = 0;
?>
<tr
>
...
<?php } ?>
 colspan="2"
><?php unset($a5_colspan,$a5_header) ?><?php $a6_class='help';$a6_key='file_max_size';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a5_header) ?><?php $a6_class='text';$a6_key='HTTP_URL';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_key,$a6_escape,$a6_cut) ?></td><?php $a5_header=false; ?><?php $column_idx++; ?><td
<?php if (!empty($column_widths)) { ?>
 width="<?php echo $column_widths[($column_idx-1)%count($column_widths)] ?>"
<?php } ?>
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a5_header) ?><?php $a6_class='text';$a6_default='';$a6_type='text';$a6_name='url';$a6_size='50';$a6_maxlength='256';$a6_onchange='';$a6_readonly=false; ?><?php if ($this->isEditable() && !$this->isEditMode()) $a6_readonly=true;
...
?><input type="hidden" id="id_<?php echo $a6_name ?>" name="<?php echo $a6_name ?>" value="<?php echo $tmp_value ?>" /><?php
 } } else { ?><a title="<?php echo langHtml('EDIT') ?>" href="<?php echo Html::url($actionName,$subactionName,0,array('mode'=>'edit')) ?>"><span class="<?php echo $a6_class ?>"><?php echo $tmp_value ?></span></a><?php } ?><?php unset($a6_class,$a6_default,$a6_type,$a6_name,$a6_size,$a6_maxlength,$a6_onchange,$a6_readonly) ?></td></tr><?php
	$column_idx = 0;
?>
<tr
>
...
<?php } ?>
 colspan="2"
><?php unset($a5_colspan,$a5_header) ?><?php $a6_title=lang('description'); ?><fieldset><?php if(isset($a6_title)) { ?><legend><?php if(isset($a6_icon)) { ?><img src="<?php echo $image_dir.'icon_'.$a6_icon.IMG_ICON_EXT ?>" align="left" border="0" /><?php } ?>&nbsp;&nbsp;<?php echo encodeHtml($a6_title) ?>&nbsp;&nbsp;</legend><?php } ?><?php unset($a6_title) ?></fieldset></td></tr><?php
	$column_idx = 0;
?>
<tr
>
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a5_header) ?><?php $a6_class='text';$a6_text='global_NAME';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a5_header) ?><?php $a6_class='text';$a6_default='';$a6_type='text';$a6_name='name';$a6_size='50';$a6_maxlength='256';$a6_onchange='';$a6_readonly=false; ?><?php if ($this->isEditable() && !$this->isEditMode()) $a6_readonly=true;
	  if ($a6_readonly && empty($$a6_name)) $$a6_name = '- '.lang('EMPTY').' -';
      if(!isset($a6_default)) $a6_default='';
      $tmp_value = Text::encodeHtml(isset($$a6_name)?$$a6_name:$a6_default);
?><?php if (!$a6_readonly || $a6_type=='hidden') {
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a5_header) ?><?php $a6_class='text';$a6_text='global_DESCRIPTION';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a5_header) ?><?php $a6_name='description';$a6_rows='5';$a6_cols='50';$a6_class='inputarea';$a6_default=''; ?><?php if ($this->isEditMode()) {
...
?><span class="<?php echo $a6_class ?>"><?php echo isset($$a6_name)?$$a6_name:$a6_default ?></span><?php } ?><?php unset($a6_name,$a6_rows,$a6_cols,$a6_class,$a6_default) ?><br/></td></tr><?php if (false) { ?>
</div>
</div>
<div class="bottom">
	<div class="status">
