...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php unset($attr5_class) ?><?php $attr6 = array('class'=>'text','text'=>'global_FOLDER','escape'=>true) ?><?php $attr6_class='text' ?><?php $attr6_text='global_FOLDER' ?><?php $attr6_escape=true ?><?php
