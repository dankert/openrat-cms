...
<?php } ?>
<?php  ?><?php  ?></form>
<?php  ?><?php  $attr2_script='mark';  ?><script src="<?php echo OR_THEMES_DIR.$conf['interface']['theme'].'/js/'.basename($attr2_script).'.js' ?>" type="text/javascript"></script>
<?php unset($attr2_script); ?><?php  ?></body>
</html><?php  ?>