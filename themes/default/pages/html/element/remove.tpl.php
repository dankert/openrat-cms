...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php $attr6 = array('default'=>'','readonly'=>'','name'=>'delete') ?><?php $attr6_default='' ?><?php $attr6_readonly='' ?><?php $attr6_name='delete' ?><?php
...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php $attr6 = array('class'=>'text','text'=>'ELEMENT_DELETE_VALUES') ?><?php $attr6_class='text' ?><?php $attr6_text='ELEMENT_DELETE_VALUES' ?><?php
	if(empty($attr6_title))
		if (!empty($attr6_key))
			$attr6_title = lang($attr6_key).'_HELP';
		else
...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php $attr6 = array('default'=>'','readonly'=>'','name'=>'deletevalues') ?><?php $attr6_default='' ?><?php $attr6_readonly='' ?><?php $attr6_name='deletevalues' ?><?php
	$attr6_default  = ( $attr6_default  == true );
