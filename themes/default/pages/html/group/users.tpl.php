...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_name='GROUP_MEMBERSHIPS';$a3_icon='user';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php
...
<?php unset($a3_name,$a3_icon,$a3_width,$a3_rowclasses,$a3_columnclasses) ?><?php $a4_list='memberships';$a4_extract=true;$a4_key='list_key';$a4_value='list_value'; ?><?php
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a7_for=$var; ?><label for="id_<?php echo $a7_for ?><?php if (!empty($a7_value)) echo '_'.$a7_value ?>"><?php unset($a7_for) ?><?php $a8_file='icon_user';$a8_align='left'; ?><?php
