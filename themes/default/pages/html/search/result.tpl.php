<?php $a3_icon='search';$a3_widths='70%,30%';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php if (false) { ?>
<div class="window">
<div class="title">
		<?php $icon=$actionName; ?>
...
<?php } ?><?php unset($a3_icon,$a3_widths,$a3_width,$a3_rowclasses,$a3_columnclasses) ?><?php
	$column_idx = 0;
?>
<tr
>
<?php $a5_class='help';$a5_header=false; ?><?php $column_idx++; ?><td
<?php if (!empty($column_widths)) { ?>
 width="<?php echo $column_widths[($column_idx-1)%count($column_widths)] ?>"
<?php } ?>
 class="help"
><?php unset($a5_class,$a5_header) ?><?php $a6_class='text';$a6_key='GLOBAL_NAME';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
...
<?php } ?>
 class="help"
><?php unset($a5_class,$a5_header) ?><?php $a6_class='text';$a6_key='GLOBAL_LASTCHANGE';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_key,$a6_escape,$a6_cut) ?></td></tr><?php $a4_list='result';$a4_extract=true;$a4_key='list_key';$a4_value='list_value'; ?><?php
...
<?php } ?>
><?php unset($a6_header) ?><?php $a7_title='';$a7_type='';$a7_target='cms_main';$a7_url=$url;$a7_class='';$a7_frame='_self'; ?><?php
	$params = array();
	$tmp_url = '';
...
?><<?php echo $tmp_tag ?> class="<?php echo $a8_class ?>" title="<?php echo $a8_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a8_title,$a8_class,$a8_var,$a8_escape,$a8_cut) ?></a></td><?php $a6_header=false; ?><?php $column_idx++; ?><td
<?php if (!empty($column_widths)) { ?>
 width="<?php echo $column_widths[($column_idx-1)%count($column_widths)] ?>"
<?php } ?>
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a6_header) ?><?php $a7_date=$lastchange_date; ?><?php	
    global $conf;
	$time = $a7_date;
...
?><?php unset($a7_date) ?></td></tr><?php } ?><?php if (false) { ?>
</div>
</div>
<div class="bottom">
	<div class="status">
