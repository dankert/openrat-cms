...
<?php unset($attr1_class); ?><?php  $attr2_name='GLOBAL_TEMPLATES';  $attr2_width='93%';  $attr2_rowclasses='odd,even';  $attr2_columnclasses='1,2,3';  ?><?php
...
<?php unset($attr2_name);unset($attr2_width);unset($attr2_rowclasses);unset($attr2_columnclasses); ?><?php  $attr3_list='templates';  $attr3_extract=true;  $attr3_key='list_key';  $attr3_value='list_value';  ?><?php
...
?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($attr7_class);unset($attr7_var);unset($attr7_escape); ?><?php  ?></a><?php  ?><?php  ?></td><?php  ?><?php  ?></tr><?php  ?><?php  ?><?php } ?><?php  ?><?php  $attr3_empty='templates';  ?><?php 
...
?>><?php unset($attr5_class); ?><?php  $attr6_class='text';  $attr6_text='GLOBAL_NO_TEMPLATES_AVAILABLE_DESC';  $attr6_escape=true;  ?><?php
		$attr6_title = '';
		$tmp_tag = 'span';
