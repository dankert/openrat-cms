...
<?php unset($a2_name,$a2_width,$a2_rowclasses,$a2_columnclasses) ?><?php $a3_list='templates';$a3_extract=true;$a3_key='list_key';$a3_value='list_value'; ?><?php
...
?><<?php echo $tmp_tag ?> class="<?php echo $a7_class ?>" title="<?php echo $a7_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a7_class,$a7_var,$a7_escape,$a7_cut) ?></a></td></tr><?php } ?><?php $a3_empty='templates'; ?><?php 
	if	( !isset($$a3_empty) )
...
<?php } ?>
 class="help"
><?php unset($a5_class) ?><?php $a6_class='text';$a6_text='GLOBAL_NO_TEMPLATES_AVAILABLE_DESC';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
