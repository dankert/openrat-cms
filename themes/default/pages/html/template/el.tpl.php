...
<?php unset($a2_name,$a2_width,$a2_rowclasses,$a2_columnclasses) ?><?php $a3_list='el';$a3_extract=true;$a3_key='list_key';$a3_value='list_value'; ?><?php
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_class='text';$a6_key=$type;$a6_prefix='EL_';$a6_escape=true;$a6_cut='both'; ?><?php
...
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_key,$a6_prefix,$a6_escape,$a6_cut) ?></td></tr><?php } ?><?php $a3_empty='el'; ?><?php 
	if	( !isset($$a3_empty) )
...
<?php } ?>
 colspan="2"
><?php unset($a5_colspan) ?><?php $a6_class='text';$a6_key='GLOBAL_NOT_FOUND';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_key,$a6_escape,$a6_cut) ?></td></tr><?php } ?>      </table>
	</td>
  </tr>
</table>
</center>
