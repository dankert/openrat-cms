...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_name='GLOBAL_TEMPLATES';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_class='text';$a6_text='element_type';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
		$langF = $a6_escape?'langHtml':'lang';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_var='text';$a6_value='text'; ?><?php
	if (isset($a6_key))
		$$a6_var = $a6_value[$a6_key];
	else
		$$a6_var = $a6_value;
?><?php unset($a6_var,$a6_value) ?><?php $a6_list='types';$a6_name='type';$a6_default='text';$a6_onchange='';$a6_title='';$a6_class='';$a6_addempty=false;$a6_multiple=false;$a6_size='1';$a6_lang=true; ?><?php
$a6_readonly=false;
$a6_tmp_list = $$a6_list;
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_for='addtotemplate'; ?><label for="id_<?php echo $a6_for ?><?php if (!empty($a6_value)) echo '_'.$a6_value ?>"><?php unset($a6_for) ?><?php $a7_default=true;$a7_readonly=false;$a7_name='addtotemplate'; ?><?php
...
?><?php unset($a7_name); unset($a7_readonly); unset($a7_default); ?><?php unset($a7_default,$a7_readonly,$a7_name) ?><?php $a7_class='text';$a7_key='menu_template_srcelement';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
