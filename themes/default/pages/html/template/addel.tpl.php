...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype,$a2_type) ?><?php $a3_class='line'; ?><div class="<?php echo $a3_class ?>"><?php unset($a3_class) ?><?php $a4_class='label'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><?php $a5_class='text';$a5_text='global_name';$a5_escape=true;$a5_cut='both'; ?><?php
		$a5_title = '';
		$tmp_tag = 'span';
...
?><input type="hidden" id="id_<?php echo $a5_name ?>" name="<?php echo $a5_name ?>" value="<?php echo $tmp_value ?>" /><?php
 } } else { ?><a title="<?php echo langHtml('EDIT') ?>" href="<?php echo Html::url($actionName,$subactionName,0,array('mode'=>'edit')) ?>"><span class="<?php echo $a5_class ?>"><?php echo $tmp_value ?></span></a><?php } ?><?php unset($a5_class,$a5_default,$a5_type,$a5_name,$a5_size,$a5_maxlength,$a5_onchange,$a5_readonly) ?></div></div><?php $a3_class='line'; ?><div class="<?php echo $a3_class ?>"><?php unset($a3_class) ?><?php $a4_class='label'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><?php $a5_class='text';$a5_text='element_type';$a5_escape=true;$a5_cut='both'; ?><?php
		$a5_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a5_class ?>" title="<?php echo $a5_title ?>"><?php
		$langF = $a5_escape?'langHtml':'lang';
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a5_class,$a5_text,$a5_escape,$a5_cut) ?></div><?php $a4_class='input'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><?php $a5_var='text';$a5_value='text'; ?><?php
	if (isset($a5_key))
		$$a5_var = $a5_value[$a5_key];
	else
		$$a5_var = $a5_value;
?><?php unset($a5_var,$a5_value) ?><?php $a5_list='types';$a5_name='type';$a5_default='text';$a5_onchange='';$a5_title='';$a5_class='';$a5_addempty=false;$a5_multiple=false;$a5_size='1';$a5_lang=true; ?><?php
$a5_readonly=false;
$a5_tmp_list = $$a5_list;
...
?><?php unset($a5_list,$a5_name,$a5_default,$a5_onchange,$a5_title,$a5_class,$a5_addempty,$a5_multiple,$a5_size,$a5_lang) ?></div></div><?php $a3_title=lang('options'); ?><fieldset><?php if(isset($a3_title)) { ?><legend><?php if(isset($a3_icon)) { ?><img src="<?php echo $image_dir.'icon_'.$a3_icon.IMG_ICON_EXT ?>" align="left" border="0" /><?php } ?>&nbsp;&nbsp;<?php echo encodeHtml($a3_title) ?>&nbsp;&nbsp;</legend><?php } ?><?php unset($a3_title) ?></fieldset><?php $a3_class='line'; ?><div class="<?php echo $a3_class ?>"><?php unset($a3_class) ?><?php $a4_class='label'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?></div><?php $a4_class='input'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><?php $a5_for='addtotemplate'; ?><label<?php if (isset($a5_for)) { ?> for="id_<?php echo $a5_for ?><?php if (!empty($a5_value)) echo '_'.$a5_value ?>" class="label"<?php } ?>>
<?php if (isset($a5_key)) { echo lang($a5_key); if(hasLang($a5_key.'_desc')) { ?><div class="description"><?php echo lang($a5_key.'_desc')?></div> <?php } } ?><?php unset($a5_for) ?><?php $a6_default=true;$a6_readonly=false;$a6_name='addtotemplate'; ?><?php
...
?><?php unset($a6_name); unset($a6_readonly); unset($a6_default); ?><?php unset($a6_default,$a6_readonly,$a6_name) ?><?php $a6_class='text';$a6_key='menu_template_srcelement';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a6_class ?>" title="<?php echo $a6_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a6_class,$a6_key,$a6_escape,$a6_cut) ?></label></div></div></form>
