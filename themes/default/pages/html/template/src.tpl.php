...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_name='TEMPLATE_SOURCE';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php
...
<?php } ?>
><?php $a6_name='src';$a6_rows='25';$a6_cols='80';$a6_class='inputarea';$a6_default=''; ?><?php if ($this->isEditMode()) {
