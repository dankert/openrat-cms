...
?><?php unset($a3_name,$a3_target,$a3_method,$a3_enctype,$a3_type) ?><?php $a4_name='TEMPLATE_SOURCE';$a4_width='93%';$a4_rowclasses='odd,even';$a4_columnclasses='1,2,3'; ?><?php if (false) { ?>
<div class="window">
<div class="title">
		<?php $icon=$actionName; ?>
...
<?php } ?>
><?php unset($a6_header) ?><?php $a7_name='src';$a7_rows='25';$a7_cols='80';$a7_class='editor';$a7_default=''; ?><?php if ($this->isEditMode()) {
...
<tr
>
<?php $a6_class='act';$a6_header=false; ?><?php $column_idx++; ?><td
<?php if (!empty($column_widths)) { ?>
 width="<?php echo $column_widths[($column_idx-1)%count($column_widths)] ?>"
<?php } ?>
 class="act"
><?php unset($a6_class,$a6_header) ?><?php $a7_type='ok';$a7_class='ok';$a7_value='ok';$a7_text='button_ok'; ?><div class="invisible">
<?php
...
?>
</div><?php unset($a7_type,$a7_class,$a7_value,$a7_text) ?><?php $a7_false=$mode=="edit"; ?><?php 
	...
	{
?>
<?php unset($a7_false) ?><?php $a8_title='';$a8_type='';$a8_class='action';$a8_action='template';$a8_subaction='srcelement';$a8_frame='_self'; ?><?php
	$params = array();
	$tmp_url = '';
	$a8_target = $view;
	switch( $a8_type )
...
?><<?php echo $tmp_tag ?> class="<?php echo $a9_class ?>" title="<?php echo $a9_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a9_class,$a9_key,$a9_escape,$a9_cut) ?></a><?php } ?></td></tr><?php if (false) { ?>
</div>
</div>
<div class="bottom">
	<div class="status">
...
<?php } ?>
<?php } ?></form>
<?php $a3_field='src'; ?><script name="JavaScript" type="text/javascript"><!--
</script>
<?php unset($a3_field) ?>