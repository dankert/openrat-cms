...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php unset($attr5_class) ?><?php unset($attr5_colspan) ?><?php $attr6 = array('not'=>true,'present'=>'done') ?><?php $attr6_not=true ?><?php $attr6_present='done' ?><?php 
...
//			$exec = true;
	...
	if	( $exec )
	{
?><?php unset($attr6) ?><?php unset($attr6_not) ?><?php unset($attr6_present) ?><?php $attr7 = array('type'=>'submit','class'=>'ok','value'=>'ok','text'=>'button_ok') ?><?php $attr7_type='submit' ?><?php $attr7_class='ok' ?><?php $attr7_value='ok' ?><?php $attr7_text='button_ok' ?><?php
	if ($attr7_type=='ok')
	{
		$attr7_type  = 'submit';
//		$attr7_class = 'ok';
...
?><input type="<?php echo $attr7_type ?>" name="<?php echo $attr7_value ?>" class="<?php echo $attr7_class ?>" value="&nbsp;&nbsp;&nbsp;&nbsp;<?php echo lang($attr7_text) ?>&nbsp;&nbsp;&nbsp;&nbsp;" /><?php unset($attr7) ?><?php unset($attr7_type) ?><?php unset($attr7_class) ?><?php unset($attr7_value) ?><?php unset($attr7_text) ?><?php $attr5 = array() ?><?php
	}
	
?><?php unset($attr5) ?><?php $attr4 = array() ?></td><?php unset($attr4) ?><?php $attr3 = array() ?></tr><?php unset($attr3) ?><?php $attr2 = array() ?>      </table>
	</td>
  </tr>
</table>
