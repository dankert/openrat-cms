...
<?php } ?><?php unset($a4_width,$a4_rowclasses,$a4_columnclasses) ?><?php
	$column_idx = 0;
?>
<tr
>
...
<?php } ?>
><?php unset($a6_header) ?><?php $a7_class='text';$a7_text='GLOBAL_NAME';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a6_header) ?><?php $a7_class='name';$a7_var='name';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a7_class ?>" title="<?php echo $a7_title ?>"><?php
		$langF = $a7_escape?'langHtml':'lang';
...
?><?php unset($a9_name); unset($a9_readonly); unset($a9_default); ?><?php unset($a9_default,$a9_readonly,$a9_name) ?><?php $a9_for='delete'; ?><label<?php if (isset($a9_for)) { ?> for="id_<?php echo $a9_for ?><?php if (!empty($a9_value)) echo '_'.$a9_value ?>" class="label"<?php } ?>>
<?php if (isset($a9_key)) { echo lang($a9_key); if(hasLang($a9_key.'_desc')) { ?><div class="description"><?php echo lang($a9_key.'_desc')?></div> <?php } } ?><?php unset($a9_for) ?><?php $a10_class='text';$a10_text='CONFIRM_DELETE';$a10_escape=true;$a10_cut='both'; ?><?php
		$a10_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a10_class ?>" title="<?php echo $a10_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a10_class,$a10_text,$a10_escape,$a10_cut) ?></label></div></fieldset></td></tr><?php
	$column_idx = 0;
?>
<tr
>
...
<?php } ?>
<?php } ?></form>
<?php $a3_field='delete'; ?><script name="JavaScript" type="text/javascript"><!--
</script>
<?php unset($a3_field) ?>