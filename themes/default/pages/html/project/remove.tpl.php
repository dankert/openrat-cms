...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_name='GLOBAL_PROJECT';$a3_icon='group';$a3_widths='20%,80%';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php
...
<?php } ?>
 colspan="2"
><?php unset($a5_colspan) ?><?php $a6_default=false;$a6_readonly=false;$a6_name='delete'; ?><?php
...
?><?php unset($a6_name); unset($a6_readonly); unset($a6_default); ?><?php unset($a6_default,$a6_readonly,$a6_name) ?><?php $a6_for='delete'; ?><label for="id_<?php echo $a6_for ?><?php if (!empty($a6_value)) echo '_'.$a6_value ?>"><?php unset($a6_for) ?><?php $a7_class='text';$a7_text='CONFIRM_DELETE';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
