...
<?php } ?><?php unset($a4_name,$a4_icon,$a4_widths,$a4_width,$a4_rowclasses,$a4_columnclasses) ?><?php
	$column_idx = 0;
?>
<tr
>
...
<?php } ?>
 colspan="3"
><?php unset($a6_colspan,$a6_header) ?><?php $a7_title=lang('options'); ?><fieldset><?php if(isset($a7_title)) { ?><legend><?php if(isset($a7_icon)) { ?><img src="<?php echo $image_dir.'icon_'.$a7_icon.IMG_ICON_EXT ?>" align="left" border="0" /><?php } ?>&nbsp;&nbsp;<?php echo encodeHtml($a7_title) ?>&nbsp;&nbsp;</legend><?php } ?><?php unset($a7_title) ?><div><?php $a9_readonly=false;$a9_name='type';$a9_value='empty';$a9_default=false;$a9_prefix='';$a9_suffix='';$a9_class='';$a9_onchange=''; ?><?php
...
<?php /* #END-IF# */ ?><?php unset($a9_readonly,$a9_name,$a9_value,$a9_default,$a9_prefix,$a9_suffix,$a9_class,$a9_onchange) ?><?php $a9_for='type_empty'; ?><label<?php if (isset($a9_for)) { ?> for="id_<?php echo $a9_for ?><?php if (!empty($a9_value)) echo '_'.$a9_value ?>" class="label"<?php } ?>>
<?php if (isset($a9_key)) { echo lang($a9_key); if(hasLang($a9_key.'_desc')) { ?><div class="description"><?php echo lang($a9_key.'_desc')?></div> <?php } } ?><?php unset($a9_for) ?><?php $a10_class='text';$a10_key='empty';$a10_escape=true;$a10_cut='both'; ?><?php
		$a10_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a10_class ?>" title="<?php echo $a10_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a10_class,$a10_key,$a10_escape,$a10_cut) ?></label></div><div><?php $a9_readonly=false;$a9_name='type';$a9_value='copy';$a9_default=false;$a9_prefix='';$a9_suffix='';$a9_class='';$a9_onchange=''; ?><?php
		if ($this->isEditable() && !$this->isEditMode()) $a9_readonly=true;
		if	( isset($$a9_name)  )
			$a9_tmp_default = $$a9_name;
		elseif ( isset($a9_default) )
			...
			$a9_tmp_default = '';
 ?><input onclick="" class="radio" type="radio" id="id_<?php echo $a9_name.'_'.$a9_value ?>"  name="<?php echo $a9_prefix.$a9_name ?>"<?php if ( $a9_readonly ) echo ' disabled="disabled"' ?> value="<?php echo $a9_value ?>" <?php if($a9_value==$a9_tmp_default) echo 'checked="checked"' ?><?php if (in_array($a9_name,$errors)) echo ' style="borderx:2px dashed red; background-color:red;"' ?> />
<?php /* #END-IF# */ ?><?php unset($a9_readonly,$a9_name,$a9_value,$a9_default,$a9_prefix,$a9_suffix,$a9_class,$a9_onchange) ?><?php $a9_for='type_copy'; ?><label<?php if (isset($a9_for)) { ?> for="id_<?php echo $a9_for ?><?php if (!empty($a9_value)) echo '_'.$a9_value ?>" class="label"<?php } ?>>
...
?><<?php echo $tmp_tag ?> class="<?php echo $a10_class ?>" title="<?php echo $a10_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a10_class,$a10_key,$a10_escape,$a10_cut) ?></label><?php $a9_list='projects';$a9_name='projectid';$a9_onchange='';$a9_title='';$a9_class='';$a9_addempty=false;$a9_multiple=false;$a9_size='1';$a9_lang=false; ?><?php
$a9_readonly=false;
$a9_tmp_list = $$a9_list;
...
?><?php unset($a9_list,$a9_name,$a9_onchange,$a9_title,$a9_class,$a9_addempty,$a9_multiple,$a9_size,$a9_lang) ?></div></fieldset></td></tr><?php
	$column_idx = 0;
?>
<tr
>
