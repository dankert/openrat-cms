...
?><?php unset($a3_name,$a3_target,$a3_method,$a3_enctype,$a3_type) ?><?php $a4_name='element';$a4_width='93%';$a4_rowclasses='odd,even';$a4_columnclasses='1,2,3'; ?><?php if (false) { ?>
<div class="window">
<div class="title">
		<?php $icon=$actionName; ?>
...
<?php } ?>
 class="help"
 colspan="2"
><?php unset($a6_class,$a6_colspan,$a6_header) ?><?php $a7_class='text';$a7_var='desc';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
...
<?php } ?>
 colspan="2"
><?php unset($a6_colspan,$a6_header) ?><?php $a7_list='objects';$a7_name='linkobjectid';$a7_onchange='';$a7_title='';$a7_class='';$a7_addempty=false;$a7_multiple=false;$a7_size='1';$a7_lang=false; ?><?php
$a7_readonly=false;
$a7_tmp_list = $$a7_list;
...
?><?php unset($a7_list,$a7_name,$a7_onchange,$a7_title,$a7_class,$a7_addempty,$a7_multiple,$a7_size,$a7_lang) ?></td></tr><?php $a5_present='release'; ?><?php 
...
<?php } ?>
 colspan="2"
><?php unset($a7_colspan,$a7_header) ?><?php $a8_default=false;$a8_readonly=false;$a8_name='release'; ?><?php
...
<?php } ?>
 colspan="2"
><?php unset($a7_colspan,$a7_header) ?><?php $a8_default=false;$a8_readonly=false;$a8_name='publish'; ?><?php
	if ($this->isEditable() && !$this->isEditMode()) $a8_readonly=true;
	if	( isset($$a8_name) )
		$checked = $$a8_name;
	else
...
<?php } ?>
<?php } ?></form>
<?php $a3_field='linko'; ?><script name="JavaScript" type="text/javascript"><!--
</script>
<?php unset($a3_field) ?>