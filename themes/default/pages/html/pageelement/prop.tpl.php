...
<?php } ?>
 colspan="2"
><?php unset($a6_colspan) ?><?php $a7_title=lang('DOCUMENT_TREE'); ?><fieldset><?php if(isset($a7_title)) { ?><legend><?php echo encodeHtml($a7_title) ?></legend><?php } ?><?php unset($a7_title) ?></fieldset></td></tr><?php
	$row_idx++;
	$column_idx = 0;
?>
<tr
