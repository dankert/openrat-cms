...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_name='import';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='a'; ?><?php
...
<?php } ?>
><?php $a6_list='types';$a6_name='type';$a6_onchange='';$a6_title='';$a6_class='';$a6_addempty=false;$a6_multiple=false;$a6_size='1';$a6_lang=false; ?><?php
$a6_readonly=false;
$a6_tmp_list = $$a6_list;
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_type='ok';$a6_class='ok';$a6_value='ok';$a6_text='button_ok'; ?><?php
		if ($this->isEditable() && !$this->isEditMode())
		$a6_text = 'MODE_EDIT';
		$a6_type = 'submit';
