...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php unset($attr_width) ?><?php unset($attr_style) ?><?php unset($attr_class) ?><?php unset($attr_colspan) ?><?php $attr = array('list'=>'objects','name'=>'linkobjectid','default'=>'','onchange'=>'','title'=>'','class'=>'') ?><?php $attr_list='objects' ?><?php $attr_name='linkobjectid' ?><?php $attr_default='' ?><?php $attr_onchange='' ?><?php $attr_title='' ?><?php $attr_class='' ?><select size="1" name="<?php echo $attr_name ?>" onchange="<?php echo $attr_onchange ?>" title="<?php echo $attr_title ?>" class="<?php echo $attr_class ?>"<?php
...
<?php } ?>
<?php unset($attr) ?><?php $attr = array() ?></form><?php unset($attr) ?><?php $attr = array('field'=>'linkobjectid') ?><?php $attr_field='linkobjectid' ?><script name="JavaScript" type="text/javascript"><!--
