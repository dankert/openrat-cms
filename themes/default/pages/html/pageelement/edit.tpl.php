...
<?php unset($attr1_class); ?><?php  $attr2_name='';  $attr2_target='_self';  $attr2_method='post';  $attr2_enctype='application/x-www-form-urlencoded';  ?>    <?php
    ...
    ?><?php unset($attr2_name);unset($attr2_target);unset($attr2_method);unset($attr2_enctype); ?><?php  $attr3_class='';  $attr3_default='';  $attr3_type='hidden';  $attr3_name='elementid';  $attr3_size='40';  $attr3_maxlength='256';  $attr3_onchange='';  $attr3_readonly=false;  ?>      <?php if ($this->isEditable() && !$this->isEditMode()) $attr3_readonly=true;
...
<?php unset($attr3_name);unset($attr3_width);unset($attr3_rowclasses);unset($attr3_columnclasses); ?><?php  ?>        <?php
        ...
        ?><tr class="<?php echo $attr4_class ?>"><?php  ?><?php  $attr5_class='help';  $attr5_colspan='2';  ?>          <?php
          	$column_class_idx++;
...
<?php unset($attr4_equals);unset($attr4_value); ?><?php  ?>          <?php
          ...
          ?><tr class="<?php echo $attr5_class ?>"><?php  ?><?php  $attr6_colspan='2';  ?>            <?php
            ...
            if	( isset($attr6_colspan)) { ?> colspan="<?php echo $attr6_colspan ?>" <?php }
            if	( isset($attr6_rowspan)) { ?> rowspan="<?php echo $attr6_rowspan ?>" <?php }
            ?>><?php unset($attr6_colspan); ?><?php  $attr7_class='calendar';  $attr7_width='85%';  $attr7_space='0px';  $attr7_padding='0px';  $attr7_rowclasses='odd,even';  ?>              <?php
              	$coloumn_widths=array();
              	$row_classes   = array('');
              ...
              ?><table class="<?php echo $attr7_class ?>" cellspacing="<?php echo $attr7_space ?>" width="<?php echo $attr7_width ?>" cellpadding="<?php echo $attr7_padding ?>"><?php unset($attr7_class);unset($attr7_width);unset($attr7_space);unset($attr7_padding);unset($attr7_rowclasses); ?><?php  ?>                <?php
                	$row_class_idx++;
                	if ($row_class_idx > count($row_classes))
                		$row_class_idx=1;
                	$row_class=$row_classes[$row_class_idx-1];
                	...
                	$cell_column_nr=0;
                	$column_class_idx = 999;
                ?><tr class="<?php echo $attr8_class ?>"><?php  ?><?php  $attr9_class='help';  $attr9_colspan='8';  ?>                  <?php
                  	$column_class_idx++;
                  	if ($column_class_idx > count($column_classes))
                  		$column_class_idx=1;
                  	$column_class=$column_classes[$column_class_idx-1];
...
<?php unset($attr10_true); ?><?php  $attr11_class='text';  $attr11_raw='_';  $attr11_escape=true;  ?>                      <?php
                	...
                	$cell_column_nr=0;
                	$column_class_idx = 999;
                ?><tr class="<?php echo $attr8_class ?>"><?php  ?><?php  ?>                  <?php
                  	$column_class_idx++;
                  	if ($column_class_idx > count($column_classes))
                  		$column_class_idx=1;
                  	$column_class=$column_classes[$column_class_idx-1];
                ...
                ?><?php unset($attr8_list);unset($attr8_extract);unset($attr8_key);unset($attr8_value); ?><?php  ?>                  <?php
                  	...
                  	$cell_column_nr=0;
                  	$column_class_idx = 999;
                  ?><tr class="<?php echo $attr9_class ?>"><?php  ?><?php  $attr10_width='12%';  ?>                    <?php
                    	$column_class_idx++;
                    	if ($column_class_idx > count($column_classes))
                    		$column_class_idx=1;
                    	$column_class=$column_classes[$column_class_idx-1];
...
<?php unset($attr12_true); ?><?php  $attr13_class='text';  $attr13_raw='*';  $attr13_escape=true;  ?>                          <?php
            	...
            	$cell_column_nr=0;
            	$column_class_idx = 999;
            ?><tr class="<?php echo $attr6_class ?>"><?php  ?><?php  $attr7_colspan='2';  ?>              <?php
              	$column_class_idx++;
              	if ($column_class_idx > count($column_classes))
              		$column_class_idx=1;
              	$column_class=$column_classes[$column_class_idx-1];
              ...
              ?>><?php unset($attr7_colspan); ?><?php  $attr8_title=lang('date');  ?>                <fieldset><?php if(isset($attr8_title)) { ?><legend><?php echo encodeHtml($attr8_title) ?></legend><?php } ?><?php unset($attr8_title); ?><?php  ?>              </fieldset><?php  ?><?php  ?>            </td><?php  ?><?php  ?>          </tr><?php  ?><?php  ?>            <?php
            	...
            	$cell_column_nr=0;
            	$column_class_idx = 999;
            ?><tr class="<?php echo $attr6_class ?>"><?php  ?><?php  ?>              <?php
              	$column_class_idx++;
              	if ($column_class_idx > count($column_classes))
              		$column_class_idx=1;
              	$column_class=$column_classes[$column_class_idx-1];
...
<?php unset($attr4_equals);unset($attr4_value); ?><?php  ?>          <?php
          	...
          	$cell_column_nr=0;
          	$column_class_idx = 999;
          ?><tr class="<?php echo $attr5_class ?>"><?php  ?><?php  $attr6_class='fx';  $attr6_colspan='2';  ?>            <?php
            	$column_class_idx++;
            	if ($column_class_idx > count($column_classes))
            		$column_class_idx=1;
            	$column_class=$column_classes[$column_class_idx-1];
            ...
            if	( isset($attr6_colspan)) { ?> colspan="<?php echo $attr6_colspan ?>" <?php }
            if	( isset($attr6_rowspan)) { ?> rowspan="<?php echo $attr6_rowspan ?>" <?php }
            ?>><?php unset($attr6_class);unset($attr6_colspan); ?><?php  $attr7_class='text';  $attr7_default='';  $attr7_type='text';  $attr7_name='text';  $attr7_size='50';  $attr7_maxlength='255';  $attr7_onchange='';  $attr7_readonly=false;  ?>              <?php if ($this->isEditable() && !$this->isEditMode()) $attr7_readonly=true;
...
<?php unset($attr4_equals);unset($attr4_value); ?><?php  ?>          <?php
          ...
          ?><tr class="<?php echo $attr5_class ?>"><?php  ?><?php  $attr6_class='fx';  $attr6_colspan='2';  ?>            <?php
            ...
            if	( isset($attr6_colspan)) { ?> colspan="<?php echo $attr6_colspan ?>" <?php }
            if	( isset($attr6_rowspan)) { ?> rowspan="<?php echo $attr6_rowspan ?>" <?php }
            ?>><?php unset($attr6_class);unset($attr6_colspan); ?><?php  $attr7_equals='html';  $attr7_value=$editor;  ?>              <?php 
...
<?php unset($attr8_present); ?><?php  $attr9_title=lang('page_preview');  ?>                  <fieldset><?php if(isset($attr9_title)) { ?><legend><?php echo encodeHtml($attr9_title) ?></legend><?php } ?><?php unset($attr9_title); ?><?php  $attr10_class='text';  $attr10_var='preview';  $attr10_escape=false;  ?>                    <?php
                ...
                ?><?php unset($attr8_name);unset($attr8_type); ?><?php  $attr8_true=$mode=="edit";  ?>                <?php 
                	...
                	{
                ?>
<?php unset($attr8_true); ?><?php  $attr9_title=lang('help');  ?>                  <fieldset><?php if(isset($attr9_title)) { ?><legend><?php echo encodeHtml($attr9_title) ?></legend><?php } ?><?php unset($attr9_title); ?><?php  ?>                </fieldset><?php  ?><?php  $attr9_width='100%';  $attr9_space='0px';  $attr9_padding='0px';  $attr9_rowclasses='odd,even';  ?>                  <?php
                  	$coloumn_widths=array();
                  	$row_classes   = array('');
                  	$column_classes= array('');
                  	if(empty($attr9_class))
                  ...
                  ?><table class="<?php echo $attr9_class ?>" cellspacing="<?php echo $attr9_space ?>" width="<?php echo $attr9_width ?>" cellpadding="<?php echo $attr9_padding ?>"><?php unset($attr9_width);unset($attr9_space);unset($attr9_padding);unset($attr9_rowclasses); ?><?php  ?>                    <?php
                    	$column_class_idx++;
                    	if ($column_class_idx > count($column_classes))
                    		$column_class_idx=1;
                    	$column_class=$column_classes[$column_class_idx-1];
...
<?php unset($attr5_true); ?><?php  ?>            <?php
            ...
            ?><tr class="<?php echo $attr6_class ?>"><?php  ?><?php  ?>              <?php
              ...
              if	( isset($attr7_colspan)) { ?> colspan="<?php echo $attr7_colspan ?>" <?php }
              if	( isset($attr7_rowspan)) { ?> rowspan="<?php echo $attr7_rowspan ?>" <?php }
              ?>><?php  ?><?php  $attr8_class='';  $attr8_default='';  $attr8_type='text';  $attr8_name='linkurl';  $attr8_size='40';  $attr8_maxlength='256';  $attr8_onchange='';  $attr8_readonly=false;  ?>                <?php if ($this->isEditable() && !$this->isEditMode()) $attr8_readonly=true;
...
<?php unset($attr6_present); ?><?php  ?>              <?php
              	...
              	$cell_column_nr=0;
              	$column_class_idx = 999;
              ?><tr class="<?php echo $attr7_class ?>"><?php  ?><?php  $attr8_colspan='2';  ?>                <?php
                	$column_class_idx++;
                	if ($column_class_idx > count($column_classes))
                		$column_class_idx=1;
                	$column_class=$column_classes[$column_class_idx-1];
...
<?php unset($attr5_present); ?><?php  ?>            <?php
            	...
            	$cell_column_nr=0;
            	$column_class_idx = 999;
            ?><tr class="<?php echo $attr6_class ?>"><?php  ?><?php  $attr7_class='fx';  $attr7_colspan='2';  ?>              <?php
              	$column_class_idx++;
              	if ($column_class_idx > count($column_classes))
              		$column_class_idx=1;
              	$column_class=$column_classes[$column_class_idx-1];
              ...
              if	( isset($attr7_colspan)) { ?> colspan="<?php echo $attr7_colspan ?>" <?php }
              if	( isset($attr7_rowspan)) { ?> rowspan="<?php echo $attr7_rowspan ?>" <?php }
              ?>><?php unset($attr7_class);unset($attr7_colspan); ?><?php  $attr8_default=false;  $attr8_readonly=false;  $attr8_name='release';  ?>                <?php
...
<?php unset($attr5_present); ?><?php  ?>            <?php
            ...
            ?><tr class="<?php echo $attr6_class ?>"><?php  ?><?php  $attr7_class='fx';  $attr7_colspan='2';  ?>              <?php
              ...
              if	( isset($attr7_colspan)) { ?> colspan="<?php echo $attr7_colspan ?>" <?php }
              if	( isset($attr7_rowspan)) { ?> rowspan="<?php echo $attr7_rowspan ?>" <?php }
              ?>><?php unset($attr7_class);unset($attr7_colspan); ?><?php  $attr8_default=false;  $attr8_readonly=false;  $attr8_name='publish';  ?>                <?php
                	if ($this->isEditable() && !$this->isEditMode()) $attr8_readonly=true;
                	if	( isset($$attr8_name) )
                		$checked = $$attr8_name;
                	else
