...
<?php unset($attr3) ?><?php unset($attr3_title) ?><?php unset($attr3_name) ?><?php unset($attr3_widths) ?><?php unset($attr3_width) ?><?php unset($attr3_rowclasses) ?><?php unset($attr3_columnclasses) ?><?php $attr4_debug_info = 'a:1:{s:5:"empty";s:2:"el";}' ?><?php $attr4 = array('empty'=>'el') ?><?php $attr4_empty='el' ?><?php 
	if	( isset($attr4_true) )
	{
...
?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($attr7) ?><?php unset($attr7_class) ?><?php unset($attr7_text) ?><?php unset($attr7_escape) ?><?php $attr5_debug_info = 'a:0:{}' ?><?php $attr5 = array() ?></td><?php unset($attr5) ?><?php $attr4_debug_info = 'a:0:{}' ?><?php $attr4 = array() ?></tr><?php unset($attr4) ?><?php $attr3_debug_info = 'a:0:{}' ?><?php $attr3 = array() ?><?php } ?><?php unset($attr3) ?><?php $attr4_debug_info = 'a:2:{s:6:"invert";s:4:"true";s:5:"empty";s:2:"el";}' ?><?php $attr4 = array('invert'=>true,'empty'=>'el') ?><?php $attr4_invert=true ?><?php $attr4_empty='el' ?><?php 
	if	( isset($attr4_true) )
	{
		if	(gettype($attr4_true) === '' && gettype($attr4_true) === '1')
			$exec = $$attr4_true == true;
...
?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($attr7) ?><?php unset($attr7_class) ?><?php unset($attr7_text) ?><?php unset($attr7_escape) ?><?php $attr5_debug_info = 'a:0:{}' ?><?php $attr5 = array() ?></td><?php unset($attr5) ?><?php $attr4_debug_info = 'a:0:{}' ?><?php $attr4 = array() ?></tr><?php unset($attr4) ?><?php $attr5_debug_info = 'a:4:{s:4:"list";s:2:"el";s:7:"extract";s:4:"true";s:3:"key";s:8:"list_key";s:5:"value";s:10:"list_value";}' ?><?php $attr5 = array('list'=>'el','extract'=>true,'key'=>'list_key','value'=>'list_value') ?><?php $attr5_list='el' ?><?php $attr5_extract=true ?><?php $attr5_key='list_key' ?><?php $attr5_value='list_value' ?><?php
...
?><td <?php foreach( $attr7 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr7) ?><?php unset($attr7_class) ?><?php $attr8_debug_info = 'a:1:{s:3:"for";s:10:"var:saveid";}' ?><?php $attr8 = array('for'=>$saveid) ?><?php $attr8_for=$saveid ?><label for="id_<?php echo $attr8_for ?><?php if (!empty($attr8_value)) echo '_'.$attr8_value ?>"><?php unset($attr8) ?><?php unset($attr8_for) ?><?php $attr9_debug_info = 'a:2:{s:5:"align";s:4:"left";s:11:"elementtype";s:8:"var:type";}' ?><?php $attr9 = array('align'=>'left','elementtype'=>$type) ?><?php $attr9_align='left' ?><?php $attr9_elementtype=$type ?><?php
...
?><img src="<?php echo $image_dir.$attr9_file.IMG_ICON_EXT ?>" border="0" align="<?php echo $attr9_align ?>"><?php } ?><?php unset($attr9) ?><?php unset($attr9_align) ?><?php unset($attr9_elementtype) ?><?php $attr9_debug_info = 'a:3:{s:5:"class";s:4:"text";s:3:"var";s:4:"name";s:6:"escape";s:4:"true";}' ?><?php $attr9 = array('class'=>'text','var'=>'name','escape'=>true) ?><?php $attr9_class='text' ?><?php $attr9_var='name' ?><?php $attr9_escape=true ?><?php
...
?><<?php echo $tmp_tag ?> class="<?php echo $attr9_class ?>" title="<?php echo $attr9_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($attr9) ?><?php unset($attr9_class) ?><?php unset($attr9_var) ?><?php unset($attr9_escape) ?><?php $attr7_debug_info = 'a:0:{}' ?><?php $attr7 = array() ?></label><?php unset($attr7) ?><?php $attr6_debug_info = 'a:0:{}' ?><?php $attr6 = array() ?></td><?php unset($attr6) ?><?php $attr7_debug_info = 'a:1:{s:5:"class";s:2:"fx";}' ?><?php $attr7 = array('class'=>'fx') ?><?php $attr7_class='fx' ?><?php
	$column_class_idx++;
	if ($column_class_idx > count($column_classes))
		$column_class_idx=1;
	$column_class=$column_classes[$column_class_idx-1];
...
?><input type="hidden" id="id_<?php echo $attr9_name ?>" name="<?php echo $attr9_name ?>" value="<?php echo isset($$attr9_name)?$$attr9_name:$attr9_default ?>" /><?php
 } } else { ?><span class="<?php echo $attr9_class ?>"><?php echo isset($$attr9_name)?$$attr9_name:$attr9_default ?></span><?php } ?><?php unset($attr9) ?><?php unset($attr9_class) ?><?php unset($attr9_default) ?><?php unset($attr9_type) ?><?php unset($attr9_index) ?><?php unset($attr9_name) ?><?php unset($attr9_size) ?><?php unset($attr9_maxlength) ?><?php unset($attr9_onchange) ?><?php unset($attr9_readonly) ?><?php $attr7_debug_info = 'a:0:{}' ?><?php $attr7 = array() ?><?php } ?><?php unset($attr7) ?><?php $attr8_debug_info = 'a:2:{s:6:"equals";s:8:"longtext";s:5:"value";s:8:"var:type";}' ?><?php $attr8 = array('equals'=>'longtext','value'=>$type) ?><?php $attr8_equals='longtext' ?><?php $attr8_value=$type ?><?php 
	if	( isset($attr8_true) )
	{
		if	(gettype($attr8_true) === '' && gettype($attr8_true) === '1')
			$exec = $$attr8_true == true;
	...
	{
?>
<?php unset($attr8) ?><?php unset($attr8_equals) ?><?php unset($attr8_value) ?><?php $attr9_debug_info = 'a:7:{s:4:"name";s:6:"var:id";s:4:"rows";s:1:"7";s:4:"cols";s:2:"50";s:5:"index";s:4:"true";s:8:"onchange";s:8:"onchange";s:5:"class";s:0:"";s:7:"default";s:9:"var:value";}' ?><?php $attr9 = array('name'=>$id,'rows'=>'7','cols'=>'50','index'=>true,'onchange'=>'onchange','class'=>'','default'=>$value) ?><?php $attr9_name=$id ?><?php $attr9_rows='7' ?><?php $attr9_cols='50' ?><?php $attr9_index=true ?><?php $attr9_onchange='onchange' ?><?php $attr9_class='' ?><?php $attr9_default=$value ?><?php if ($this->isEditable() && $this->getRequestVar('mode')!='edit') $attr9_readonly=true;
      if ( !$attr9_readonly) {
...
?><span class="<?php echo $attr9_class ?>"><?php echo isset($$attr9_name)?$$attr9_name:$attr9_default ?></span><?php } ?><?php unset($attr9) ?><?php unset($attr9_name) ?><?php unset($attr9_rows) ?><?php unset($attr9_cols) ?><?php unset($attr9_index) ?><?php unset($attr9_onchange) ?><?php unset($attr9_class) ?><?php unset($attr9_default) ?><?php $attr7_debug_info = 'a:0:{}' ?><?php $attr7 = array() ?><?php } ?><?php unset($attr7) ?><?php $attr8_debug_info = 'a:2:{s:5:"value";s:8:"var:type";s:8:"contains";s:16:"select,link,list";}' ?><?php $attr8 = array('value'=>$type,'contains'=>'select,link,list') ?><?php $attr8_value=$type ?><?php $attr8_contains='select,link,list' ?><?php 
	if	( isset($attr8_true) )
	{
		if	(gettype($attr8_true) === '' && gettype($attr8_true) === '1')
			$exec = $$attr8_true == true;
	...
	{
?>
<?php unset($attr8) ?><?php unset($attr8_value) ?><?php unset($attr8_contains) ?><?php $attr9_debug_info = 'a:10:{s:4:"list";s:4:"list";s:4:"name";s:6:"var:id";s:7:"default";s:9:"var:value";s:8:"onchange";s:0:"";s:5:"title";s:0:"";s:5:"class";s:0:"";s:8:"addempty";s:5:"false";s:8:"multiple";s:5:"false";s:4:"size";s:1:"1";s:4:"lang";s:5:"false";}' ?><?php $attr9 = array('list'=>'list','name'=>$id,'default'=>$value,'onchange'=>'','title'=>'','class'=>'','addempty'=>false,'multiple'=>false,'size'=>'1','lang'=>false) ?><?php $attr9_list='list' ?><?php $attr9_name=$id ?><?php $attr9_default=$value ?><?php $attr9_onchange='' ?><?php $attr9_title='' ?><?php $attr9_class='' ?><?php $attr9_addempty=false ?><?php $attr9_multiple=false ?><?php $attr9_size='1' ?><?php $attr9_lang=false ?><?php
if ($this->isEditable() && $this->getRequestVar('mode')!='edit') $attr9_readonly=true;
...
?><?php unset($attr9) ?><?php unset($attr9_list) ?><?php unset($attr9_name) ?><?php unset($attr9_default) ?><?php unset($attr9_onchange) ?><?php unset($attr9_title) ?><?php unset($attr9_class) ?><?php unset($attr9_addempty) ?><?php unset($attr9_multiple) ?><?php unset($attr9_size) ?><?php unset($attr9_lang) ?><?php $attr7_debug_info = 'a:0:{}' ?><?php $attr7 = array() ?><?php } ?><?php unset($attr7) ?><?php $attr6_debug_info = 'a:0:{}' ?><?php $attr6 = array() ?></td><?php unset($attr6) ?><?php $attr5_debug_info = 'a:0:{}' ?><?php $attr5 = array() ?></tr><?php unset($attr5) ?><?php $attr4_debug_info = 'a:0:{}' ?><?php $attr4 = array() ?><?php } ?><?php unset($attr4) ?><?php $attr5_debug_info = 'a:1:{s:7:"present";s:7:"release";}' ?><?php $attr5 = array('present'=>'release') ?><?php $attr5_present='release' ?><?php 
	if	( isset($attr5_true) )
	{
...
?><<?php echo $tmp_tag ?> class="<?php echo $attr9_class ?>" title="<?php echo $attr9_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($attr9) ?><?php unset($attr9_class) ?><?php unset($attr9_raw) ?><?php unset($attr9_escape) ?><?php $attr9_debug_info = 'a:3:{s:5:"class";s:4:"text";s:4:"text";s:14:"GLOBAL_RELEASE";s:6:"escape";s:4:"true";}' ?><?php $attr9 = array('class'=>'text','text'=>'GLOBAL_RELEASE','escape'=>true) ?><?php $attr9_class='text' ?><?php $attr9_text='GLOBAL_RELEASE' ?><?php $attr9_escape=true ?><?php
	if	( isset($attr9_prefix)&& isset($attr9_key))
		$attr9_key = $attr9_prefix.$attr9_key;
	if	( isset($attr9_suffix)&& isset($attr9_key))
		$attr9_key = $attr9_key.$attr9_suffix;
...
?><<?php echo $tmp_tag ?> class="<?php echo $attr9_class ?>" title="<?php echo $attr9_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($attr9) ?><?php unset($attr9_class) ?><?php unset($attr9_raw) ?><?php unset($attr9_escape) ?><?php $attr9_debug_info = 'a:3:{s:5:"class";s:4:"text";s:4:"text";s:23:"PAGE_PUBLISH_AFTER_SAVE";s:6:"escape";s:4:"true";}' ?><?php $attr9 = array('class'=>'text','text'=>'PAGE_PUBLISH_AFTER_SAVE','escape'=>true) ?><?php $attr9_class='text' ?><?php $attr9_text='PAGE_PUBLISH_AFTER_SAVE' ?><?php $attr9_escape=true ?><?php
	if	( isset($attr9_prefix)&& isset($attr9_key))
		$attr9_key = $attr9_prefix.$attr9_key;
	if	( isset($attr9_suffix)&& isset($attr9_key))
		$attr9_key = $attr9_key.$attr9_suffix;
...
?><<?php echo $tmp_tag ?> class="<?php echo $attr9_class ?>" title="<?php echo $attr9_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($attr9) ?><?php unset($attr9_class) ?><?php unset($attr9_text) ?><?php unset($attr9_escape) ?><?php $attr7_debug_info = 'a:0:{}' ?><?php $attr7 = array() ?></label><?php unset($attr7) ?><?php $attr6_debug_info = 'a:0:{}' ?><?php $attr6 = array() ?></td><?php unset($attr6) ?><?php $attr5_debug_info = 'a:0:{}' ?><?php $attr5 = array() ?></tr><?php unset($attr5) ?><?php $attr4_debug_info = 'a:0:{}' ?><?php $attr4 = array() ?><?php } ?><?php unset($attr4) ?><?php $attr5_debug_info = 'a:0:{}' ?><?php $attr5 = array() ?><?php
	$row_class_idx++;
	if ($row_class_idx > count($row_classes))
		$row_class_idx=1;
	$row_class=$row_classes[$row_class_idx-1];
