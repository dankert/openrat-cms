<?php $attr1 = array('file'=>'header') ?><?php $attr1_file='header' ?><?php include( $tpl_dir.$attr1_file.'.tpl.php') ?><?php unset($attr1) ?><?php unset($attr1_file) ?><?php $attr2 = array('action'=>'page','subaction'=>'saveform','name'=>'','target'=>'_self','method'=>'post','enctype'=>'application/x-www-form-urlencoded') ?><?php $attr2_action='page' ?><?php $attr2_subaction='saveform' ?><?php $attr2_name='' ?><?php $attr2_target='_self' ?><?php $attr2_method='post' ?><?php $attr2_enctype='application/x-www-form-urlencoded' ?><?php
...
?><td <?php foreach( $attr6 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr6) ?><?php unset($attr6_class) ?><?php $attr7 = array('class'=>'text','text'=>'PAGE_ELEMENT_NAME') ?><?php $attr7_class='text' ?><?php $attr7_text='PAGE_ELEMENT_NAME' ?><?php
	if	( isset($attr7_prefix)&& isset($attr7_key))
		$attr7_key = $attr7_prefix.$attr7_key;
	if	( isset($attr7_suffix)&& isset($attr7_key))
		$attr7_key = $attr7_key.$attr7_suffix;
...
?><span class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
	...
	echo $tmp_text;
?></span><?php unset($attr7) ?><?php unset($attr7_class) ?><?php unset($attr7_text) ?><?php $attr5 = array() ?></td><?php unset($attr5) ?><?php $attr6 = array('class'=>'help') ?><?php $attr6_class='help' ?><?php
//	if (empty($attr6_class))
//		$attr6['class']=$row_class;
	$column_class_idx++;
	if ($column_class_idx > count($column_classes))
...
?><td <?php foreach( $attr6 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr6) ?><?php unset($attr6_class) ?><?php $attr7 = array('class'=>'text','text'=>'GLOBAL_CHANGE') ?><?php $attr7_class='text' ?><?php $attr7_text='GLOBAL_CHANGE' ?><?php
	if	( isset($attr7_prefix)&& isset($attr7_key))
		$attr7_key = $attr7_prefix.$attr7_key;
	if	( isset($attr7_suffix)&& isset($attr7_key))
		$attr7_key = $attr7_key.$attr7_suffix;
...
?><td <?php foreach( $attr6 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr6) ?><?php unset($attr6_class) ?><?php $attr7 = array('class'=>'text','text'=>'GLOBAL_VALUE') ?><?php $attr7_class='text' ?><?php $attr7_text='GLOBAL_VALUE' ?><?php
	if	( isset($attr7_prefix)&& isset($attr7_key))
		$attr7_key = $attr7_prefix.$attr7_key;
	if	( isset($attr7_suffix)&& isset($attr7_key))
		$attr7_key = $attr7_key.$attr7_suffix;
...
?><span class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
	...
	echo $tmp_text;
?></span><?php unset($attr7) ?><?php unset($attr7_class) ?><?php unset($attr7_text) ?><?php $attr5 = array() ?></td><?php unset($attr5) ?><?php $attr4 = array() ?></tr><?php unset($attr4) ?><?php $attr5 = array('list'=>'el','extract'=>true,'key'=>'list_key','value'=>'list_value') ?><?php $attr5_list='el' ?><?php $attr5_extract=true ?><?php $attr5_key='list_key' ?><?php $attr5_value='list_value' ?><?php
...
?><img src="<?php echo $image_dir.$attr8_file.IMG_ICON_EXT ?>" border="0" align="<?php echo $attr8_align ?>"><?php } ?><?php unset($attr8) ?><?php unset($attr8_align) ?><?php unset($attr8_elementtype) ?><?php $attr8 = array('class'=>'text','var'=>'name') ?><?php $attr8_class='text' ?><?php $attr8_var='name' ?><?php
...
?><span class="<?php echo $attr8_class ?>" title="<?php echo $attr8_title ?>"><?php
	...
	echo $tmp_text;
?></span><?php unset($attr8) ?><?php unset($attr8_class) ?><?php unset($attr8_var) ?><?php $attr6 = array() ?></td><?php unset($attr6) ?><?php $attr7 = array('class'=>'fx') ?><?php $attr7_class='fx' ?><?php
//	if (empty($attr7_class))
//		$attr7['class']=$row_class;
	$column_class_idx++;
	if ($column_class_idx > count($column_classes))
...
?><td <?php foreach( $attr7 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr7) ?><?php unset($attr7_class) ?>