...
?><tr class="<?php echo $attr4_class ?>"><?php unset($attr4) ?><?php $attr5_debug_info = 'a:2:{s:5:"class";s:3:"act";s:7:"colspan";s:1:"2";}' ?><?php $attr5 = array('class'=>'act','colspan'=>'2') ?><?php $attr5_class='act' ?><?php $attr5_colspan='2' ?><?php
	...
	if	( isset($column_widths[$cell_column_nr-1]) && !isset($attr5_rowspan) )
		$attr5['width']=$column_widths[$cell_column_nr-1];
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php unset($attr5_class) ?><?php unset($attr5_colspan) ?><?php $attr6_debug_info = 'a:4:{s:4:"type";s:2:"ok";s:5:"class";s:2:"ok";s:5:"value";s:2:"ok";s:4:"text";s:19:"message:button_next";}' ?><?php $attr6 = array('type'=>'ok','class'=>'ok','value'=>'ok','text'=>lang('button_next')) ?><?php $attr6_type='ok' ?><?php $attr6_class='ok' ?><?php $attr6_value='ok' ?><?php $attr6_text=lang('button_next') ?><?php
	if ($attr6_type=='ok')
	{
...
<?php unset($attr1) ?><?php $attr2_debug_info = 'a:1:{s:5:"field";s:10:"templateid";}' ?><?php $attr2 = array('field'=>'templateid') ?><?php $attr2_field='templateid' ?><?php
