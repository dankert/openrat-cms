...
?></<?php echo $tmp_tag ?>><?php unset($attr6_class);unset($attr6_text);unset($attr6_escape); ?><?php  ?></td><?php  ?><?php  ?><?php
	...
	if	( isset($column_widths[$cell_column_nr-1]) && !isset($attr5_rowspan) )
		$attr5_width=$column_widths[$cell_column_nr-1];
?><td<?php
?>><?php  ?><?php  $attr6_title='';  $attr6_target='_self';  $attr6_url='template_url';  $attr6_class='';  ?><?php
	$params = array();
		$tmp_url = $attr6_url;
...
?>><?php unset($attr5_class);unset($attr5_colspan); ?><?php  $attr6_type='ok';  $attr6_class='ok';  $attr6_value='ok';  $attr6_text=lang('button_next');  ?><?php
		if ($this->isEditable() && !$this->isEditMode())
