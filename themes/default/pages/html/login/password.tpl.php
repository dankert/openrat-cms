...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype,$a2_type) ?><?php $a3_name='password'; ?><img src="<?php echo $image_dir.'logo_'.$a3_name.IMG_ICON_EXT ?>" border="0" align="left" /><h2 class="logo"><?php echo langHtml('logo_'.$a3_name) ?></h2><p class="logo"><?php echo langHtml('logo_'.$a3_name.'_text') ?></p><?php unset($a3_name) ?><?php $a3_class='line'; ?><div class="<?php echo $a3_class ?>"><?php unset($a3_class) ?><?php $a4_class='label'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><?php $a5_class='text';$a5_text='USER_USERNAME';$a5_escape=true;$a5_cut='both'; ?><?php
		$a5_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a5_class ?>" title="<?php echo $a5_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a5_class,$a5_text,$a5_escape,$a5_cut) ?></div><?php $a4_class='input'; ?><div class="<?php echo $a4_class ?>"><?php unset($a4_class) ?><?php $a5_class='focus';$a5_default='';$a5_type='text';$a5_name='username';$a5_value='';$a5_size='';$a5_maxlength='256';$a5_onchange='';$a5_readonly=false; ?><?php if ($this->isEditable() && !$this->isEditMode()) $a5_readonly=true;
