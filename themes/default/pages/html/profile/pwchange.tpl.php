...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php $attr = array('class'=>'text','text'=>'user_password') ?><?php $attr_class='text' ?><?php $attr_text='user_password' ?><?php
	if(empty($attr_title))
		if (!empty($attr_key))
...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php $attr = array('name'=>'act_password','default'=>'','class'=>'','size'=>'40','maxlength'=>'256') ?><?php $attr_name='act_password' ?><?php $attr_default='' ?><?php $attr_class='' ?><?php $attr_size='40' ?><?php $attr_maxlength='256' ?><input type="password" name="<?php echo $attr_name ?>" size="<?php echo $attr_size ?>" maxlength="<?php echo $attr_maxlength ?>" class="<?php echo $attr_class ?>" value="<?php echo isset($$attr_name)?$$attr_name:$attr_default ?>" /><?php unset($attr) ?><?php unset($attr_name) ?><?php unset($attr_default) ?><?php unset($attr_class) ?><?php unset($attr_size) ?><?php unset($attr_maxlength) ?><?php $attr = array() ?><br/><?php unset($attr) ?><?php $attr = array() ?><br/><?php unset($attr) ?><?php $attr = array() ?><br/><?php unset($attr) ?><?php $attr = array() ?></td><?php unset($attr) ?><?php $attr = array() ?></tr><?php unset($attr) ?><?php $attr = array() ?><?php
	$row_class_idx++;
	if ($row_class_idx > count($row_classes))
		$row_class_idx=1;
	$row_class=$row_classes[$row_class_idx-1];
...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php $attr = array('class'=>'text','text'=>'user_new_password') ?><?php $attr_class='text' ?><?php $attr_text='user_new_password' ?><?php
	if(empty($attr_title))
		if (!empty($attr_key))
			$attr_title = lang($attr_key).'_HELP';
		else
...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php $attr = array('class'=>'text','text'=>'user_new_password_repeat') ?><?php $attr_class='text' ?><?php $attr_text='user_new_password_repeat' ?><?php
	if(empty($attr_title))
		if (!empty($attr_key))
			$attr_title = lang($attr_key).'_HELP';
		else
...
<?php unset($attr) ?><?php $attr = array('field'=>'act_password') ?><?php $attr_field='act_password' ?>
