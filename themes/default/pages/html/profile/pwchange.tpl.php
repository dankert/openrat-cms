...
<?php } ?>
 class="logo"
 colspan="2"
><?php unset($a5_class,$a5_colspan) ?><?php $a6_name='changepassword'; ?><img src="<?php echo $image_dir.'logo_'.$a6_name.IMG_ICON_EXT ?>" border="0" align="left"><h2 class="logo"><?php echo langHtml('logo_'.$a6_name) ?></h2><p class="logo"><?php echo langHtml('logo_'.$a6_name.'_text') ?></p><?php unset($a6_name) ?></td></tr><?php
	$row_idx++;
	$column_idx = 0;
?>
<tr
...
<?php } ?>
 colspan="2"
><?php unset($a5_colspan) ?><?php $a6_title=lang('user_act_password'); ?><fieldset><?php if(isset($a6_title)) { ?><legend><?php if(isset($a6_icon)) { ?><image src="<?php echo $image_dir.'icon_'.$a6_icon.IMG_ICON_EXT ?>" align="left" border="0"><?php } ?><?php echo encodeHtml($a6_title) ?></legend><?php } ?><?php unset($a6_title) ?></fieldset></td></tr><?php
	$row_idx++;
	$column_idx = 0;
?>
<tr
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_class='text';$a6_text='user_password';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_name='act_password';$a6_default='';$a6_class='';$a6_size='40';$a6_maxlength='256'; ?><input type="password" name="<?php echo $a6_name ?>" size="<?php echo $a6_size ?>" maxlength="<?php echo $a6_maxlength ?>" class="<?php echo $a6_class ?>" value="<?php if (count($errors)==0) echo isset($$a6_name)?$$a6_name:$a6_default ?>" <?php if (in_array($a6_name,$errors)) echo 'style="border:2px dashed red;"' ?> /><?php unset($a6_name,$a6_default,$a6_class,$a6_size,$a6_maxlength) ?></td></tr><?php
	$row_idx++;
	$column_idx = 0;
?>
<tr
