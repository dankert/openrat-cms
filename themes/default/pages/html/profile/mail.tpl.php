...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php $attr6 = array('class'=>'text','text'=>'user_new_mail') ?><?php $attr6_class='text' ?><?php $attr6_text='user_new_mail' ?><?php
