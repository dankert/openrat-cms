...
<?php } ?>
 colspan="2"
><?php unset($a5_colspan) ?><?php $a6_title=lang('user_mail'); ?><fieldset><?php if(isset($a6_title)) { ?><legend><?php echo encodeHtml($a6_title) ?></legend><?php } ?><?php unset($a6_title) ?></fieldset></td></tr><?php
	$row_idx++;
	$column_idx = 0;
?>
<tr
