<?php $attr1_debug_info = 'a:1:{s:5:"class";s:4:"tree";}' ?><?php $attr1 = array('class'=>'tree') ?><?php $attr1_class='tree' ?><?php if (!headers_sent()) header('Content-Type: text/html; charset='.lang('CHARSET'))
...
<?php unset($attr1) ?><?php unset($attr1_class) ?><!-- $Id$ -->
