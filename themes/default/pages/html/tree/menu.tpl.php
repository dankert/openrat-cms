      ...
      <td>
        <?php
          if	( count($projects) < 2 )
          	...
          	$attrDisabled = array();
        ?>
        <?php echo Html::selectBox( 'projectid',$projects,$act_projectid,array('onchange'=>'submit();','title'=>lang('PROJECT_SELECT_DESC'),'style'=>'margin:0px;padding:0px;','class'=>'treemenu')+$attrDisabled ) ?></td><td><noscript>&nbsp;<input type="submit" class="submit" value="&raquo;"></noscript>
      </td>
      </tr>
      </table>
      </form>
