...
<?php unset($attr1_class); ?><?php  $attr2_name='GLOBAL_USERS';  $attr2_icon='user';  $attr2_width='70%';  $attr2_rowclasses='odd,even';  $attr2_columnclasses='1,2,3';  ?>    <?php
...
<?php unset($attr2_name);unset($attr2_icon);unset($attr2_width);unset($attr2_rowclasses);unset($attr2_columnclasses); ?><?php  $attr3_list='el';  $attr3_extract=true;  $attr3_key='list_key';  $attr3_value='list_value';  ?>      <?php
      ...
      ?><?php unset($attr3_list);unset($attr3_extract);unset($attr3_key);unset($attr3_value); ?><?php  ?>        <?php
        ...
        ?><tr class="<?php echo $attr4_class ?>"><?php  ?><?php  $attr5_class='fx';  ?>          <?php
          ...
          ?>><?php unset($attr5_class); ?><?php  $attr6_title='desc';  $attr6_target='cms_main';  $attr6_url=$url;  $attr6_class='';  ?>            <?php
            	$params = array();
          ...
          if	( isset($attr5_colspan)) { ?> colspan="<?php echo $attr5_colspan ?>" <?php }
          if	( isset($attr5_rowspan)) { ?> rowspan="<?php echo $attr5_rowspan ?>" <?php }
          ?>><?php unset($attr5_class); ?><?php  $attr6_class='text';  $attr6_value=$fullname;  $attr6_escape=true;  ?>            <?php
            ...
            ?><<?php echo $tmp_tag ?> class="<?php echo $attr6_class ?>" title="<?php echo $attr6_title ?>"><?php
            	...
            	echo $tmp_text;
            	unset($tmp_text);
            ?></<?php echo $tmp_tag ?>><?php unset($attr6_class);unset($attr6_value);unset($attr6_escape); ?><?php  $attr6_true=$isAdmin;  ?>            <?php 
            	...
            	{
            ?>
<?php unset($attr6_true); ?><?php  $attr7_class='text';  $attr7_raw='_(';  $attr7_escape=true;  ?>              <?php
              	if	( isset($attr7_prefix)&& isset($attr7_key))
              		$attr7_key = $attr7_prefix.$attr7_key;
              	if	( isset($attr7_suffix)&& isset($attr7_key))
              		$attr7_key = $attr7_key.$attr7_suffix;
              ...
              ?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
              	...
              	echo $tmp_text;
              	unset($tmp_text);
              ?></<?php echo $tmp_tag ?>><?php unset($attr7_class);unset($attr7_raw);unset($attr7_escape); ?><?php  $attr7_class='text';  $attr7_key='USER_ADMIN';  $attr7_escape=true;  ?>              <?php
              	if	( isset($attr7_prefix)&& isset($attr7_key))
              		$attr7_key = $attr7_prefix.$attr7_key;
              	if	( isset($attr7_suffix)&& isset($attr7_key))
              		$attr7_key = $attr7_key.$attr7_suffix;
              ...
              ?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
              	...
              	echo $tmp_text;
              	unset($tmp_text);
              ?></<?php echo $tmp_tag ?>><?php unset($attr7_class);unset($attr7_key);unset($attr7_escape); ?><?php  $attr7_class='text';  $attr7_raw=')';  $attr7_escape=true;  ?>              <?php
              	if	( isset($attr7_prefix)&& isset($attr7_key))
              		$attr7_key = $attr7_prefix.$attr7_key;
              	if	( isset($attr7_suffix)&& isset($attr7_key))
              		$attr7_key = $attr7_key.$attr7_suffix;
              ...
              ?><<?php echo $tmp_tag ?> class="<?php echo $attr7_class ?>" title="<?php echo $attr7_title ?>"><?php
              	...
              	echo $tmp_text;
              	unset($tmp_text);
              ?></<?php echo $tmp_tag ?>><?php unset($attr7_class);unset($attr7_raw);unset($attr7_escape); ?><?php  ?>          <?php } ?><?php  ?><?php  ?>        </td><?php  ?><?php  ?>      </tr><?php  ?><?php  ?>    <?php } ?><?php  ?><?php  ?>        </table>
  	</td>
    </tr>
  </table>
  </center>
