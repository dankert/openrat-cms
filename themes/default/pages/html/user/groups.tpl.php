...
?><?php unset($a2_name,$a2_target,$a2_method,$a2_enctype) ?><?php $a3_name='USER_MEMBERSHIPS';$a3_widths='5%,95%';$a3_width='70%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php
...
<?php unset($a3_name,$a3_widths,$a3_width,$a3_rowclasses,$a3_columnclasses) ?><?php $a4_list='memberships';$a4_extract=true;$a4_key='list_key';$a4_value='list_value'; ?><?php
...
<?php } ?>
><?php $a7_default=false;$a7_readonly=false;$a7_name=$var; ?><?php
...
?><?php unset($a7_name); unset($a7_readonly); unset($a7_default); ?><?php unset($a7_default,$a7_readonly,$a7_name) ?></td><?php $column_idx++; ?><td
<?php if (!empty($column_widths)) { ?>
 width="<?php echo $column_widths[($column_idx-1)%count($column_widths)] ?>"
<?php } ?>
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a7_for=$var; ?><label for="id_<?php echo $a7_for ?><?php if (!empty($a7_value)) echo '_'.$a7_value ?>"><?php unset($a7_for) ?><?php $a8_file='icon_group';$a8_align='left'; ?><?php
