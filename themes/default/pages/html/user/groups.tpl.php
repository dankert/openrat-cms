...
<td width="30%" class="<?php if($f1==true) {echo'f1';$f1=false;}else{echo'f2';$f1=true;}?>"><a href="<?php echo Html::url(array('action'=>'user','subaction'=>'delgroup','groupid'=>$id)) ?>"><?php echo lang('DELETE') ?></a></td>
</tr>
<?php }
...
<tr>
  ...
  <td width="30%" class="act"><input type="submit" class="submit" value="<?php echo lang('ADD') ?>"></td>
</tr>
</table>
