...
<?php if (isset($a8_key)) { echo lang($a8_key); if(hasLang($a8_key.'_desc')) { ?><div class="description"><?php echo lang($a8_key.'_desc')?></div> <?php } } ?><?php unset($a8_for) ?><?php $a9_file='icon_group';$a9_align='left'; ?><?php
...
?>
</div><?php unset($a7_type,$a7_class,$a7_value,$a7_text) ?></td></tr><?php
