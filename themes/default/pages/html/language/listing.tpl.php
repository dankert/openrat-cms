...
?><td <?php foreach( $attr5 as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr5) ?><?php unset($attr5_class) ?><?php $attr6 = array('class'=>'text','var'=>'isocode','escape'=>true) ?><?php $attr6_class='text' ?><?php $attr6_var='isocode' ?><?php $attr6_escape=true ?><?php
