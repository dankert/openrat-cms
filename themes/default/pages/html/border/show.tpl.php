<?php $attr1_debug_info = 'a:1:{s:5:"class";s:6:"border";}' ?><?php $attr1 = array('class'=>'border') ?><?php $attr1_class='border' ?><?php if (!headers_sent()) header('Content-Type: text/html; charset='.lang('CHARSET'))
