...
<?php unset($attr) ?><?php unset($attr_class) ?><?php $attr = array('action'=>'file','subaction'=>'doextract','id'=>'','name'=>'','target'=>'_self','method'=>'post','enctype'=>'application/x-www-form-urlencoded') ?><?php $attr_action='file' ?><?php $attr_subaction='doextract' ?><?php $attr_id='' ?><?php $attr_name='' ?><?php $attr_target='_self' ?><?php $attr_method='post' ?><?php $attr_enctype='application/x-www-form-urlencoded' ?><?php
