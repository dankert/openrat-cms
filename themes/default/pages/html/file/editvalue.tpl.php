...
?><td<?php
?>><?php  ?><?php  $attr6_class='text';  $attr6_text='GLOBAL_VALUE';  $attr6_escape=true;  ?><?php
		$attr6_title = '';
		$tmp_tag = 'span';
...
?></<?php echo $tmp_tag ?>><?php unset($attr6_class);unset($attr6_text);unset($attr6_escape); ?><?php  ?></td><?php  ?><?php  ?><?php
	...
	if	( isset($column_widths[$cell_column_nr-1]) && !isset($attr5_rowspan) )
		$attr5_width=$column_widths[$cell_column_nr-1];
?><td<?php
?>><?php  ?><?php  $attr6_name='value';  $attr6_rows='35';  $attr6_cols='60';  $attr6_class='inputarea';  $attr6_default='';  ?><?php if ($this->isEditable() && !$this->isEditMode()) $attr6_readonly=true;
      if ( !$attr6_readonly) {
