...
<?php } ?>
><?php unset($a6_header) ?><?php $a7_class='text';$a7_text='GLOBAL_VALUE';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php unset($a6_header) ?><?php $a7_name='value';$a7_rows='40';$a7_cols='40';$a7_class='editor';$a7_default=''; ?><?php if ($this->isEditMode()) {
...
<?php } ?>
<?php } ?></form>
<?php $a3_field='value'; ?><script name="JavaScript" type="text/javascript"><!--
</script>
<?php unset($a3_field) ?>