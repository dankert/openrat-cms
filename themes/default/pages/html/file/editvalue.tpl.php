...
<?php } ?>
><?php $a6_class='text';$a6_text='GLOBAL_VALUE';$a6_escape=true;$a6_cut='both'; ?><?php
		$a6_title = '';
		$tmp_tag = 'span';
...
<?php if (!empty($column_classes)) { ?>
 class="<?php echo $column_classes[($column_idx-1)%count($column_classes)] ?>"
<?php } ?>
><?php $a6_name='value';$a6_rows='35';$a6_cols='60';$a6_class='inputarea';$a6_default=''; ?><?php if ($this->isEditMode()) {
