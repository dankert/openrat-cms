<?php $a3_icon='folder';$a3_width='93%';$a3_rowclasses='odd,even';$a3_columnclasses='1,2,3'; ?><?php if (false) { ?>
<div class="window">
<div class="title">
		<?php $icon=$actionName; ?>
...
<?php } ?><?php unset($a3_icon,$a3_width,$a3_rowclasses,$a3_columnclasses) ?><?php
	$column_idx = 0;
?>
<tr
>
...
<?php } ?>
 colspan="2"
><?php unset($a5_colspan,$a5_header) ?><?php $a6_inline=false;$a6_url=$preview_url; ?><iframe name="<?php echo $a6_name ?>" src="<?php echo $a6_url ?>"></iframe>
<?php unset($a6_inline,$a6_url) ?><?php $a6_title='';$a6_type='';$a6_class='action';$a6_action='file';$a6_subaction='edit';$a6_frame='_self'; ?><?php
	$params = array();
	$tmp_url = '';
	$a6_target = $view;
	switch( $a6_type )
...
?><<?php echo $tmp_tag ?> class="<?php echo $a7_class ?>" title="<?php echo $a7_title ?>"><?php
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a7_class,$a7_key,$a7_escape,$a7_cut) ?></a><?php $a6_title='';$a6_type='';$a6_class='action';$a6_action='file';$a6_subaction='editvalue';$a6_frame='_self'; ?><?php
	$params = array();
	$tmp_url = '';
	$a6_target = $view;
	switch( $a6_type )
...
?><a target="<?php echo $a6_frame ?>"<?php if (isset($a6_name)) { ?> name="<?php echo $a6_name ?>"<?php }else{ ?> href="javascript:void(0);" onclick="<?php echo $tmp_function_call ?>" <?php } ?> class="<?php echo $a6_class ?>"<?php if (isset($a6_accesskey)) echo ' accesskey="'.$a6_accesskey.'"' ?>  title="<?php echo encodeHtml($a6_title) ?>"><?php unset($a6_title,$a6_type,$a6_class,$a6_action,$a6_subaction,$a6_frame) ?><?php $a7_file='icon/editvalue';$a7_align='left'; ?><?php
	$a7_tmp_image_file = $image_dir.$a7_file.IMG_ICON_EXT;
	$a7_tmp_title = basename($a7_tmp_image_file);
?><img alt="<?php echo $a7_tmp_title; if (isset($a7_size)) { echo ' ('; list($a7_tmp_width,$a7_tmp_height)=explode('x',$a7_size);echo $a7_tmp_width.'x'.$a7_tmp_height; echo')';} ?>" src="<?php echo $a7_tmp_image_file ?>" border="0"<?php if(isset($a7_align)) echo ' align="'.$a7_align.'"' ?><?php if (isset($a7_size)) { list($a7_tmp_width,$a7_tmp_height)=explode('x',$a7_size);echo ' width="'.$a7_tmp_width.'" height="'.$a7_tmp_height.'"';} ?> /><?php unset($a7_file,$a7_align) ?><?php $a7_class='text';$a7_key='menu_file_editvalue';$a7_escape=true;$a7_cut='both'; ?><?php
		$a7_title = '';
		$tmp_tag = 'span';
?><<?php echo $tmp_tag ?> class="<?php echo $a7_class ?>" title="<?php echo $a7_title ?>"><?php
		$langF = $a7_escape?'langHtml':'lang';
	...
	echo $tmp_text;
	unset($tmp_text);
?></<?php echo $tmp_tag ?>><?php unset($a7_class,$a7_key,$a7_escape,$a7_cut) ?></a></td></tr><?php if (false) { ?>
</div>
</div>
<div class="bottom">
	<div class="status">
