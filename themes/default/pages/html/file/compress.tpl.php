...
<?php unset($attr) ?><?php unset($attr_class) ?><?php unset($attr_title) ?><?php $attr = array('action'=>'file','subaction'=>'docompress','name'=>'','target'=>'_self','method'=>'post','enctype'=>'application/x-www-form-urlencoded') ?><?php $attr_action='file' ?><?php $attr_subaction='docompress' ?><?php $attr_name='' ?><?php $attr_target='_self' ?><?php $attr_method='post' ?><?php $attr_enctype='application/x-www-form-urlencoded' ?><?php
...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php $attr = array('class'=>'text','text'=>'type') ?><?php $attr_class='text' ?><?php $attr_text='type' ?><?php
	if(empty($attr_title))
		if (!empty($attr_key))
...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php $attr = array() ?></td><?php unset($attr) ?><?php $attr = array() ?><?php
//	if (empty($attr_class))
//		$attr['class']=$row_class;
	$column_class_idx++;
	if ($column_class_idx > count($column_classes))
...
?><td <?php foreach( $attr as $a_name=>$a_value ) echo " $a_name=\"$a_value\"" ?>><?php unset($attr) ?><?php $attr = array('var'=>'field','value'=>'replace') ?><?php $attr_var='field' ?><?php $attr_value='replace' ?><?php $$attr_var = $attr_value ?><?php unset($attr) ?><?php unset($attr_var) ?><?php unset($attr_value) ?><?php $attr = array('name'=>'field','value'=>'1') ?><?php $attr_name='field' ?><?php $attr_value='1' ?><?php
?><input type="radio" name="<?php echo $attr_prefix.$attr_name ?>"<?php if ( $attr_readonly ) echo ' disabled="disabled"' ?> value="<?php echo $attr_value ?>" <?php if( $attr_value == $$attr_name ) echo 'checked="checked"' ?> /><?php unset($attr) ?><?php unset($attr_name) ?><?php unset($attr_value) ?><?php $attr = array('class'=>'text','text'=>'replace') ?><?php $attr_class='text' ?><?php $attr_text='replace' ?><?php
	if(empty($attr_title))
		if (!empty($attr_key))
			$attr_title = lang($attr_key).'_HELP';
		else
...
?><span class="<?php echo $attr_class ?>" title="<?php echo $attr_title ?>"><?php
	...
	echo $tmp_text;
?></span><?php unset($attr) ?><?php unset($attr_class) ?><?php unset($attr_text) ?><?php $attr = array() ?><br/><?php unset($attr) ?><?php $attr = array('name'=>'field','value'=>'') ?><?php $attr_name='field' ?><?php $attr_value='' ?><?php
?><input type="radio" name="<?php echo $attr_prefix.$attr_name ?>"<?php if ( $attr_readonly ) echo ' disabled="disabled"' ?> value="<?php echo $attr_value ?>" <?php if( $attr_value == $$attr_name ) echo 'checked="checked"' ?> /><?php unset($attr) ?><?php unset($attr_name) ?><?php unset($attr_value) ?><?php $attr = array('class'=>'text','text'=>'createnew') ?><?php $attr_class='text' ?><?php $attr_text='createnew' ?><?php
	if(empty($attr_title))
		if (!empty($attr_key))
			$attr_title = lang($attr_key).'_HELP';
		else
