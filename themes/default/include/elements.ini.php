...
if       = var,value,invert,not,empty,present,contains,true,false
image    = config,file,url,icon,align:left,type,elementtype
...
logo     = name:*
newline  =
page     = class:main,title:var:cms_title
...
text     = title,class:text,var,text,key,textvar,raw,maxlength,value
