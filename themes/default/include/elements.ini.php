...
dummy    =
focus    = field:*
form     = action,subaction,id,name:,target:_self,method:post,enctype:application/x-www-form-urlencoded,type:,cancel:false,label,visible:false,async:false,autosave:false
frame    = file,name,scrolling
frameset = rows,columns
frameset-page=menu
group    = title,icon,open:true,class,show:true
hidden   = name:*,default
