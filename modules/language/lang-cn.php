...
'GLOBAL_FOLDER_DESC'=>"A Directory may contain other directories, pages, files and links.",
...
'GLOBAL_LOGIN'=>"Login",
'GLOBAL_LOG'=>"Log",
'GLOBAL_MAKE_DEFAULT'=>"Set to standard",
'GLOBAL_MENU_TITLE_FILEBROWSER_BROWSE'=>"Selection",
'GLOBAL_MINUTE'=>"Minute",
'GLOBAL_MINUTES'=>"Minutes",
'GLOBAL_MODELS_DESC'=>"With models you may do more views of an project, f.e. an HTML and an WML-Model.",
'GLOBAL_MODELS'=>"Models",
'GLOBAL_MODEL'=>"Model",
'GLOBAL_MONTH'=>"Month",
'GLOBAL_MONTHS'=>"Months",
'GLOBAL_MOVE'=>"Move",
'GLOBAL_MUCH_TIME'=>"Hint: This can take much time. Do not abort while loading the page.",
