...
'GLOBAL_MENU_TITLE_FILEBROWSER_BROWSE'=>"Auswahl",
...
'GLOBAL_MUCH_TIME'=>"Dieser Vorgang kann längere Zeit dauern. Bitte brechen Sie das Laden der Seite nicht ab.",
'GLOBAL_NAME_DESC'=>"Logischer Name des Objektes. Kann beliebige Zeichen enthalten (max. 255 Zeichen)",
'GLOBAL_NAME'=>"Name",
'GLOBAL_NEW'=>"Neu",
'GLOBAL_NO_ARCHIVE_DESC'=>"Zu diesem Platzhalter ist noch kein Archiv verfügbar.",
...
'NOTICE_ADMIN_NO_PROJECTS_AVAILABLE'=>"Es ist kein Projekt verfügbar. Bitte legen Sie in der Administrationsoberfläche eines an.",
...
'NOTICE_CODE_DISABLED'=>"Der dynamische Programmcode wird in der aktuellen Umgebung aus Sicherheitsgründen nicht ausgeführt.",
...
'NOTICE_DUPLICATE_INPUT'=>"Ihre Eingabe muss eindeutig sein.",
...
'NOTICE_IMAGE_RESIZING_UNKNOWN_TYPE'=>"Das Verändern dieses Bildtyps ist leider nicht möglich.",
...
'NOTICE_MAX_FILE_SIZE_EXCEEDED'=>"Die maximal erlaubte Dateigröße wurde überschritten.",
'NOTICE_MOVED'=>"wurde verschoben.",
'NOTICE_MUCH_TIME'=>"Dieser Vorgang kann längere Zeit dauern. Bitte brechen Sie das Laden der Seite nicht ab.",
'NOTICE_NO_DATABASE_CONFIGURATION'=>"Es ist keine Datenbankverbindung konfiguriert",
'NOTICE_NO_PROJECTS_AVAILABLE'=>"Es ist kein Projekt verfügbar, für das Sie berechtigt sind.",
'NOTICE_NO_TEMPLATES_AVAILABLE'=>"Es sind keine Seitenvorlagen verfügbar. Sie können erst Seiten anlegen, wenn es mindestens 1 Seitenvorlage gibt",
'NOTICE_NOTHING_DONE'=>"Die Aktion konnte nicht ausgeführt werden.",
'NOTICE_NOT_SAVED'=>"wurde nicht gespeichert.",
'NOTICE_PAGE_WITH_TEMPLATE_EXIST'=>"Es gibt mindestens 1 Seite, die auf dieser Vorlage basiert. Solange solche Seiten existieren, kann die Vorlage nicht gelöscht werden.",
'NOTICE_PASSWORDCODE_NOT_MATCH'=>"Der eingegebene Kennwort-Code ist ungültig.",
'NOTICE_PASSWORD_MINLENGTH'=>"Das Kennwort ist zu kurz, es muss mindestens {minlength} Zeichen lang sein.",
'NOTICE_PASSWORDS_DO_NOT_MATCH'=>"Die Kennwörter stimmen nicht überein.",
...
'NOTICE_PUBLISHED_ERROR'=>"Wurde nicht veröffentlicht.",
...
'NOTICE_UNEXPECTED_CHARS'=>"Ihre Eingabe enthielt ungültige Zeichen, diese wurden entfernt.",
...
'NOTICE_DEVELOPMENT_MODE'=>"Der Entwicklungsmodus ist aktiviert",
'METHOD_EDIT'=>"Inhalt",
