...
<div class="tree selector" data-types="{types}" data-init-id="<?php echo $linkobjectid ?>" data-init-folderid="<?php echo $rootfolderid ?>">
		...
		<div class="bottom"><div class="command yes"><input type="button" class="submit ok" value="<?php echo lang('save') ?>" onclick="$(this).closest('div.sheet').find('form').submit(); " /></div></div></form>
