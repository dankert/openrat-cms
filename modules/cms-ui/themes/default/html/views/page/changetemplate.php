		...
		<div class="bottom"><div class="command 1"><input type="button" class="submit ok" value="<?php echo lang('BUTTON_NEXT') ?>" /><input type="button" class="submit cancel" value="<?php echo lang("CANCEL") ?>" /></div></div></form>
