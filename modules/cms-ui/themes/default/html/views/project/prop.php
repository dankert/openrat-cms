<?php if (!defined('OR_TITLE')) die('Forbidden'); ?> 
		...
		<form name="" target="_self" data-target="view" action="./" data-method="prop" data-action="project" data-id="<?php echo OR_ID ?>" method="POST" enctype="application/x-www-form-urlencoded" class="or-form project" data-async="false" data-autosave="false"><input type="hidden" name="<?php echo REQ_PARAM_TOKEN ?>" value="<?php echo token() ?>" /><input type="hidden" name="<?php echo REQ_PARAM_ACTION ?>" value="project" /><input type="hidden" name="<?php echo REQ_PARAM_SUBACTION ?>" value="prop" /><input type="hidden" name="<?php echo REQ_PARAM_ID ?>" value="<?php echo OR_ID ?>" />
			<fieldset class="toggle-open-close<?php echo true?" open":" closed" ?><?php echo true?" show":"" ?>"><legend class="on-click-open-close"><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('NAME') ?></legend><div class="closable">
				<div class="line">
					...
					<div class="input">
						<div class="inputholder"><input id="<?php echo REQUEST_ID ?>_name" name="<?php if ('') echo ''.'_' ?>name<?php if (false) echo '_disabled' ?>" type="text" maxlength="128" class="name" value="<?php echo Text::encodeHtml(@$name) ?>" /><?php if (false) { ?><input type="hidden" name="name" value="<?php $name ?>"/><?php } ?></div>
				...
				<div class="line">
					...
					<div class="input">
						<div class="inputholder"><input id="<?php echo REQUEST_ID ?>_url" name="<?php if ('') echo ''.'_' ?>url<?php if (false) echo '_disabled' ?>" type="text" maxlength="255" class="" value="<?php echo Text::encodeHtml(@$url) ?>" /><?php if (false) { ?><input type="hidden" name="url" value="<?php $url ?>"/><?php } ?></div>
						
					</div>
				</div>
			</div></fieldset>
			<fieldset class="toggle-open-close<?php echo true?" open":" closed" ?><?php echo true?" show":"" ?>"><legend class="on-click-open-close"><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('PUBLISH') ?></legend><div class="closable">
				<div class="line">
					<div class="label">
					...
					<div class="input">
						<div class="inputholder"><input id="<?php echo REQUEST_ID ?>_target_dir" name="<?php if ('') echo ''.'_' ?>target_dir<?php if (false) echo '_disabled' ?>" type="text" maxlength="255" class="filename" value="<?php echo Text::encodeHtml(@$target_dir) ?>" /><?php if (false) { ?><input type="hidden" name="target_dir" value="<?php $target_dir ?>"/><?php } ?></div>
				...
				<div class="line">
					...
					<div class="input">
						<?php { $tmpname     = 'publishFileExtension';$default  = false;$readonly = false;$required = false;		
		if	( isset($$tmpname) )
			$checked = $$tmpname;
		else
			$checked = $default;
		...
		?><input type="hidden" name="<?php echo $tmpname ?>" value="1" /><?php
				...
				<div class="line">
					...
					<div class="input">
						<?php { $tmpname     = 'publishPageExtension';$default  = false;$readonly = false;$required = false;		
		if	( isset($$tmpname) )
			$checked = $$tmpname;
		else
			$checked = $default;
		...
		?><input type="hidden" name="<?php echo $tmpname ?>" value="1" /><?php
				...
				<label class="or-form-row"><span class="or-form-label"></span><span class="or-form-input"><input  class="" type="radio" id="<?php echo REQUEST_ID ?>_linksAbsolute_0" name="<?php if ('') echo ''.'_' ?>linksAbsolute<?php if (false) echo '_disabled' ?>" value="0"<?php if('0'==@$linksAbsolute)echo ' checked="checked"' ?> />&nbsp;?LINKS_RELATIVE? </span></label>
				
				<label class="or-form-row"><span class="or-form-label"></span><span class="or-form-input"><input  class="" type="radio" id="<?php echo REQUEST_ID ?>_linksAbsolute_1" name="<?php if ('') echo ''.'_' ?>linksAbsolute<?php if (false) echo '_disabled' ?>" value="1"<?php if('1'==@$linksAbsolute)echo ' checked="checked"' ?> />&nbsp;?LINKS_ABSOLUTE? </span></label>
				
			</div></fieldset>
			<fieldset class="toggle-open-close<?php echo true?" open":" closed" ?><?php echo true?" show":"" ?>"><legend class="on-click-open-close"><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('project_FTP') ?></legend><div class="closable">
				<div class="line">
					<div class="label">
					...
					<div class="input">
						...
						<?php { $tmpname     = 'ftp_passive';$default  = false;$readonly = !config('publish','ftp','enable');$required = false;		
		if	( isset($$tmpname) )
			$checked = $$tmpname;
		else
			$checked = $default;
		...
		?><input type="hidden" name="<?php echo $tmpname ?>" value="1" /><?php
			...
			<fieldset class="toggle-open-close<?php echo true?" open":" closed" ?><?php echo true?" show":"" ?>"><legend class="on-click-open-close"><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('options') ?></legend><div class="closable">
				<div class="line">
					...
					<div class="input">
						<?php { $tmpname     = 'content_negotiation';$default  = false;$readonly = false;$required = false;		
		if	( isset($$tmpname) )
			$checked = $$tmpname;
		else
			$checked = $default;
		...
		?><input type="hidden" name="<?php echo $tmpname ?>" value="1" /><?php
				...
				<div class="line">
					...
					<div class="input">
						<?php { $tmpname     = 'cut_index';$default  = false;$readonly = false;$required = false;		
		if	( isset($$tmpname) )
			$checked = $$tmpname;
		else
			$checked = $default;
