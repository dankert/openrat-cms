		...
		<form name="" target="_self" data-target="view" action="./" data-method="maintenance" data-action="project" data-id="<?php echo OR_ID ?>" method="POST" enctype="application/x-www-form-urlencoded" class="or-form project" data-async="false" data-autosave="false"><input type="hidden" name="<?php echo REQ_PARAM_TOKEN ?>" value="<?php echo token() ?>" /><input type="hidden" name="<?php echo REQ_PARAM_ACTION ?>" value="project" /><input type="hidden" name="<?php echo REQ_PARAM_SUBACTION ?>" value="maintenance" /><input type="hidden" name="<?php echo REQ_PARAM_ID ?>" value="<?php echo OR_ID ?>" />
			<fieldset class="toggle-open-close<?php echo true?" open":" closed" ?><?php echo true?" show":"" ?>"><legend class="on-click-open-close"><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('options') ?></legend><div class="closable">
				<div>
					...
					<input  class="" type="radio" id="<?php echo REQUEST_ID ?>_type_check_limit" name="<?php if ('') echo ''.'_' ?>type<?php if (false) echo '_disabled' ?>" value="check_limit"<?php if('check_limit'==@$type)echo ' checked="checked"' ?> />
				...
				<div>
					...
					<input  class="" type="radio" id="<?php echo REQUEST_ID ?>_type_check_files" name="<?php if ('') echo ''.'_' ?>type<?php if (false) echo '_disabled' ?>" value="check_files"<?php if('check_files'==@$type)echo ' checked="checked"' ?> />
