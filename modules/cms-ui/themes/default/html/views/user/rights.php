		...
		<table width="100%">
			<?php foreach($projects as $list_key=>$list_value){ ?><?php extract($list_value) ?>
				<tr>
					<td colspan="2">
						<fieldset class="<?php echo '1'?" open":"" ?><?php echo '1'?" show":"" ?>"><legend><div class="arrow-right closed" /><div class="arrow-down open" /><?php echo $projectname ?></legend><div>
								...
								<table width="100%">
									...
									<?php foreach($rights as $aclid=>$acl){ ?><?php extract($acl) ?>
										<tr class="data">
											...
											<td>
												<img class="" title="" src="./themes/default/images/icon_<?php echo $objecttype ?>.png" />
												
												<a target="_self" data-action="<?php echo $objecttype ?>" data-method="" data-id="<?php echo $objectid ?>" href="javascript:void(0);">
