	...
	<h2>
		...
		<p>
			<?php echo langHtml('logo_changepassword_text') ?>
				...
				<fieldset class="<?php echo '1'?" open":" closed" ?><?php echo '1'?" show":"" ?>"><legend><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('user_act_password') ?></legend><div>
					<div class="line">
						<div class="label">
				...
				<fieldset class="<?php echo '1'?" open":" closed" ?><?php echo '1'?" show":"" ?>"><legend><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('user_new_password') ?></legend><div>
					<div class="line">
						<div class="label">
