<?php if (!defined('OR_TITLE')) die('Forbidden'); ?> 
	...
	<h2>
		...
		<p>
			...
			<fieldset class="toggle-open-close<?php echo '1'?" open":" closed" ?><?php echo '1'?" show":"" ?>"><legend class="on-click-open-close"><div class="arrow arrow-right on-closed"></div><div class="arrow arrow-down on-open"></div><?php echo lang('user_mail') ?></legend><div class="closable">
				<div class="line">
					<div class="label">
