...
else{a=n.value.length;var o=prompt('Text');n.value=n.value.substr(0,a)+t+o+i+n.value.substr(a)}};function createUrl(e,t,i,o,a){var n='./';n+='?';if(e)n+='&action='+e;if(t)n+='&subaction='+t;if(i)n+='&id='+i;if(typeof o==='string'){o=o.replace(/'/g,'"');var l=jQuery.parseJSON(o);jQuery.each(l,function(e,t){n=n+'&'+e+'='+t})}
else if(typeof o==='object'){jQuery.each(o,function(e,t){n=n+'&'+e+'='+t})}
else{};return n};function help(e,t,n){var i=$(e).closest('div.panel').find('li.action.active').attr('data-action'),o=$(e).closest('div.panel').find('li.action.active').attr('data-method');window.open(t+i+'/'+o+n,'OpenRat_Help','location=no,menubar=no,scrollbars=yes,toolbar=no,resizable=yes')};function htmlEntities(e){return String(e).replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;')};function registerOpenClose(e){$(e).children('.on-click-open-close').click(function(){$(this).closest('.toggle-open-close').toggleClass('open closed')})};