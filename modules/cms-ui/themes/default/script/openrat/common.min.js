...
else if(typeof n.selectionStart!='undefined'){var r=n.selectionStart,s=n.selectionEnd,i=n.value.substring(r,s);n.value=n.value.substr(0,r)+t+i+a+n.value.substr(s);var o;if(i.length==0){o=r+t.length}
