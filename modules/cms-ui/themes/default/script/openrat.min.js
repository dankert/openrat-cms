...
else if(typeof a.selectionStart!='undefined'){var s=a.selectionStart,d=a.selectionEnd,n=a.value.substring(s,d);a.value=a.value.substr(0,s)+t+n+i+a.value.substr(d);var o;if(n.length==0){o=s+t.length}
else{o=s+t.length+n.length+i.length};a.selectionStart=o;a.selectionEnd=o}
