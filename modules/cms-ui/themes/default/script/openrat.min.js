...
else if(typeof n.selectionStart!='undefined'){var d=n.selectionStart,s=n.selectionEnd,a=n.value.substring(d,s);n.value=n.value.substr(0,d)+e+a+i+n.value.substr(s);var o;if(a.length==0){o=d+e.length}
