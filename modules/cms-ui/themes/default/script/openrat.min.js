...
else{r.moveStart('character',t.length+a.length+i.length)};r.select()}
else if(typeof n.selectionStart!='undefined'){var c=n.selectionStart,l=n.selectionEnd,a=n.value.substring(c,l);n.value=n.value.substr(0,c)+t+a+i+n.value.substr(l);var o;if(a.length==0){o=c+t.length}
else{o=c+t.length+a.length+i.length};n.selectionStart=o;n.selectionEnd=o}
else{o=n.value.length;var a=prompt('Text');n.value=n.value.substr(0,o)+t+a+i+n.value.substr(o)}};function createUrl(e,t,i,n,o){var a='./';a+='?action='+e;if(t!=null)a+='&subaction='+t;a+='&id='+i;if(o)a+='&embed=1';if(typeof n==='string'){n=n.replace(/'/g,'"');var r=jQuery.parseJSON(n);jQuery.each(r,function(e,t){if(e=='action'||e=='subaction'||e=='id')return;a=a+'&'+e+'='+t})}
else if(typeof n==='object'){jQuery.each(n,function(e,t){if(e=='action'||e=='subaction'||e=='id')return;a=a+'&'+e+'='+t})}
