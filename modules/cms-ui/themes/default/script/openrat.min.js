...
else if(typeof n.selectionStart!='undefined'){var c=n.selectionStart,s=n.selectionEnd,a=n.value.substring(c,s);n.value=n.value.substr(0,c)+t+a+i+n.value.substr(s);var o;if(a.length==0){o=c+t.length}
