...
else if(typeof n.selectionStart!='undefined'){var r=n.selectionStart,c=n.selectionEnd,o=n.value.substring(r,c);n.value=n.value.substr(0,r)+t+o+i+n.value.substr(c);var a;if(o.length==0){a=r+t.length}
