...
else if(typeof n.selectionStart!='undefined'){var c=n.selectionStart,r=n.selectionEnd,o=n.value.substring(c,r);n.value=n.value.substr(0,c)+t+o+i+n.value.substr(r);var a;if(o.length==0){a=c+t.length}
else{a=c+t.length+o.length+i.length};n.selectionStart=a;n.selectionEnd=a}
else{a=n.value.length;var o=prompt('Text');n.value=n.value.substr(0,a)+t+o+i+n.value.substr(a)}};function createUrl(e,t,i,n,a){var o='./';o+='?action='+e;if(t!=null)o+='&subaction='+t;o+='&id='+i;if(a)o+='&embed=1';if(typeof n==='string'){n=n.replace(/'/g,'"');var l=jQuery.parseJSON(n);jQuery.each(l,function(e,t){if(e=='action'||e=='subaction'||e=='id')return;o=o+'&'+e+'='+t})}
