...
else if(typeof n.selectionStart!='undefined'){var l=n.selectionStart,s=n.selectionEnd,o=n.value.substring(l,s);n.value=n.value.substr(0,l)+t+o+i+n.value.substr(s);var a;if(o.length==0){a=l+t.length}
else{a=l+t.length+o.length+i.length};n.selectionStart=a;n.selectionEnd=a}
else{a=n.value.length;var o=prompt('Text');n.value=n.value.substr(0,a)+t+o+i+n.value.substr(a)}};function createUrl(e,t,i,n,a){var o='./';o+='?action='+e;if(t!=null)o+='&subaction='+t;o+='&id='+i;if(a)o+='&embed=1';if(typeof n==='string'){n=n.replace(/'/g,'"');var r=jQuery.parseJSON(n);jQuery.each(r,function(e,t){if(e=='action'||e=='subaction'||e=='id')return;o=o+'&'+e+'='+t})}
