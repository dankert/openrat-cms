...
else if(typeof n.selectionStart!='undefined'){var l=n.selectionStart,c=n.selectionEnd,o=n.value.substring(l,c);n.value=n.value.substr(0,l)+t+o+i+n.value.substr(c);var a;if(o.length==0){a=l+t.length}
