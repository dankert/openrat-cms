...
else if(typeof a.selectionStart!='undefined'){var c=a.selectionStart,d=a.selectionEnd,n=a.value.substring(c,d);a.value=a.value.substr(0,c)+t+n+i+a.value.substr(d);var o;if(n.length==0){o=c+t.length}
else{o=c+t.length+n.length+i.length};a.selectionStart=o;a.selectionEnd=o}
else{o=a.value.length;var n=prompt('Text');a.value=a.value.substr(0,o)+t+n+i+a.value.substr(o)}};function createUrl(e,t,i,a,o){var n='./';n+='?action='+e;if(t!=null)n+='&subaction='+t;n+='&id='+i;if(o)n+='&embed=1';if(typeof a==='string'){a=a.replace(/'/g,'"');jQuery.each(jQuery.parseJSON(a),function(e,t){if(e=='action'||e=='subaction'||e=='id')return;n=n+'&'+e+'='+t})}
