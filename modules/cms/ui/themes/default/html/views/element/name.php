    ...
    <div class="<?php echo O::escapeHtml('or-form-content') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <tr><?php echo O::escapeHtml('') ?>
        <td><?php echo O::escapeHtml('') ?>
          <span><?php echo O::escapeHtml(''.@O::lang('ELEMENT_NAME').'') ?></span>
        </td>
        <td><?php echo O::escapeHtml('') ?>
      ...
      <tr><?php echo O::escapeHtml('') ?>
        ...
        <td><?php echo O::escapeHtml('') ?>
          <textarea name="<?php echo O::escapeHtml('description') ?>" class="<?php echo O::escapeHtml('or-input or-inputarea') ?>"><?php echo O::escapeHtml(''.@$description.'') ?></textarea>
        </td>
      </tr>
      <tr><?php echo O::escapeHtml('') ?>
