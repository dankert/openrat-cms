<?php if (!defined('OR_TITLE')) exit(); ?>
  <form name="<?php echo \template_engine\Output::escapeHtml('') ?>" target="<?php echo \template_engine\Output::escapeHtml('_self') ?>" data-target="<?php echo \template_engine\Output::escapeHtml('view') ?>" action="<?php echo \template_engine\Output::escapeHtml('./') ?>" data-method="<?php echo \template_engine\Output::escapeHtml('name') ?>" data-action="<?php echo \template_engine\Output::escapeHtml('element') ?>" data-id="<?php echo \template_engine\Output::escapeHtml(''.@$_id.'') ?>" method="<?php echo \template_engine\Output::escapeHtml('POST') ?>" enctype="<?php echo \template_engine\Output::escapeHtml('application/x-www-form-urlencoded') ?>" data-async="<?php echo \template_engine\Output::escapeHtml('') ?>" data-autosave="<?php echo \template_engine\Output::escapeHtml('') ?>" class="<?php echo \template_engine\Output::escapeHtml('or-form element') ?>"><?php echo \template_engine\Output::escapeHtml('') ?>
    ...
    <div><?php echo \template_engine\Output::escapeHtml('') ?>
      ...
      <tr><?php echo \template_engine\Output::escapeHtml('') ?>
        ...
        <td><?php echo \template_engine\Output::escapeHtml('') ?>
          <textarea name="<?php echo \template_engine\Output::escapeHtml('description') ?>" class="<?php echo \template_engine\Output::escapeHtml('inputarea') ?>"><?php echo \template_engine\Output::escapeHtml(''.@$description.'') ?>
          </textarea>
        </td>
      </tr>
      <tr><?php echo \template_engine\Output::escapeHtml('') ?>
