<?php if (defined('OR_TITLE')) {  ?>
    ...
    <form name="<?php echo escapeHtml('') ?>" target="<?php echo escapeHtml('_self') ?>" data-target="<?php echo escapeHtml('view') ?>" action="<?php echo escapeHtml('./') ?>" data-method="<?php echo escapeHtml('extension') ?>" data-action="<?php echo escapeHtml('template') ?>" data-id="<?php echo escapeHtml(''.@$_id.'') ?>" method="<?php echo escapeHtml('POST') ?>" enctype="<?php echo escapeHtml('application/x-www-form-urlencoded') ?>" data-async="<?php echo escapeHtml('') ?>" data-autosave="<?php echo escapeHtml('') ?>" class="<?php echo escapeHtml('or-form template') ?>"><?php echo escapeHtml('') ?>
      ...
      <input type="<?php echo escapeHtml('hidden') ?>" name="<?php echo escapeHtml('subaction') ?>" value="<?php echo escapeHtml('extension') ?>" /><?php echo escapeHtml('') ?>
          ...
          <fieldset class="<?php echo escapeHtml('or-group toggle-open-close open show') ?>"><?php echo escapeHtml('') ?>
            ...
            <div class="<?php echo escapeHtml('closable') ?>"><?php echo escapeHtml('') ?>
              ...
              <label class="<?php echo escapeHtml('or-form-row or-form-input') ?>"><?php echo escapeHtml('') ?>
                <span class="<?php echo escapeHtml('or-form-label') ?>"><?php echo escapeHtml('template_extension') ?>
                </span>
                <input name="<?php echo escapeHtml(''.@$name.'') ?>" required="<?php echo escapeHtml('required') ?>" type="<?php echo escapeHtml('text') ?>" maxlength="<?php echo escapeHtml('10') ?>" value="<?php echo escapeHtml(''.'.'.@$'.'[' . @$name . '].'[' . ' . '].'') ?>" /><?php echo escapeHtml('') ?>
              </label>
            </div>
          </fieldset>
         <?php } ?>
