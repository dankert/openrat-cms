    ...
    <div class="<?php echo O::escapeHtml('or-menu-group') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
          ...
          <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-folder or-on-action-page or-on-action-file or-on-action-projectlist or-on-action-templatelist or-on-action-userlist or-on-action-grouplist or-on-action-languagelist or-on-action-modellist') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_new_desc').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('') ?>" data-method="<?php echo O::escapeHtml('add') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('add') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':null,\'dialogMethod\':\'add\'}') ?>" href="<?php echo O::escapeHtml('#/') ?>" class="<?php echo O::escapeHtml('or-link') ?>"><?php echo O::escapeHtml('') ?>
                <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--method-add') ?>"><?php echo O::escapeHtml('') ?>
                </i>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-folder') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-file') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
          ...
          <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-link or-on-action-folder or-on-action-page or-on-action-file or-on-action-text or-on-action-url or-on-action-image') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-page or-on-action-file or-on-action-folder or-on-action-text or-on-action-image or-on-action-pageelement or-on-action-template') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_pub_desc').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('') ?>" data-method="<?php echo O::escapeHtml('pub') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('pub') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':null,\'dialogMethod\':\'pub\'}') ?>" href="<?php echo O::escapeHtml('#/') ?>" class="<?php echo O::escapeHtml('or-link') ?>"><?php echo O::escapeHtml('') ?>
                <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--method-publish') ?>"><?php echo O::escapeHtml('') ?>
                </i>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-pageelement') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-project or-on-action-folder or-on-action-link or-on-action-user or-on-action-group or-on-action-page or-on-action-file or-on-action-image or-on-action-text or-on-action-url') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-pageelement or-on-action-user or-on-action-group or-on-action-page or-on-action-project or-on-action-projectlist') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-page or-on-action-file or-on-action-image or-on-action-template or-on-action-pageelement') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
          ...
          <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-user') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-user or-on-action-group') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-folder or-on-action-element or-on-action-file or-on-action-image or-on-action-text or-on-action-pageelement') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-page') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-template or-on-action-configuration or-on-action-page') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-template') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-text') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-image') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-dropdown-entry or-clickable or-filtered or-on-action-project') ?>"><?php echo O::escapeHtml('') ?>
