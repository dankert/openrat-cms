  ...
  <div class="<?php echo O::escapeHtml('or-menu') ?>"><?php echo O::escapeHtml('') ?>
    <div class="<?php echo O::escapeHtml('or-menu-group') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=(isset($dbname)); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
          ...
          <span class="<?php echo O::escapeHtml('or-label') ?>"><?php echo O::escapeHtml(''.@O::lang('database').'') ?>
          </span>
          <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--dropdown') ?>"><?php echo O::escapeHtml('') ?>
          </i>
          <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
            <div class="<?php echo O::escapeHtml('or-entry inactive') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-clickable or-filtered or-on-action-folder or-on-action-page or-on-action-file or-on-action-projectlist or-on-action-templatelist or-on-action-userlist or-on-action-grouplist or-on-action-languagelist or-on-action-modellist') ?>"><?php echo O::escapeHtml('') ?>
       ...
       <?php } ?>
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-clickable or-filtered or-on-action-folder or-on-action-page or-on-action-file or-on-action-image or-on-action-text or-on-action-pageelement or-on-action-template') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
          ...
          <span class="<?php echo O::escapeHtml('or-label') ?>"><?php echo O::escapeHtml(''.@O::lang('file').'') ?>
          </span>
          <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--dropdown') ?>"><?php echo O::escapeHtml('') ?>
          </i>
          <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-folder or-on-action-page or-on-action-file or-on-action-projectlist or-on-action-templatelist or-on-action-userlist or-on-action-grouplist or-on-action-languagelist or-on-action-modellist') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_new_desc').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('') ?>" data-method="<?php echo O::escapeHtml('add') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('add') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':null,\'dialogMethod\':\'add\'}') ?>" href="<?php echo O::escapeHtml('/#//') ?>"><?php echo O::escapeHtml('') ?>
                <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--method-add') ?>"><?php echo O::escapeHtml('') ?>
                </i>
                <span><?php echo O::escapeHtml(''.@O::lang('menu_new').'') ?>
                </span>
                <span class="<?php echo O::escapeHtml('or-keystroke') ?>"><?php echo O::escapeHtml(''.O::config('ui','keybinding','method','add').'') ?>
                </span>
              </a>
            </div>
            <div class="<?php echo O::escapeHtml('or-divide') ?>"><?php echo O::escapeHtml('') ?>
            </div>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-folder') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-file') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('USER_LOGOUT_DESC').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('post') ?>" data-action="<?php echo O::escapeHtml('login') ?>" data-method="<?php echo O::escapeHtml('logout') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra="<?php echo O::escapeHtml('[]') ?>" data-data="<?php echo O::escapeHtml('{"action":"login","subaction":"logout","id":"","token":"'.@$_token.'","none":"0"}') ?>" class="<?php echo O::escapeHtml('or-entry') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
          <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--menu-edit') ?>"><?php echo O::escapeHtml('') ?>
          </i>
          <span class="<?php echo O::escapeHtml('or-label') ?>"><?php echo O::escapeHtml(''.@O::lang('edit').'') ?>
          </span>
          <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--dropdown') ?>"><?php echo O::escapeHtml('') ?>
          </i>
          <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-user or-on-action-project or-on-action-link or-on-action-folder or-on-action-page or-on-action-template or-on-action-element or-on-action-file or-on-action-url or-on-action-image or-on-action-text or-on-action-language or-on-action-model') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_prop_desc').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('') ?>" data-method="<?php echo O::escapeHtml('prop') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('prop') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':null,\'dialogMethod\':\'prop\'}') ?>" href="<?php echo O::escapeHtml('/#//') ?>"><?php echo O::escapeHtml('') ?>
                ...
                <span class="<?php echo O::escapeHtml('or-keystroke') ?>"><?php echo O::escapeHtml(''.O::config('ui','keybinding','method','prop').'') ?>
                </span>
              </a>
            </div>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-link or-on-action-folder or-on-action-page or-on-action-file or-on-action-text or-on-action-url or-on-action-image') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-page or-on-action-file or-on-action-folder or-on-action-text or-on-action-image or-on-action-pageelement or-on-action-template') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_pub_desc').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('') ?>" data-method="<?php echo O::escapeHtml('pub') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('pub') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':null,\'dialogMethod\':\'pub\'}') ?>" href="<?php echo O::escapeHtml('/#//') ?>"><?php echo O::escapeHtml('') ?>
                <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--method-publish') ?>"><?php echo O::escapeHtml('') ?>
                </i>
                <span><?php echo O::escapeHtml(''.@O::lang('menu_pub').'') ?>
                </span>
                <span class="<?php echo O::escapeHtml('or-keystroke') ?>"><?php echo O::escapeHtml(''.O::config('ui','keybinding','method','pub').'') ?>
                </span>
              </a>
            </div>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-pageelement') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_archive_desc').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('') ?>" data-method="<?php echo O::escapeHtml('archive') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('archive') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':null,\'dialogMethod\':\'archive\'}') ?>" href="<?php echo O::escapeHtml('/#//') ?>" class="<?php echo O::escapeHtml('or-entry') ?>"><?php echo O::escapeHtml('') ?>
                ...
                <span class="<?php echo O::escapeHtml('or-keystroke') ?>"><?php echo O::escapeHtml(''.O::config('ui','keybinding','method','archive').'') ?>
                </span>
              </a>
            </div>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-project or-on-action-folder or-on-action-link or-on-action-user or-on-action-group or-on-action-page or-on-action-file or-on-action-image or-on-action-text or-on-action-url') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_rights_desc').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('') ?>" data-method="<?php echo O::escapeHtml('rights') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('rights') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':null,\'dialogMethod\':\'rights\'}') ?>" href="<?php echo O::escapeHtml('/#//') ?>"><?php echo O::escapeHtml('') ?>
                ...
                <span class="<?php echo O::escapeHtml('or-keystroke') ?>"><?php echo O::escapeHtml(''.O::config('ui','keybinding','method','rights').'') ?>
                </span>
              </a>
            </div>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-pageelement or-on-action-user or-on-action-group or-on-action-page or-on-action-project or-on-action-projectlist') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-page or-on-action-file or-on-action-image or-on-action-template or-on-action-pageelement') ?>"><?php echo O::escapeHtml('') ?>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
          ...
          <span class="<?php echo O::escapeHtml('or-label') ?>"><?php echo O::escapeHtml(''.@O::lang('extras').'') ?>
          </span>
          <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--dropdown') ?>"><?php echo O::escapeHtml('') ?>
          </i>
          <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-user') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-user or-on-action-group') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-folder or-on-action-element or-on-action-file or-on-action-image or-on-action-text or-on-action-pageelement') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-page') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-template or-on-action-configuration or-on-action-page') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-template') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-text') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-image') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable or-filtered or-on-action-project') ?>"><?php echo O::escapeHtml('') ?>
    ...
    <div class="<?php echo O::escapeHtml('or-menu-group') ?>"><?php echo O::escapeHtml('') ?>
      <div class="<?php echo O::escapeHtml('or-toolbar-icon or-user or-menu-category') ?>"><?php echo O::escapeHtml('') ?>
        ...
        <span class="<?php echo O::escapeHtml('or-label') ?>"><?php echo O::escapeHtml(''.@$userfullname.'') ?>
        </span>
        <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--dropdown') ?>"><?php echo O::escapeHtml('') ?>
        </i>
        <div class="<?php echo O::escapeHtml('or-dropdown') ?>"><?php echo O::escapeHtml('') ?>
          <?php $if1=($isLoggedIn); if($if1) {  ?>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable') ?>"><?php echo O::escapeHtml('') ?>
              <a title="<?php echo O::escapeHtml(''.@O::lang('menu_PROFILE_DESC').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('dialog') ?>" data-action="<?php echo O::escapeHtml('profile') ?>" data-method="<?php echo O::escapeHtml('edit') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra-dialogAction="<?php echo O::escapeHtml('profile') ?>" data-extra-dialogMethod="<?php echo O::escapeHtml('edit') ?>" data-extra="<?php echo O::escapeHtml('{\'dialogAction\':\'profile\',\'dialogMethod\':\'edit\'}') ?>" href="<?php echo O::escapeHtml('/#/profile/') ?>"><?php echo O::escapeHtml('') ?>
                ...
                <span class="<?php echo O::escapeHtml('or-keystroke') ?>"><?php echo O::escapeHtml(''.O::config('ui','keybinding','action','profile').'') ?>
                </span>
              </a>
            </div>
            <div class="<?php echo O::escapeHtml('or-entry or-clickable') ?>"><?php echo O::escapeHtml('') ?>
            ...
            <div class="<?php echo O::escapeHtml('or-entry or-clickable') ?>"><?php echo O::escapeHtml('') ?>
              <a data-after-success="<?php echo O::escapeHtml('reloadAll') ?>" title="<?php echo O::escapeHtml(''.@O::lang('USER_LOGOUT_DESC').'') ?>" target="<?php echo O::escapeHtml('_self') ?>" data-type="<?php echo O::escapeHtml('post') ?>" data-action="<?php echo O::escapeHtml('login') ?>" data-method="<?php echo O::escapeHtml('logout') ?>" data-id="<?php echo O::escapeHtml('') ?>" data-extra="<?php echo O::escapeHtml('[]') ?>" data-data="<?php echo O::escapeHtml('{"action":"login","subaction":"logout","id":"","token":"'.@$_token.'","none":"0"}') ?>" class="<?php echo O::escapeHtml('or-entry') ?>"><?php echo O::escapeHtml('') ?>
                <i class="<?php echo O::escapeHtml('or-image-icon or-image-icon--method-logout') ?>"><?php echo O::escapeHtml('') ?>
                </i>
                <span><?php echo O::escapeHtml(''.@O::lang('USER_LOGOUT').'') ?>
                </span>
      ...
      <?php $if1=($isLoggedIn); if($if1) {  ?>
        <div class="<?php echo O::escapeHtml('or-toolbar-icon or-menu-category or-search') ?>"><?php echo O::escapeHtml('') ?>
          ...
          <div class="<?php echo O::escapeHtml('or-dropdown or-act-global-search-results') ?>"><?php echo O::escapeHtml('') ?>
            <span class="<?php echo O::escapeHtml('or-entry') ?>"><?php echo O::escapeHtml('') ?>
            </span>
          </div>
        </div>
       <?php } ?>
