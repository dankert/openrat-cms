<?php defined('APP_STARTED') || die('Forbidden'); ?>
  <form name="<?php echo \template_engine\Output::escapeHtml('') ?>" target="<?php echo \template_engine\Output::escapeHtml('_self') ?>" data-target="<?php echo \template_engine\Output::escapeHtml('view') ?>" action="<?php echo \template_engine\Output::escapeHtml('./') ?>" data-method="<?php echo \template_engine\Output::escapeHtml('value') ?>" data-action="<?php echo \template_engine\Output::escapeHtml('image') ?>" data-id="<?php echo \template_engine\Output::escapeHtml(''.@$_id.'') ?>" method="<?php echo \template_engine\Output::escapeHtml('POST') ?>" enctype="<?php echo \template_engine\Output::escapeHtml('application/x-www-form-urlencoded') ?>" data-async="<?php echo \template_engine\Output::escapeHtml('') ?>" data-autosave="<?php echo \template_engine\Output::escapeHtml('') ?>" class="<?php echo \template_engine\Output::escapeHtml('or-form image') ?>"><?php echo \template_engine\Output::escapeHtml('') ?>
    ...
    <div><?php echo \template_engine\Output::escapeHtml('') ?>
      <tr><?php echo \template_engine\Output::escapeHtml('') ?>
        ...
        <td><?php echo \template_engine\Output::escapeHtml('') ?>
          <textarea name="<?php echo \template_engine\Output::escapeHtml('value') ?>" data-extension="<?php echo \template_engine\Output::escapeHtml('') ?>" data-mimetype="<?php echo \template_engine\Output::escapeHtml('') ?>" data-mode="<?php echo \template_engine\Output::escapeHtml('htmlmixed') ?>" class="<?php echo \template_engine\Output::escapeHtml('editor code-editor') ?>"><?php echo \template_engine\Output::escapeHtml(''.@$value.'') ?>
          </textarea>
        </td>
      </tr>
      <tr><?php echo \template_engine\Output::escapeHtml('') ?>
