<?php if (defined('OR_TITLE')) {  ?>
    ...
    <form name="" target="_self" data-target="view" action="./" data-method="info" data-action="file" data-id="<?php echo OR_ID ?>" method="POST" enctype="application/x-www-form-urlencoded" data-async="" data-autosave="" class="or-form file">
          ...
          <div class="closable">
            ...
            <div class="line">
              ...
              <div class="input">
                ...
                <br />
                <a target="_self" data-action="file" data-method="size" data-id="" data-extra="[]" href="/#/file/" class="action">
