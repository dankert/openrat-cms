<?php /* THIS FILE IS GENERATED from license.tpl.src.xml - DO NOT CHANGE */ defined('APP_STARTED') || die('Forbidden'); use \template_engine\Output as O; ?>
  <div class="<?php echo O::escapeHtml('or-form') ?>"><?php echo O::escapeHtml('') ?>
    <span class="<?php echo O::escapeHtml('or-name') ?>"><?php echo O::escapeHtml(''.@$cms_name.'') ?></span>
    <span class="<?php echo O::escapeHtml('or-addition') ?>"><?php echo O::escapeHtml(''.@$cms_version.'') ?></span>
    <span class="<?php echo O::escapeHtml('or-addition') ?>"><?php echo O::escapeHtml(''.@$cms_operator.'') ?></span>
