<?php if (!defined('OR_TITLE')) exit(); ?>
  ...
  <fieldset class="<?php echo escapeHtml('or-group toggle-open-close open show') ?>"><?php echo escapeHtml('') ?>
    ...
    <div class="<?php echo escapeHtml('closable') ?>"><?php echo escapeHtml('') ?>
      <textarea name="<?php echo escapeHtml('src') ?>" data-extension="<?php echo escapeHtml('') ?>" data-mimetype="<?php echo escapeHtml('') ?>" data-mode="<?php echo escapeHtml('html') ?>" class="<?php echo escapeHtml('editor code-editor') ?>"><?php echo escapeHtml(''.@$src.'') ?>
      </textarea>
    </div>
  </fieldset>