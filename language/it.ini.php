...
ACL_DELETE = "Delete"
ACL_DESC = "che questo radrizza � usato per tutta la richiesta ai diritti di questo Grant dell'oggetto"
ACL_GRANT_ABBREV = "GR"
ACL_GRANT = "Grant"
ACL_INHERITED = "ereditati"
ACL = "La lima di Upload di diritti"
ACL_PROP_ABBREV = "PRP"
ACL_PROP = "pubblicano le propriet�"
...
DATE_WEEKDAY1 = "luned�"
DATE_WEEKDAY2 = "marted�"
DATE_WEEKDAY3 = "Wednesdy"
DATE_WEEKDAY4 = "gioved�"
DATE_WEEKDAY5 = "venerd�"
...
EL_CODE_DESC = "che questo <strong>PHP code</strong>-element contiene il PHP-Codice che � eseguito mentre pubblica la pagina. Soltanto per i programmatori con esperienza di PHP!"
...
ELEMENT_DELETE_VALUES_DESC = "tutti i valori di questo elemento sar� cancellata!"
ELEMENT_DELETE_VALUES = "La cancellazione stima"
ELEMENT_DESC_DESC = "Questa descrizione � indicata mentre pubblica il soddisfare, questa dovrebbe essere una descrizione utile per il Elemento-nome dell'autore"
ELEMENT_NAME = ""
...
EL_LIST_DESC = "l'elemento della lista contiene 1 �re pi� pagine. Con questo elemento che potete unire pi� pagina in un"
EL_LIST = "Listing"
EL_LONGTEXT_DESC = "A � il testo con pi� di 1 linea"
EL_LONGTEXT = "testo lungo lungo del testo"
EL_NUMBER_DESC = "l'elemento di numero contiene i valori numerici"
EL_NUMBER = "numero"
EL_PROP_ALL_LANGUAGES_DESC = "il soddisfare � uguale in tutto il <em>Hint di codice di lingue"
...
EL_PROP_CODE = "PHP"
EL_PROP_DATEFORMAT_DESC = "della data. Informare il vostro coordinatore se avete bisogno dell'altro formats<br/> (suggerimento: Ci� formatta � definita nel conteggio della lima <tt>dateformat.ini.php</tt>)"
...
EL_PROP_DEFAULT_FOLDEROBJECT_DESC = "che il oggetto collegato pu� essere choosed da questo dispositivo di piegatura. La Selezion-lista sar� molto pulitore con una regolazione utile qui."
EL_PROP_DEFAULT_FOLDEROBJECT = "l'pi� alto indice"
EL_PROP_DEFAULT_LONGTEXT_DESC = "questo testo � usato se l'elemento �"
...
EL_PROP_DEFAULT_TEXT_DESC = "questo testo � usato se l'elemento �"
...
EL_PROP_SELECT_ITEMS_DESC = "qui sono valori spiegati dall'autore pu� selezionare i valori."
...
EL_PROP_WITH_ICON_DESC = "dentro pubblica il modo un'icona � indicata prima che il controllo scrivibile di valore"
EL_PROP_WRITABLE = ""
EL_PROP_WRITABLE_DESC = "questo, in modo da il valore dell'elemento possa essere"
EL_SELECT_DESC = "il valore � dato dall'autore da un giacimento del testo della lista"
EL_SELECT = "Selectbox cambiato"
EL_TEXT = ""
EL_TEXT_DESC = "il textfield � usato per una linea testi fino a 255 lettere"
EMPTY=Empty
...
ERROR_DESTDIR_NOT_WRITEABLE = "L'indice locale della lima non � scrivibile."
ERROR_FTP_CANNOT_CONNECT_TO_SERVER = "il ftp server non � disponibile."
ERROR_FTP_CANNOT_LOGIN = "L'inizio attivit� sul ftp server � venuto a mancare."
...
GLOBAL_DAY = "D�a"
GLOBAL_DAYS = "D�as"
GLOBAL_DEFAULT = "Est�ndar"
GLOBAL_DEFAULT_TEXT = "Texto del defecto"
GLOBAL_DELETE = "Cancelaci�n"
GLOBAL_DELETED = "El objeto fue suprimido"
GLOBAL_DESCRIPTION = "Descripci�n"
...
GLOBAL_FILE = "Archivo"
GLOBAL_FILENAME_DESC = "Nombre de fichero, que ser� utilizado para generar. La voluntad comprob� autom�ticamente contra RFC 2396 (m�ximo 255 carbones)."
GLOBAL_FILENAME = "Nombre de fichero"
GLOBAL_FILES = "Archivos"
GLOBAL_FILE_TRANSFER_DESC = "Importar el archivo m�ltiple en la base de datos de los medios"
GLOBAL_FILE_TRANSFER = "Transferencia de archivo"
GLOBAL_FOLDER_DESC = "Un directorio puede contener otros directorios, p�ginas, archivos y acoplamientos."
...
GLOBAL_GPL = "El software viene con ABSOLUTAMENTE NING�N WARRANTY.<br/>This es software libre, y eres agradable redistribuirlo bajo ciertas condiciones."
GLOBAL_GROUP = "Grupo"
GLOBAL_GROUPS = "Grupos"
GLOBAL_HIDETREE = "�rbol de la piel"
GLOBAL_HOUR = "Hora"
GLOBAL_HOURS = "Houres"
GLOBAL_ICON = "Corregir-icono"
GLOBAL_ID = "Identificaci�n"
...
GLOBAL_LOGIN = "Conexi�n"
GLOBAL_LOG = "Registro"
GLOBAL_MAKE_DEFAULT = "Fijar al est�ndar"
GLOBAL_MINUTE = "Minutar"
GLOBAL_MINUTES = "Minutos"
GLOBAL_MODEL = "Modelo"
GLOBAL_MODELS_DESC = "Con los modelos puedes hacer m�s opiniones un proyecto, el FE un HTML y un WML-Modelo."
GLOBAL_MODELS = "Modelos"
GLOBAL_MONTH = "Mes"
GLOBAL_MONTHS = "Meses"
GLOBAL_MOVE = "Moverte"
GLOBAL_MUCH_TIME = "<em>Hint: </em> esto puede tomar mucha hora. No abortar mientras que carga la p�gina."
GLOBAL_NAME_DESC = "Nombre l�gico de este objeto. Puede contener cualquier carb�n (m�ximo 255 carbones)"
GLOBAL_NAME = "Nombrar"
GLOBAL_NEW = "Nuevo"
...
GLOBAL_UNKNOWN_TEXT = "ning�n texto disponible"
GLOBAL_UP = "encima de"
...
GLOBAL_YEAR = "A�o"
GLOBAL_YEARS = "A�os"
GROUP_DELETE_DESC = "Suprimir a grupo. �Todas las derechas y calidades de miembro ser�n perdidas!"
...
HELP = "Help"
HELP_LANGUAGE_DELETE = "�Quitar este language.<strong>Be careful</strong>, todo el contenido de esta lengua ser� perdido!"
...
LOGIN_NOLOGIN_DESC = "La conexi�n se inhabilita en el momento."
...
LOGO_CHANGEPASSWORD = "Cambiar la contrase�a"
LOGO_CHANGEPASSWORD_TEXT = "Cambiar tu contrase�a"
LOGO_LOGIN = "Anmeldung"
LOGO_LOGIN_TEXT = "A la conexi�n, necesitas una cuenta del usuario. Comprobar por favor para saber si hay sensitives del caso."
LOGO_PASSWORD = "�Contrase�a perdida?"
LOGO_PASSWORD_TEXT = "Si te has olvidado de tu contrase�a, sensaci�n libremente para solicitar un nuevo."
LOGO_PROJECTMENU = "El proyecto selecto"
LOGO_PROJECTMENU_TEXT = "selecciona por favor un proyecto."
LOGO_REGISTER = "El registro"
LOGO_REGISTER_TEXT = "si no tienes una cuenta del usuario, entonces se siente libre ahora colocarse. Necesitas una cuenta del E-mail, a la cual se env�a un c�digo del registro."
MAIL_CODE = "Confirmation code"
MAIL_SUBJECT_MAIL_CHANGE_CODE ="Change of your E-Mail adress"
MAIL_SUBJECT_PASSWORD_COMMIT_CODE = "Contrase�a de la petici�n del cambio de la contrase�a nueva"
MAIL_SUBJECT_PASSWORD_NEW = ""
MAIL_SUBJECT_REGISTER_COMMIT_CODE = "tu c�digo del registro"
MAIL_SUBJECT_USER_MAIL = "tu contrase�a"
...
MAIL_TEXT_PASSWORD_COMMIT_CODE = "hola {name}; ; tu c�digo para solicitar una nueva contrase�a es: {code}; ; Insertar por favor este n�mero en el campo de la entrada. ; ; Si no tienes petici�n una nueva contrase�a, no hacer caso por favor de este E-mail. En este caso, tu contrase�a permanecer� sin cambiar. ; ; Gracias."
...
MENU_FILE_PROP_DESC = "pubblica le propriet� di questa lima"
MENU_FILE_PROP = "pubblica le propriet�"
...
MENU_FILE_RIGHTS = ""
MENU_FILE_RIGHTS_DESC = "delle propriet� di questa della lima"
...
MENU_FOLDER_ORDER_DESC = "riordina gli oggetti nelle propriet� di questo dispositivo di piegatura"
MENU_FOLDER_ORDER = "Order"
MENU_FOLDER_PROP_DESC = "pubblica le propriet�"
MENU_FOLDER_PROP = "Properties"
MENU_FOLDER_PUB_DESC = "publica la carpeta"
MENU_FOLDER_PUB = "publica"
MENU_FOLDER_REMOVE_DESC = "quita este contenido de la demostraci�n de las caracter�sticas de la demostraci�n de la demostraci�n"
MENU_FOLDER_REMOVE = "quita"
MENU_FOLDER_RIGHTS = "del valor selecto selecto del contenido de las derechas de la demostraci�n de las derechas de la carpeta"
...
MENU_GROUP_LISTING = "todo el cambio de la contrase�a del cambio de la demostraci�n todos los grupos"
...
MENU_PAGE_ACLFORM_DESC = "agrega una derecha a esta p�gina"
MENU_PAGE_CHANGETEMPLATE_DESC = "substituye la plantilla de esta p�gina"
MENU_PAGE_CHANGETEMPLATE = "substituye la plantilla"
MENU_PAGE_EL = "corrige todos los"
MENU_PAGE_EL_DESC = "que todos los elementos de esta p�gina"
...
MENU_PAGE_ELEMENTS = "elementos de esta demostraci�n de la p�gina"
...
MENU_PAGE_FORM_DESC = "corrigen todos los elementos de esta p�gina en una"
MENU_PAGE_PROP_DESC = "corrigen caracter�sticas de esta p�gina"
MENU_PAGE_PROP = "las caracter�sticas formular"
...
MENU_PROJECT_REMOVE_DESC = "rimuove il progetto e tutte le propriet� del soddisfare"
MENU_PROJECT_REMOVE = "rimuove il progetto"
MENU_PROP = ""
MENU_PROP_DESC = "pubblica le propriet� di questo oggetto"
MENU_PROP_KEY = "la E"
...
MENU_TEMPLATE_PROP = "pubblica la mascherina di cancellazione di cancellazione delle propriet�"
...
NOTICE_IMPORTED = "lima cambiata era ist collegato del '' del <em> del '' del username di inizio attivit� failed.<br/><br/>The del importet"
NOTICE_INPUT_NEW_IMAGE_SIZE = "Please enter the new image size, either a size factor or widht and height."
NOTICE_LINKED = ""
NOTICE_LOGIN_FAILED = "</em> {nome} non assente o la parola d'accesso � errata."
NOTICE_LOGIN_FAILED_MUSTCHANGEPASSWORD = "l'inizio attivit� � stato negato, perch� la vostra parola d'accesso ha cronometrato fuori. Ancora, ma ora provare prego all'inizio attivit� insieme ad una nuova parola d'accesso."
...
NOTICE_MAIL_SENT = "Il email � stato trasmesso."
NOTICE_MAX_FILE_SIZE_EXCEEDED="The maximum filesize is exceeded"
NOTICE_MOVED = "� stato spostato"
NOTICE_MOVED = "� stato spostato"
...
NOTICE_NOT_SAVED = "� stato risparmiato"
...
NOTICE_PROP_SAVED = "Le propriet� conservate"
...
PAGE_REPLACE_TEMPLATE_DESC = "sostituisce la mascherina. Il soddisfare pu� essere copiato nella finestra successiva."
...
PROJECT_CMD_AFTER_PUBLISH_DESC = "del questo ordine � eseguito dopo che il <tt>exec di PHP-funzione di publishing.<br>The () </tt> sia usato. Il <tt>escapeshellcmd di ordine () </tt> non � denominato!"
PROJECT_CMD_AFTER_PUBLISH = "Eseguire dopo la pubblicazione"
PROJECT_CONTENT_NEGOTIATION_DESC = "con Negotiation che Content il web server pu� servire automaticamente la lingua corretta. Il URLs � cutted dal web server di language-id.<br/>Your deve sostenere questo! <br/>If incerto, uncheck questo."
PROJECT_CONTENT_NEGOTIATION = "Il web server sta sostenendo Negotiation Content"
PROJECT_CUT_INDEX_DESC = "alle lime con il nome di schedario <tt>index</tt> sono cutted. Ci� gli d� pi� beautyul URLs:)<br/><em>Example: </em> http://server/inhalt/ anzich� http://server/inhalt/index.html <br/>You pu� regolare questa opzione senza cura."
...
PROJECTMODEL_DELETE_DESC = "cancella questo modello di progetto, tutte le mascherine � perso!"
PROJECT_NAME = ""
...
SEARCH_PROP = "della ricerca soddisfatta della ricerca sommaria di ricerca della propriet�"
...
USER_LOGIN_FAILED = "inizio attivit� non possibile. Username errato o parola d'accesso errata."
USER_LOGOUT_DESC = "da questa applicazione. La vostra sessione � chiusa."
USER_LOGOUT = "Termine attivit� di termine attivit�"
...
USER_MAIL_TEXT_PREFIX = "la vostra parola d'accesso per entrare a OpenRat ch'il sistema di amministrazione soddisfatto �:"
...
USER_PASSWORD = ""
USER_PASSWORD_TIMEOUT = "cronometrer� ancora fuori"
...
USER_REGISTER_CODE = ""
USER_STYLE_DESC = "A stile contiene le regolazioni per i colori e le serie complete di caratteri. Ogni utente pu� selezionare il suo proprio username del telefono di stile"
USER_STYLE = "Style"
USER_TEL = "Telephone"
