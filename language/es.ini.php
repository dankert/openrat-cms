...
ACL_CREATE_PAGE = " Crean una p�gina "
ACL_DELETE_ABBREV = " DEL "
ACL_DELETE = " Cancelaci�n "
ACL_DESC = " Esto endereza se utiliza para toda la petici�n a este objeto "
ACL_GRANT_ABBREV = " GR "
ACL_GRANT = " Grant endereza "
ACL_INHERITED = " heredado "
ACL = "Las derechas "
ACL_PROP_ABBREV = " PRP "
ACL_PROP = " Corregir las caracter�sticas "
ACL_PUBLISH_ABBREV = " Publicaci�n "
...
DATE_ANSI = " Fechar la notaci�n del ANSI "
DATE = " Fechar "
DATE_FORMAT_LONG = "m/d Y, H:i"
DATE_FORMAT = " m/d Y, H: i: s "
DATE_LAST_MONTH = " El mes pasado "
DATE_LAST_YEAR = " El a�o pasado "
...
DATE_NEXT_MONTH = " El mes pr�ximo "
DATE_NEXT_YEAR = " El a�o pr�ximo "
DATE_TIME = " Tiempo "
DATE_TODAY = " Hoy "
...
EL_CODE = " C�digo de PHP "
EL_CODE_DESC = " Este <strong>PHP code</strong>-element contiene el PHP-C�digo se ejecuta que mientras que publica la p�gina. �Solamente para los programadores experimentados de PHP! "
EL_COPY = " Copy "
EL_COPY_DESC = "Copy a Value out of an element of a linked page"
EL_DATE_DESC = " Cet �l�ment contient une date "
EL_DATE = " Fecha "
EL_DYNAMIC_DESC = " L'�l�ment dynamique puissant contient les scripting-�l�ments dynamiques, menus complexes de navigation de Fe. "
EL_DYNAMIC = " Dynamique "
ELEMENT_DELETE_DESC = " Suprimir el elemento. �<strong>Attention</strong>, todos los valores con se basan en este elemento ser�n perdidos! "
ELEMENT_DELETE_VALUES_DESC = " �Todos los valores de este elemento ser�n suprimidos! "
ELEMENT_DELETE_VALUES = " Valores de la cancelaci�n "
ELEMENT_DESC_DESC = " Se demuestra esta descripci�n mientras que corrige el contenido, esto debe ser una descripci�n provechosa para el autor "
ELEMENT = " Elemento "
ELEMENT_NAME_DESC = " Este identicates conocidos este elemento en el c�digo de la plantilla. Puedes cambiar este nombre m�s adelante "
ELEMENT_NAME = " Elemento-nombre "
ELEMENTS = " Elementos "
ELEMENT_SUBTYPE = " Subtipo "
ELEMENT_TYPE = " Elemento-tipo "
EL_INFO_ACT_USER_DESC = " Usuario entrado: Descripci�n "
EL_INFO_ACT_USER_FULLNAME = " Usuario entrado: Nombre completo "
EL_INFO_ACT_USER_MAIL = " Usuario entrado: E-mail "
EL_INFO_ACT_USER_TEL = " Usuario entrado: Tel�fono "
EL_INFO_ACT_USER_USERNAME = " Usuario entrado: Username "
EL_INFO_CREATE_USER_DESC = " Erstellungsautor: Descripci�n "
EL_INFO_CREATE_USER_FULLNAME = " Creaci�n-Usuario: Nombre completo "
EL_INFO_CREATE_USER_MAIL = " Creaci�n-Usuario: email "
EL_INFO_CREATE_USER_TEL = " Creaci�n-Usuario: N�mero de tel�fono "
EL_INFO_CREATE_USER_USERNAME = " Creaci�n-Usuario: Benutzername "
EL_INFODATE_DATE_CREATED = " Date/heure de cr�ation "
EL_INFODATE_DATE_PUBLISHED = " Date/heure de l'�dition "
EL_INFODATE_DATE_SAVED = " Le date/heure du bout �conomisent "
EL_INFODATE_DESC = " L'Infodate contient une date produite automatique "
EL_INFODATE = " Infodate "
EL_INFO_DB_ID = " Base de datos: Identificaci�n "
EL_INFO_DB_NAME = " Base de datos: Nombre "
EL_INFO_DESC = " Este campo del Info contiene el contenido autom�tico "
EL_INFO_EDIT_FULLURL = " URL para la conexi�n (completa) "
EL_INFO_EDIT_URL = " URL para la conexi�n (relativa) "
EL_INFO = " Information "
EL_INFO_LANGUAGE_ID = " Lengua usada: Identificaci�n "
EL_INFO_LANGUAGE_ISO = " Lengua usada: ISO-C�digo "
EL_INFO_LANGUAGE_NAME = " Lengua usada: Nombre "
EL_INFO_LASTCH_USER_DESC = " Usuario pasado: Descripci�n "
EL_INFO_LASTCH_USER_FULLNAME = " Usuario pasado: Nombre completo "
EL_INFO_LASTCH_USER_MAIL = " Usuario pasado: email "
EL_INFO_LASTCH_USER_TEL = " Usuario pasado: N�mero de tel�fono "
EL_INFO_LASTCH_USER_USERNAME = " Usuario pasado: Username "
EL_INFO_PAGE_DESC = " P�gina: Beschreibung "
EL_INFO_PAGE_EXTENSION = " P�gina: Nombre de fichero-extensi�n "
EL_INFO_PAGE_FILENAME = " P�gina: Nombre de fichero (sin la extensi�n) "
EL_INFO_PAGE_FULLFILENAME = " P�gina: Terminar la trayectoria y el nombre de fichero "
EL_INFO_PAGE_ID = " P�gina: Identificaci�n "
EL_INFO_PAGE_NAME = " P�gina: Nombre "
EL_INFO_PROJECT_ID = " Proyecto: Identificaci�n "
EL_INFO_PROJECT_NAME = " Proyecto: Nombre "
EL_INFO_URL = " URL a abrirse una sesi�n "
...
EL_LINK_DESC = " Acoplamiento a una p�gina o a un archivo "
...
EL_LIST_DESC = " El elemento de la lista contiene 1 mineral m�s p�ginas. Con este elemento puedes juntar m�s p�gina en una "
EL_LIST = " Lista "
EL_LONGTEXT_DESC = " Un texto largo es el texto con m�s de 1 l�nea "
EL_LONGTEXT = " Texto largo "
EL_NUMBER_DESC = " El elemento del n�mero contiene valores num�ricos "
EL_NUMBER = " N�mero "
EL_PROP_ALL_LANGUAGES_DESC = " El contenido es igual en todas las idiomas "
EL_PROP_ALL_LANGUAGES = " Todas las idiomas "
EL_PROP_CODE = " C�digo de PHP "
EL_PROP_CODE_DESC = " <em>Hint: Toma de </em> una mirada en la API-Documentaci�n de esta clase. �Ser seguro utilizar solamente los m�todos de esta clase, nunca <tt>echo</tt> o <tt>print</tt>! "
...
EL_PROP_DEC_POINT_DESC = " Carb�n de la coma, FE. ?.? o ?,?, o vaciar "
EL_PROP_DEFAULT_FOLDEROBJECT_DESC = " El objeto ligado puede ser choosed fuera de esta carpeta. La Seleccionar-lista ser� mucho clarificante con un ajuste �til aqu�. "
EL_PROP_DEFAULT_FOLDEROBJECT = " El directorio m�s alto "
EL_PROP_DEFAULT_LONGTEXT_DESC = " Se utiliza este texto si el elemento es vac�o "
...
EL_PROP_DEFAULT_TEXT_DESC = " Se utiliza este texto si el elemento es vac�o "
EL_PROP_DEFAULT_TEXT = " Texto del defecto "
EL_PROP_DYNAMIC_PARAMETERS_DESC = " Puedes fijar los par�metros para este elemento din�mico "
EL_PROP_DYNAMIC_PARAMETERS = " Par�metro "
EL_PROP_DYN_PARAM_DESC = " ninguna descripci�n "
EL_PROP_DYN_PARAM = " Par�metros "
...
EL_PROP_SELECT_ITEMS_DESC = " Aqu� est�n los valores explicados fuera del autor pueden seleccionar valores. "
...
EL_PROP_WIKI = " Formato r�pido de <em>Wiki</em> "
...
EL_PROP_WRITABLE_DESC = " Comprobar esto, as� que el valor del elemento puede ser cambiado "
EL_PROP_WRITABLE = " escribible "
EL_SELECT_DESC = " El valor es dado por el autor fuera de una lista "
EL_SELECT = " Selectbox "
EL_TEXT = " Campo del texto "
EL_TEXT_DESC = " El textfield se utiliza para una l�nea los textos hasta 255 letras "
EMPTY=Empty
...
ERROR_FTP_CANNOT_CONNECT_TO_SERVER = " El ftp server no est� disponible. "
ERROR_FTP_CANNOT_LOGIN = " La conexi�n en el ftp server fall�. "
...
ERROR_FTP_UNABLE_TO_CHDIR = " El ftp server no pod�a seleccionar el directorio. "
ERROR_LOGIN_BROKEN_SSL_CERT = "Login was denied, because your SSL-certificat is invalid."
ERROR_NO_PROJECT = " ning�n proyecto disponible. "
ERROR_NOT_A_FOLDER = " el objeto no es un directorio "
ERROR = " Technischer Fehler "
ERROR_USER_PW_DESC = " La contrase�a no podr�a ser cambiada "
ERROR_USER_PW = " La contrase�a no podr�a ser cambiada "
EXAMPLE = "Example"
EXPORT_DESC = " Utilizar la exportaci�n para los archivos de copiado al servidor "
EXPORT = " Exportaci�n "
FILE_DELETE_DESC = " Quitando el archivo "
FILE_EXTENSION = " Extensi�n de archivo "
...
FILE_IMAGE_RESIZE_DESC = " Changer la taille d'image, donner la nouvelles largeur et taille dans pixels<br/><em>Hint : </em> ont entr� seulement la taille de la largeur <strong>or</strong> pour ne pas toucher le format. Si vous voulez seulement changer le format, laisser les deux champs vides. "
...
FILENAME = Filename
FILE_NO_DELETE_BECAUSE_LINKED = " <em>Notice : </em> : Ce dossier ne peut pas �tre enlev�, parce qu'il est employ� par quelques pages. "
FILE_PAGES_DESC = " Les pages suivantes lient � ce dossier : "
FILE_PAGES = " Pages Renvers�-Li�es "
FILE_REPLACE_DESC = " Vous pouvez remplacer ce dossier avec un dossier de votre harddisc<br/><em>Hint : Les liens de </em>All � cette page sont intacts "
...
FOLDER_ORDER = " Ordre "
FOLDER_ROOT_DESC = " R�pertoire racine du projet. Il contient toutes les valeurs. "
FOLDER_ROOT = " R�pertoire racine "
...
FOLDER_SUBFOLDER = " Sous-r�pertoire "
FOLDER_UNMARK_ALL = " --"
...
GLOBAL_CLEAN_AFTER_PUBLISH = " L'annuaire de cible de nettoyage et enl�vent de vieux dossiers dans lui. "
...
GLOBAL_CREATED = " cr�� "
GLOBAL_DATABASE = " Base de donn�es "
GLOBAL_DAY = " Jour "
GLOBAL_DAYS = " Jours "
GLOBAL_DEFAULT = " Norme "
GLOBAL_DEFAULT_TEXT = " Texte de d�faut "
GLOBAL_DELETED = " L'objet a �t� supprim� "
GLOBAL_DELETE = " Effacement "
GLOBAL_DESCRIPTION = " Description "
GLOBAL_DIFFERENCES_DESC = " Montrer les diff�rences entre 2 r�visions "
GLOBAL_DIFFERENCES = " Diff�rences "
GLOBAL_DOWN = " vers le bas "
GLOBAL_ELEMENT = Template-Element
GLOBAL_EXTENSIONS = " Prolongements "
GLOBAL_FILE = " Dossier "
GLOBAL_FILENAME_DESC = " Nom de fichier, qui sera employ� pour se produire. La volont� a automatiquement v�rifi� contre RFC 2396 (maximum 255 chars). "
GLOBAL_FILENAME = " Nom de fichier "
GLOBAL_FILES = " Dossiers "
GLOBAL_FILE_TRANSFER_DESC = " Importer le dossier multiple dans la base de donn�es de m�dias "
...
GLOBAL_GPL = " Le logiciel vient avec ABSOLUMENT AUCUN WARRANTY.<br/>This est logiciel libre, et vous �tes bienvenu pour le redistribuer dans certaines conditions. "
GLOBAL_GROUP = " Groupe "
GLOBAL_GROUPS = " Groupes "
GLOBAL_HIDETREE = " Arbre de peau "
GLOBAL_HOUR = " Heure "
GLOBAL_HOURS = " Houres "
GLOBAL_ICON = " �diter-ic�ne "
...
GLOBAL_LANGUAGES_DESC = " Tout le contenu peut �tre cr�� dans plusieurs langues "
GLOBAL_LANGUAGES = " Langues "
GLOBAL_LANGUAGE = " Sprache "
GLOBAL_LASTCHANGE = " Dernier changement "
GLOBAL_LINK = " Raccourci "
GLOBAL_LINK_TO = " Raccourci � "
GLOBAL_LISTING = " Liste "
GLOBAL_LOGIN = " Ouverture "
GLOBAL_LOG = " Notation "
GLOBAL_MAKE_DEFAULT = " Placer � la norme "
GLOBAL_MINUTE = " Minuter "
GLOBAL_MINUTES = " Minutes "
GLOBAL_MODEL = " Mod�le "
GLOBAL_MODELS_DESC = " Avec des mod�les vous pouvez faire plus de vues d'un projet, de Fe un HTML et d'un WML-Mod�le. "
GLOBAL_MODELS = " Mod�les "
GLOBAL_MONTH = " Mois "
GLOBAL_MONTHS = " Mois "
GLOBAL_MOVE = " Se d�placer "
...
GLOBAL_NO_DIFFERENCES_FOUND = " Aucunes diff�rences trouv�es "
GLOBAL_NOPUBLISH_DESC = " Toutes les fonctions de �dition sont mises hors tension � l'heure actuelle. "
GLOBAL_NOPUBLISH = " �ditant non disponible "
GLOBAL_NO_TEMPLATES_AVAILABLE_DESC = " <em>Hint : </em> l� ne sont aucun calibre disponible. "
GLOBAL_NOT_FOUND = " non trouv� "
GLOBAL_NOTICES = " Notification "
GLOBAL_NOT_LOGGED_IN = " non entr� "
...
GLOBAL_PAGE = " Page "
GLOBAL_PAGES = " Pages "
GLOBAL_PHP = " Interpr�te "
GLOBAL_PLEASE_LOGIN = " Svp ouverture "
GLOBAL_PREFS = " Pr�f�rences "
GLOBAL_PROFILE = "User profile"
GLOBAL_PROJECT = " Projet "
GLOBAL_PROJECTS = " Projets "
GLOBAL_PROP = " Propri�t�s "
GLOBAL_PUBLIC = " public "
GLOBAL_PUBLISH = " �diter "
GLOBAL_PUBLISH_WITH_SUBDIRS = " �diter avec des sous-r�pertoires "
GLOBAL_READONLY_DESC = " Le syst�me est en mode inalt�rable. Vous ne pouvez sauver aucune donn�es ! "
GLOBAL_READONLY = " Mode inalt�rable "
GLOBAL_REFRESH = " R�g�n�rer "
...
GLOBAL_SEND_PASSWORD_DESC = " Si vous avez oubli� votre mot de passe, demander un neuf. "
GLOBAL_SEND_PASSWORD = " Mot de passe oubli� "
GLOBAL_SETTINGS = " Arrangements "
GLOBAL_SHOW = " Montrer "
GLOBAL_SHOWTREE = " Montrer l'arbre "
GLOBAL_STATE = State
GLOBAL_SYSTEM = " Syst�me "
GLOBAL_TEMPLATE = " Calibre "
GLOBAL_TEMPLATES = " Calibres "
GLOBAL_TEMPLATES_DESC = " �diter les calibres "
GLOBAL_TIME = " Temps "
GLOBAL_TO = " "
...
GLOBAL_YEAR = " Ann�e "
GLOBAL_YEARS = " Ann�es "
GROUP_DELETE_DESC = " Supprimer le groupe. Toutes les droites et adh�sions seront perdues ! "
...
LOGIN_NOLOGIN_DESC = " L'ouverture est neutralis�e � l'heure actuelle. "
...
LOGO_LOGIN_TEXT = " � l'ouverture, vous avez besoin d'un compte d'utilisateur. V�rifier svp les sensitives de cas. "
LOGO_PASSWORD = " Mot de passe perdu ? "
LOGO_PASSWORD_TEXT = " Si vous avez oubli� votre mot de passe, sensation librement pour demander un neuf. "
LOGO_PROJECTMENU = " Choisir le projet "
LOGO_PROJECTMENU_TEXT = " Veuillez choisir un projet. "
LOGO_REGISTER = " Enregistrement "
LOGO_REGISTER_TEXT = " Si vous n'avez pas un compte d'utilisateur, alors se sentir libre pour s'enregistrer maintenant. Vous avez besoin d'un compte d'E-mail, auquel un code d'enregistrement est envoy�. "
...
MAIL_TEXT_PASSWORD_COMMIT_CODE = " Bonjour {name},;;votre code pour demander un nouveau mot de passe est : {code};;Veuillez ins�rer ce nombre dans le champ d'entr�e.;;Si vous n'avez pas la demande un nouveau mot de passe, ignorer svp cet E-mail. Dans ce cas-ci, votre mot de passe restera sans changement. ; ; Merci. "
MAIL_TEXT_PASSWORD_NEW = " Hola {name};;tu nueva contrase�a: {password};;Observar por favor esta contrase�a en un lugar seguro y suprimir este correo.;;Gracias. "
MAIL_TEXT_REGISTER_COMMIT_CODE = " Hola,;;t� (u otra persona) has solicitado un c�digo del registro.;;Tu c�digo del registro: {code}.;;Insertar por favor este n�mero en el campo de la entrada.;;Gracias. "
MAIL_TEXT_USER_MAIL = " Hola {name};;Tus detalles de la cuenta para la conexi�n en sistema de gerencia contento de OpenRat son los siguientes.;;Conexi�n: {username}; Contrase�a: {password};;Gracias."
...
MENU_ELEMENT_NAME_DESC = " corrige las caracter�sticas del nombre del elemento "
MENU_ELEMENT_NAME = " que el nombre "
MENU_ELEMENT_PROPERTIES = " "
MENU_ELEMENT_PROPERTIES_DESC = " las caracter�sticas del elemento "
...
MENU_FILE_PROP = " corrige caracter�sticas "
MENU_FILE_PROP_DESC = " corrige caracter�sticas de este archivo "
MENU_FILE_PUB_DESC = " publica el archivo "
MENU_FILE_PUB = " publica "
MENU_FILE_REMOVE = " quita las derechas de la demostraci�n de las derechas del archivo "
MENU_FILE_RIGHTS = " "
MENU_FILE_RIGHTS_DESC = " de las caracter�sticas de esta del archivo "
MENU_FILE_SHOWPROP = " demostraci�n de la demostraci�n "
MENU_FILE_SHOWPROP_DESC = " de este cambio del tama�o de la imagen del archivo "
MENU_FILE_SIZE = " "
MENU_FILE_SIZE_DESC = " que el Upload del tama�o de la imagen "
...
MENU_FOLDER_CREATEPAGE_DESC = " crea una p�gina nueva en esta carpeta "
MENU_FOLDER_CREATEPAGE = " La p�gina nueva "
MENU_FOLDER_NEW = " crea una nueva orden del objeto "
MENU_FOLDER_ORDER = " "
MENU_FOLDER_ORDER_DESC = " Commander � nouveau les objets dans cette chemise "
MENU_FOLDER_PROP_DESC = " �diter les propri�t�s "
MENU_FOLDER_PROP = " Propri�t�s "
MENU_FOLDER_PUB_DESC = " �diter la chemise "
MENU_FOLDER_PUB = " �diter "
...
MENU_FOLDER_SHOWPROP_DESC = " Montrer les propri�t�s "
MENU_FOLDER_SHOWPROP = " Montrer "
MENU_FOLDER_SHOW = " �valuer " "
MENU_FORM_DESC = " Former pour tous les �l�ments "
MENU_FORM = " Former "
MENU_FORM_KEY = " F "
...
MENU_GROUP_EDIT_DESC = " �diter le nom de ce groupe "
MENU_GROUP_EDIT = " �diter "
...
MENU_GROUPS = " Adh�sions "
MENU_GROUPS_DESC = " Ajouter ou enlever les groupes "
MENU_GROUP_USERS_DESC = " que copy de la importaci�n "
MENU_GROUP_USERS = " usuario en archivos de este del grupo "
MENU_HELP_DESC=Online help
MENU_HELP=Help
MENU_IMPORT = " de la carpeta local a una administraci�n de la CMS-carpeta "
MENU_IMPORT_DESC = " "
...
MENU_INDEX_CHANGEPASSWORD_DESC = " tu registro de estado de la m�quina del registro de estado de la m�quina de la conexi�n de la contrase�a "
MENU_INDEX_LOGIN = " "
MENU_INDEX_LOGOUT = " "
MENU_INDEX_LOGOUT_DESC = " de este uso. ?"
MENU_INDEX_MENU = " elegir la contrase�a olvidada del proyecto "
MENU_INDEX_PASSWORD = " "
MENU_INDEX_PASSWORD_DESC = " si no sabes tu contrase�a, t� puede conseguirla v�a correo. "
...
MENU_INDEX_SHOWLOGIN = " Conexi�n "
MENU_INDEX_SHOWLOGIN_DESC = " debes conexi�n. "
...
MENU_LINK_EDIT = " corrigen la demostraci�n de las derechas de las caracter�sticas de la blanco "
MENU_LINK_EDIT_DESC = "Edit target"
MENU_LINK_PROP = " "
MENU_LINK_PROP_DESC = Edit properties of link
MENU_LINK_RIGHTS = " "
MENU_LINK_RIGHTS_DESC = " que todas las derechas de esta lista de la lista de la opini�n del acoplamiento "
MENU_LINK_SHOWPROP = " "
...
MENU_PAGE_ACLFORM_DESC = " Ajouter une droite � cette page "
MENU_PAGE_CHANGETEMPLATE_DESC = " Remplacer le calibre de cette page "
MENU_PAGE_CHANGETEMPLATE = " Remplacer le calibre "
MENU_PAGE_EL_DESC = " Montrer tous les �l�ments de cette page "
MENU_PAGE_EL = " �diter tous "
...
MENU_PAGEELEMENT_SHOW =View
MENU_PAGE_ELEMENTS = " �l�ments de cette page "
MENU_PAGE_FORM_DESC = " �diter tous les �l�ments de cette page dans une formular "
MENU_PAGE_FORM = " �diter "
MENU_PAGE_PROP_DESC = " �diter les propri�t�s de cette page "
MENU_PAGE_PROP = " Propri�t�s "
MENU_PAGE_PUB_DESC = " Seite ver�ffentlichen "
MENU_PAGE_PUB = " Ver�ffentlichen "
MENU_PAGE_RIGHTS_DESC = " consideran que las derechas de esta opini�n de la p�gina "
MENU_PAGE_RIGHTS = " Rechte "
MENU_PAGE_SHOWPROP = " "
MENU_PAGE_SHOWPROP_DESC = " consideran las caracter�sticas de esta p�gina "
...
MENU_PROFILE_EDIT_DESC = " corrigen tu cambio personal de la contrase�a del cambio de los ajustes "
...
MENU_PROFILE_PWCHANGE_DESC = " que tu contrase�a "
...
MENU_PROJECT_LISTING_DESC = " proyectos del alle de la visi�n "
...
MENU_PROJECT_REMOVE_DESC = " quita el proyecto y todas las caracter�sticas del contenido "
MENU_PROJECT_REMOVE = " quita proyecto "
MENU_PROP = " "
MENU_PROP_DESC = " corrige las caracter�sticas de este objeto "
MENU_PROP_KEY = " E "
MENU_PUB_DESC = " publica este objeto en la concesi�n de las derechas de la contrase�a del usuario de cambio de la contrase�a del Internet "
MENU_PUB_KEY = " V "
MENU_PUB = " publica "
MENU_PW = " "
MENU_PW_DESC = " "
MENU_RIGHTS = " "
MENU_RIGHTS_DESC = " o revocan la demostraci�n de las derechas "
MENU_RIGHTS_KEY = " X "
...
MENU_SEARCH_PROP = "Property"
MENU_SHOW = " "
MENU_SHOW_DESC = " El sourcecode de la demostraci�n de la fuente de la demostraci�n "
MENU_SHOW_KEY = " S "
MENU_SRC = " "
MENU_SRC_DESC = " de la p�gina "
MENU_SRC_KEY = " Q "
...
MENU_TEMPLATE_EL_DESC = " que todo el Elemente de la extensi�n de la plantilla "
MENU_TEMPLATE_EL = " elementos "
MENU_TEMPLATE_EXTENSION = " "
MENU_TEMPLATE_EXTENSION_DESC = " corregir la extensi�n "
MENU_TEMPLATE_LISTING_DESC = " ver todas las plantillas "
MENU_TEMPLATE_LISTING = " todas las plantillas "
MENU_TEMPLATE_NAME_DESC = " �diter le nom de calibre "
MENU_TEMPLATE_NAME = " el nombre "
MENU_TEMPLATE_PAGES_DESC=Related pages
MENU_TEMPLATE_PAGES=Pages
MENU_TEMPLATE_PROP = " �diter les propri�t�s "
MENU_TEMPLATE_REMOVE_DESC = " Supprimer le calibre "
MENU_TEMPLATE_REMOVE = " Supprimer "
MENU_TEMPLATE_SRC_DESC = " �diter le sourcecode "
MENU_TEMPLATE_SRCELEMENT = " Ajouter l'�l�ment "
MENU_TEMPLATE_SRCELEMENT_DESC = " Ajouter un �l�ment "
...
MENU_TREETITLE_ADMINISTRATION_DESC = " Administration de syst�me "
...
MENU_USER_EDIT = " Donn�es d'utilisateur "
...
NOTICE_IMPORTED = " archivo cambiante era ist ligado del '' del <em> del '' del username de la conexi�n failed.<br/><br/>The del importet "
NOTICE_INPUT_NEW_IMAGE_SIZE = "Please enter the new image size, either a size factor or widht and height."
NOTICE_LINKED = " "
NOTICE_LOGIN_FAILED = " </em> {conocido} no presente o la contrase�a es incorrecta. "
NOTICE_LOGIN_FAILED_MUSTCHANGEPASSWORD = " la conexi�n fue negado, porque tu contrase�a ha medido el tiempo hacia fuera. Otra vez, pero ahora intentar por favor a la conexi�n junto con una nueva contrase�a. "
...
NOTICE_PASSWORD_TIMEOUT = " tu contrase�a ha medido el tiempo hacia fuera y debe ser cambiado. �"
NOTICE_PROP_SAVED = " Las caracter�sticas ahorradas "
...
OPTIONS="Options"
PAGE_ARCHIVE_DESC = " eligen una versi�n para alcanzar el valor "
PAGE_DELETE_DESC = " quitan esta p�gina, <strong>Attention</strong> que todos los valores de esta p�gina se suprimen! "
PAGE_EDITOR_ADD_EMPHATIC = " Marcar el texto como (it�lico) "
PAGE_EDITOR_ADD_IMAGE = " el relleno enf�tico seleccion� acoplamiento de la imagen "
PAGE_EDITOR_ADD_LINK = " con la p�gina o el relleno seleccionada del archivo "
...
PAGE_PUBLISH_AFTER_SAVE = " despu�s de que ahorre publica la p�gina "
...
PAGE_SOURCE = " Sourcecode de los ajustes de la p�gina "
PAGE_TEMPLATE_NEW = "New Template"
PAGE_TEMPLATE_OLD = "Old Template"
PASSWORD_CODE = " c�digo agregado para reqesting una nueva contrase�a "
PASSWORD_CODE_HELP = " que has recibido un c�digo v�a E-mail. Insertar por favor este c�digo en este campo de la entrada. "
PREFERENCES = " "
PROJECT_CHECK_FILES="Folder Integritycheck"
PROJECT_CHECK_LIMIT="Remove old values from archives"
PROJECT_CMD_AFTER_PUBLISH_DESC = " este comando se ejecuta despu�s de que se utilice el <tt>exec de la PHP-funci�n de publishing.<br>The () </tt>. �El <tt>escapeshellcmd del comando () </tt> no se llama! "
PROJECT_CMD_AFTER_PUBLISH = " Ejecutarte despu�s de publicar "
PROJECT_CONTENT_NEGOTIATION_DESC = " con Negotiation. Content que el web server puede servir autom�ticamente la lengua correcta. �El URLs es cutted por el web server de language-id.<br/>Your tiene que apoyar esto! <br/>If inseguro, uncheck esto. "
PROJECT_CONTENT_NEGOTIATION = " El web server est� apoyando Negotiation Content"
PROJECT_CUT_INDEX_DESC = " a los archivos con el nombre de fichero index son cutted. Esto te da m�s beautyul URLs:) Example: http://server/inhalt/ en vez de http://server/inhalt/index.html You puede fijar esta opci�n sin cuidado. "
...
PROJECT_FTP = "FTP"
PROJECT_FTP_PASSIVE_DESC = " uso que el usar pasivo de FTP-Transfer.<br/>While pasivo Ftp-Transfiere solamente a cliente est� solicitando conexiones. Algunos cortafuegos necesitan este ftp server del URL del ftp server de la opci�n "
PROJECT_FTP_PASSIVE = " pasivo Ftp-Transfiere "
PROJECT_FTP_URL = " "
PROJECT_FTP_URL_DESC = ", formato: <tt> ftp://user:pw@hostname:port/path/.../path/ </tt>.<br/>Leave este espacio en blanco, si est�s generando solamente a local. "
PROJECT_INFO_COUNT_OBJECTS="Objects count"
PROJECT_INFO_SUM_FILESIZE="Size of all files"
PROJECT_LOCAL_FOLDER_DESC = " un Directy en el filesystem local en el servidor, ejemplo: <tt>/home/user/dir</tt> (Unix) o <tt>c: El trabajo de la descripci�n del proyecto de /documents/dir</tt> (Windows) "
PROJECT_LOCAL_FOLDER = " Directorio local "
PROJECT_LOCALPATH_DESC = " Directorio local, formato: espacio en blanco de <tt>/path/? /path/</tt>.<br/>Leave, si est�s publicando solamente v�a el ftp. "
PROJECTMODEL_DELETE_DESC = " suprime este modelo del proyecto, todas las plantillas se pierde! "
PROJECT_NAME = " "
PROJECT_SELECT_DESC = " en otra b�squeda del directorio de la blanco del proyecto "
PROJECT_TARGET_DIR = " "
PROP_USERINFO = "User"
SEARCH_CONTENT = " para "
SEARCH_DESC="Searching in the project"
SEARCH_PROP = " la b�squeda contenta para la b�squeda sumaria de la b�squeda de la caracter�stica "
SEARCH_RESULT = " "
SEARCH="Search"
SEARCH_TEMPLATE = " para la cancelaci�n de la plantilla "
...
START_DESC="Start"
START = "Start"
TEMPLATE_DELETE_DESC = " la plantilla con todos los elementos en �l "
TEMPLATE_ELEMENT = " extensi�n de los elementos del elemento "
TEMPLATE_ELEMENTS = " "
TEMPLATE_EXTENSION = " de la opini�n publicada de la plantilla de las p�ginas "
TEMPLATE_NAME =Template-Name
TEMPLATE_SHOW = " "
TEMPLATE_SOURCE = " Sourcecode de la plantilla? "
TEMPLATE_SRC_BEGIN = " comienza "
TEMPLATE_SRC_END = " la importaci�n numerada en negrilla de la lista de la tabla de la lista del it�lico del c�digo de la c�lula de If_Element_is_empty? "
...
TIMEZONE="Timezone"
TRANSFER_IMPORT = " "
TRANSFER_IMPORT_DESC = " que usa la importaci�n que puedes importar archivos del sistema de ficheros del servidor. "
TRANSFER_SOURCE = " La blanco de la fuente "
TRANSFER_TARGET = "? "
TREE_CHOOSE_PROJECT = " selecciona por favor un proyecto. "
TREE_CLOSE_ELEMENT = " Cerrar esta parte del �rbol "
TREE_OPEN_ELEMENT = " abren a esta parte del usuario activo del administrador del passwort del �rbol "
USER_ACT_PASSWORD = " "
USER_ADMIN = " "
...
USER_DESC = " Los administradores del nombre completo de la descripci�n "
USER_FULLNAME = " "
USER_ISADMIN_DESC = " tienen todas las derechas a todos los proyectos. "
USER_LDAPDN_DESC = " <em>distinguished name</em> de este usuario en el LDAP-diretory.<br/><br/>Example: El <tt>cn=Eddi Murphy, ou=Finance, organizaci�n o=My, c=DE</tt><br/><br/>If inseguro, deja este espacio en blanco. "
USER_LDAPDN = " LDAP abajo "
USER_LOGINAS = " Entrado como "
USER_LOGIN_FAILED = " conexi�n no posible. Username incorrecto o contrase�a incorrecta. "
USER_LOGOUT_DESC = " de este uso. Tu sesi�n es cerrada. "
USER_LOGOUT = " Registro de estado de la m�quina del registro de estado de la m�quina "
USER_MAIL = " El invalid de los adress del E-mail del E-mail "
USER_MAIL_INVALID = " "
USER_MAIL_NEW_PASSWORD = " env�a E-mail al usuario con la nueva contrase�a "
USER_MAIL_SUBJECT = " tu contrase�a "
USER_MAIL_TEXT_PREFIX = " tu contrase�a para entrar a OpenRat que es el sistema de gerencia contento: "
USER_MAIL_TEXT_SUFFIX = " Observar esta contrase�a en un lugar seguro y quitar este E-mail. Tu poder cambiar tu contrase�a despu�s de entrar. "
USER_MEMBERSHIPS = " La nueva nueva contrase�a de la contrase�a de la contrase�a de la contrase�a de las calidades de miembro "
USER_NEW_MAIL = "New E-Mail address"
USER_NEW_PASSWORD = " "
USER_NEW_PASSWORD_REPEAT = " "
USER_PASSWORD = " "
USER_PASSWORD_TIMEOUT = " medir� el tiempo otra vez hacia fuera "
USER_PROFILE_DESC = " de tu perfil. Cambiar tus ajustes personales "
USER_RANDOM_PASSWORD = " crean el estilo al azar del c�digo del registro de Comit de la contrase�a "
USER_REGISTER_CODE = " "
USER_STYLE = " "
USER_STYLE_DESC = " A ?estilo? contiene los ajustes para los colores y las fuentes. Cada usuario puede seleccionar su propio username del tel�fono del estilo "
USER_TEL = " "
USER_USERNAME = " "
USER_USERNAME_DESC = " con este nombre que el usuario est� entrando "
