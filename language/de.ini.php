...
EL_CODE = "PHP Code"
EL_CODE_DESC = "Das <strong>PHP Code</strong>-Element enthält PHP-Code, welcher während der Generierung vom System ausgeführt wird. Mit diesem Element kann eine Seite sehr dynamisch aufgebaut werden, bleibt nach der Generierung aber statisch. Dieser Elementtyp verlangt Kenntnisse in der Programmierung von PHP-Code!"
EL_COPY =Kopie
...
TEMPLATE_SRC_IFEMPTY ="Bedingung:Wenn-Element-leer"
TEMPLATE_SRC_IFNOTEMPTY ="Bedingung:Wenn-Element-nicht-leer"
TEXT_BOLD = fett
TEXT_CELL = Zelle
TEXT_CODE = Code
TEXT_ITALIC = kursiv
